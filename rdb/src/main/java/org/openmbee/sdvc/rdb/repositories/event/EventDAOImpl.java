package org.openmbee.sdvc.rdb.repositories.event;
...
public class EventDAOImpl extends BaseDAOImpl implements EventDAO {
    ...
    public BaseEvent save(BaseEvent event) throws InvalidDataAccessApiUsageException, DataRetrievalFailureException {
        if (event.getId() == null) {
                ...
                public PreparedStatement createPreparedStatement(Connection connection)
                    ...
                    PreparedStatement ps = connection
                        .prepareStatement(String.format(INSERT_SQL, getSuffix()),
                            new String[]{"id"});
                    return prepareStatement(ps, event);
                }
            }, keyHolder);
