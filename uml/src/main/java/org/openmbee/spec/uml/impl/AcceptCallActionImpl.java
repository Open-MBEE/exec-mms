...
import org.openmbee.spec.uml.AcceptCallAction;
...
@Entity
@SecondaryTable(name = "AcceptCallAction")
@Table(appliesTo = "AcceptCallAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "AcceptCallAction")
@JsonTypeName(value = "AcceptCallAction")
public class AcceptCallActionImpl extends MofObjectImpl implements AcceptCallAction {
    ...
    private OutputPin returnInformation;
    ...
    @JoinTable(name = "AcceptCallAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "AcceptCallActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isUnmarshall", table = "AcceptCallAction")
    ...
    @JsonProperty(required = true)
    @JsonSetter
    public void setUnmarshall(Boolean isUnmarshall) {
    ...
    @Column(name = "name", table = "AcceptCallAction")
    ...
    @JoinTable(name = "AcceptCallAction_localPrecondition",
        joinColumns = @JoinColumn(name = "AcceptCallActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "AcceptCallAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "AcceptCallAction")
    ...
    @JoinColumn(name = "activityId", table = "AcceptCallAction")
    ...
    @JoinTable(name = "AcceptCallAction_localPostcondition",
        joinColumns = @JoinColumn(name = "AcceptCallActionId"),
    ...
    @JoinTable(name = "AcceptCallAction_redefinedNode",
        joinColumns = @JoinColumn(name = "AcceptCallActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "AcceptCallAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "AcceptCallAction")
    ...
    @JoinTable(name = "AcceptCallAction_handler",
        joinColumns = @JoinColumn(name = "AcceptCallActionId"),
    ...
    @JoinTable(name = "AcceptCallAction_result",
        joinColumns = @JoinColumn(name = "AcceptCallActionId"),
    ...
    @JoinTable(name = "AcceptCallAction_outgoing",
        joinColumns = @JoinColumn(name = "AcceptCallActionId"),
    ...
    @JoinTable(name = "AcceptCallAction_inPartition",
        joinColumns = @JoinColumn(name = "AcceptCallActionId"),
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "OutputPinMetaDef", metaColumn = @Column(name = "returnInformationType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "returnInformationId", table = "AcceptCallAction")
    ...
    @JoinTable(name = "AcceptCallAction_trigger",
        joinColumns = @JoinColumn(name = "AcceptCallActionId"),
    ...
    @JoinTable(name = "AcceptCallAction_incoming",
        joinColumns = @JoinColumn(name = "AcceptCallActionId"),
    ...
    @JoinTable(name = "AcceptCallAction_ownedComment",
        joinColumns = @JoinColumn(name = "AcceptCallActionId"),
