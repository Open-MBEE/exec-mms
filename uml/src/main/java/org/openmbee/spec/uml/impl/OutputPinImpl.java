...
@Entity
@SecondaryTable(name = "OutputPin")
@Table(appliesTo = "OutputPin", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "OutputPin")
@JsonTypeName(value = "OutputPin")
public class OutputPinImpl extends MofObjectImpl implements OutputPin {
    ...
    @JoinTable(name = "OutputPin_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "OutputPinId"),
    ...
    @JoinColumn(name = "upperBoundId", table = "OutputPin")
    ...
    @JoinColumn(name = "typeId", table = "OutputPin")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "lowerValueId", table = "OutputPin")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isOrdered", table = "OutputPin")
    ...
    @JoinTable(name = "OutputPin_inState",
        joinColumns = @JoinColumn(name = "OutputPinId"),
    ...
    @Column(name = "name", table = "OutputPin")
    ...
    @JoinColumn(name = "nameExpressionId", table = "OutputPin")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "OutputPin")
    ...
    @JoinColumn(name = "activityId", table = "OutputPin")
    ...
    @JoinTable(name = "OutputPin_redefinedNode",
        joinColumns = @JoinColumn(name = "OutputPinId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "OutputPin")
    ...
    @JoinColumn(name = "upperValueId", table = "OutputPin")
    ...
    @JoinTable(name = "OutputPin_outgoing",
        joinColumns = @JoinColumn(name = "OutputPinId"),
    ...
    @JoinColumn(name = "selectionId", table = "OutputPin")
    ...
    @JoinTable(name = "OutputPin_inPartition",
        joinColumns = @JoinColumn(name = "OutputPinId"),
    ...
    @JoinTable(name = "OutputPin_incoming",
        joinColumns = @JoinColumn(name = "OutputPinId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isUnique", table = "OutputPin")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isControlType", table = "OutputPin")
    ...
    @JoinTable(name = "OutputPin_ownedComment",
        joinColumns = @JoinColumn(name = "OutputPinId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isControl", table = "OutputPin")
