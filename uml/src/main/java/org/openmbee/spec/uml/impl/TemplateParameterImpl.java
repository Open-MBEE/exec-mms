...
@Entity
@SecondaryTable(name = "TemplateParameter")
@Table(appliesTo = "TemplateParameter", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "TemplateParameter")
@JsonTypeName(value = "TemplateParameter")
public class TemplateParameterImpl extends MofObjectImpl implements TemplateParameter {

    private Element owner;
    private Collection<Element> ownedElement;
    private ParameterableElement default_;
    private ParameterableElement parameteredElement;
    ...
    @JoinColumn(name = "default_Id", table = "TemplateParameter")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "ParameterableElementMetaDef", metaColumn = @Column(name = "parameteredElementType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "parameteredElementId", table = "TemplateParameter")
    ...
    @JoinColumn(name = "ownedDefaultId", table = "TemplateParameter")
    ...
    @JoinColumn(name = "ownedParameteredElementId", table = "TemplateParameter")
    ...
    @JoinTable(name = "TemplateParameter_ownedComment",
        joinColumns = @JoinColumn(name = "TemplateParameterId"),
    ...
    @JoinColumn(name = "signatureId", table = "TemplateParameter")
