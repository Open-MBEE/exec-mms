...
import org.openmbee.spec.uml.ReadSelfAction;
...
@Entity
@SecondaryTable(name = "ReadSelfAction")
@Table(appliesTo = "ReadSelfAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ReadSelfAction")
@JsonTypeName(value = "ReadSelfAction")
public class ReadSelfActionImpl extends MofObjectImpl implements ReadSelfAction {
    ...
    @JoinTable(name = "ReadSelfAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ReadSelfActionId"),
    ...
    @Column(name = "name", table = "ReadSelfAction")
    ...
    @JoinTable(name = "ReadSelfAction_localPrecondition",
        joinColumns = @JoinColumn(name = "ReadSelfActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ReadSelfAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ReadSelfAction")
    ...
    @JoinColumn(name = "activityId", table = "ReadSelfAction")
    ...
    @JoinTable(name = "ReadSelfAction_localPostcondition",
        joinColumns = @JoinColumn(name = "ReadSelfActionId"),
    ...
    @JoinTable(name = "ReadSelfAction_redefinedNode",
        joinColumns = @JoinColumn(name = "ReadSelfActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ReadSelfAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "ReadSelfAction")
    ...
    @JoinTable(name = "ReadSelfAction_handler",
        joinColumns = @JoinColumn(name = "ReadSelfActionId"),
    ...
    @JoinTable(name = "ReadSelfAction_outgoing",
        joinColumns = @JoinColumn(name = "ReadSelfActionId"),
    ...
    @JoinTable(name = "ReadSelfAction_inPartition",
        joinColumns = @JoinColumn(name = "ReadSelfActionId"),
    ...
    @JoinTable(name = "ReadSelfAction_incoming",
        joinColumns = @JoinColumn(name = "ReadSelfActionId"),
    ...
    @JoinColumn(name = "resultId", table = "ReadSelfAction")
    ...
    @JoinTable(name = "ReadSelfAction_ownedComment",
        joinColumns = @JoinColumn(name = "ReadSelfActionId"),
