...
@Table(appliesTo = "Class", fetch = FetchMode.SELECT, optional = false)
...
public class ClassImpl extends MofObjectImpl implements Class {
    ...
    @JoinTable(name = "Class_elementImport",
    ...
    @JoinColumn(name = "nameExpressionId", table = "Class")
    ...
    @JoinTable(name = "Class_generalization",
        joinColumns = @JoinColumn(name = "ClassId"),
    ...
    @JoinTable(name = "Class_packageImport",
        joinColumns = @JoinColumn(name = "ClassId"),
    ...
    @JoinTable(name = "Class_ownedOperation",
        joinColumns = @JoinColumn(name = "ClassId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "Class")
    ...
    @JoinTable(name = "Class_ownedAttribute",
        joinColumns = @JoinColumn(name = "ClassId"),
    ...
    @JoinTable(name = "Class_templateBinding",
        joinColumns = @JoinColumn(name = "ClassId"),
    ...
    @JoinColumn(name = "representationId", table = "Class")
    ...
    @JoinTable(name = "Class_ownedReception",
        joinColumns = @JoinColumn(name = "ClassId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "Class")
    ...
    @JoinTable(name = "Class_ownedBehavior",
        joinColumns = @JoinColumn(name = "ClassId"),
    ...
    @JoinColumn(name = "classifierBehaviorId", table = "Class")
    ...
    @JoinTable(name = "Class_substitution",
        joinColumns = @JoinColumn(name = "ClassId"),
    ...
    @JoinTable(name = "Class_ownedConnector",
        joinColumns = @JoinColumn(name = "ClassId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "Class")
    ...
    @JoinTable(name = "Class_interfaceRealization",
        joinColumns = @JoinColumn(name = "ClassId"),
    ...
    @JoinTable(name = "Class_redefinedClassifier",
        joinColumns = @JoinColumn(name = "ClassId"),
    ...
    @JoinTable(name = "Class_ownedRule",
        joinColumns = @JoinColumn(name = "ClassId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Class")
    ...
    @JoinTable(name = "Class_collaborationUse",
        joinColumns = @JoinColumn(name = "ClassId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Class")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "Class")
    ...
    @JoinTable(name = "Class_nestedClassifier",
        joinColumns = @JoinColumn(name = "ClassId"),
    ...
    @JoinTable(name = "Class_ownedUseCase",
        joinColumns = @JoinColumn(name = "ClassId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isActive", table = "Class")
    ...
    @JoinColumn(name = "package_Id", table = "Class")
    ...
    @JoinTable(name = "Class_ownedComment",
        joinColumns = @JoinColumn(name = "ClassId"),
    ...
    @JoinTable(name = "Class_powertypeExtent",
        joinColumns = @JoinColumn(name = "ClassId"),
