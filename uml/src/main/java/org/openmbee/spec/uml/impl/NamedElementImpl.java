...
public abstract class NamedElementImpl extends MofObjectImpl implements NamedElement {
    ...
    @Column(name = "name", table = "NamedElement")
    ...
    @JoinColumn(name = "nameExpressionId", table = "NamedElement")
    ...
    @JoinTable(name = "NamedElement_ownedComment",
        joinColumns = @JoinColumn(name = "NamedElementId"),
