...
import org.openmbee.spec.uml.DecisionNode;
...
@Table(appliesTo = "DecisionNode", fetch = FetchMode.SELECT, optional = false)
...
public class DecisionNodeImpl extends MofObjectImpl implements DecisionNode {
    ...
    private Behavior decisionInput;
    ...
    private ObjectFlow decisionInputFlow;
    ...
    @JoinTable(name = "DecisionNode_redefinedNode",
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "DecisionNode")
    ...
    @JoinTable(name = "DecisionNode_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "DecisionNodeId"),
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "BehaviorMetaDef", metaColumn = @Column(name = "decisionInputType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "decisionInputId", table = "DecisionNode")
    ...
    @JoinTable(name = "DecisionNode_outgoing",
        joinColumns = @JoinColumn(name = "DecisionNodeId"),
    ...
    @JoinTable(name = "DecisionNode_inPartition",
        joinColumns = @JoinColumn(name = "DecisionNodeId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "DecisionNode")
    ...
    @JoinTable(name = "DecisionNode_incoming",
        joinColumns = @JoinColumn(name = "DecisionNodeId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "DecisionNode")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "ObjectFlowMetaDef", metaColumn = @Column(name = "decisionInputFlowType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "decisionInputFlowId", table = "DecisionNode")
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(using = MofObjectDeserializer.class, as = ObjectFlowImpl.class)
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "DecisionNode")
    ...
    @JoinTable(name = "DecisionNode_ownedComment",
        joinColumns = @JoinColumn(name = "DecisionNodeId"),
    ...
    @JoinColumn(name = "activityId", table = "DecisionNode")
