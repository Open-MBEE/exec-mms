...
@Entity
@SecondaryTable(name = "Enumeration")
@Table(appliesTo = "Enumeration", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Enumeration")
@JsonTypeName(value = "Enumeration")
public class EnumerationImpl extends MofObjectImpl implements Enumeration {
    ...
    private List<EnumerationLiteral> ownedLiteral;
    ...
    @JoinTable(name = "Enumeration_ownedAttribute",
        joinColumns = @JoinColumn(name = "EnumerationId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "Enumeration")
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "EnumerationLiteralMetaDef", metaColumn = @Column(name = "ownedLiteralType"), fetch = FetchType.LAZY)
    @JoinTable(name = "Enumeration_ownedLiteral",
        joinColumns = @JoinColumn(name = "EnumerationId"),
        inverseJoinColumns = @JoinColumn(name = "ownedLiteralId"))
    public List<EnumerationLiteral> getOwnedLiteral() {
        if (ownedLiteral == null) {
            ownedLiteral = new ArrayList<>();
        }
        return ownedLiteral;
    }
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(contentUsing = MofObjectDeserializer.class, contentAs = EnumerationLiteralImpl.class)
    ...
    @JoinTable(name = "Enumeration_useCase",
        joinColumns = @JoinColumn(name = "EnumerationId"),
    ...
    @JoinTable(name = "Enumeration_elementImport",
        joinColumns = @JoinColumn(name = "EnumerationId"),
    ...
    @Column(name = "name", table = "Enumeration")
    ...
    @JoinTable(name = "Enumeration_substitution",
        joinColumns = @JoinColumn(name = "EnumerationId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "Enumeration")
    ...
    @JoinTable(name = "Enumeration_generalization",
        joinColumns = @JoinColumn(name = "EnumerationId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "Enumeration")
    ...
    @JoinTable(name = "Enumeration_packageImport",
        joinColumns = @JoinColumn(name = "EnumerationId"),
    ...
    @JoinTable(name = "Enumeration_redefinedClassifier",
        joinColumns = @JoinColumn(name = "EnumerationId"),
    ...
    @JoinTable(name = "Enumeration_ownedRule",
        joinColumns = @JoinColumn(name = "EnumerationId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Enumeration")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "Enumeration")
    ...
    @JoinTable(name = "Enumeration_collaborationUse",
        joinColumns = @JoinColumn(name = "EnumerationId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Enumeration")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "Enumeration")
    ...
    @JoinTable(name = "Enumeration_ownedUseCase",
        joinColumns = @JoinColumn(name = "EnumerationId"),
    ...
    @JoinTable(name = "Enumeration_templateBinding",
        joinColumns = @JoinColumn(name = "EnumerationId"),
    ...
    @JoinColumn(name = "package_Id", table = "Enumeration")
    ...
    @JoinColumn(name = "representationId", table = "Enumeration")
    ...
    @JoinTable(name = "Enumeration_ownedOperation",
        joinColumns = @JoinColumn(name = "EnumerationId"),
    ...
    @JoinTable(name = "Enumeration_ownedComment",
        joinColumns = @JoinColumn(name = "EnumerationId"),
    ...
    @JoinTable(name = "Enumeration_powertypeExtent",
        joinColumns = @JoinColumn(name = "EnumerationId"),
