...
import org.openmbee.spec.uml.ReadExtentAction;
...
@Entity
@SecondaryTable(name = "ReadExtentAction")
@Table(appliesTo = "ReadExtentAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ReadExtentAction")
@JsonTypeName(value = "ReadExtentAction")
public class ReadExtentActionImpl extends MofObjectImpl implements ReadExtentAction {
    ...
    @JoinTable(name = "ReadExtentAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ReadExtentActionId"),
    ...
    @JoinColumn(name = "resultId", table = "ReadExtentAction")
    ...
    @Column(name = "name", table = "ReadExtentAction")
    ...
    @JoinTable(name = "ReadExtentAction_localPrecondition",
        joinColumns = @JoinColumn(name = "ReadExtentActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ReadExtentAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ReadExtentAction")
    ...
    @JoinColumn(name = "activityId", table = "ReadExtentAction")
    ...
    @JoinTable(name = "ReadExtentAction_localPostcondition",
        joinColumns = @JoinColumn(name = "ReadExtentActionId"),
    ...
    @JoinTable(name = "ReadExtentAction_redefinedNode",
        joinColumns = @JoinColumn(name = "ReadExtentActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ReadExtentAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "ReadExtentAction")
    ...
    @JoinTable(name = "ReadExtentAction_handler",
        joinColumns = @JoinColumn(name = "ReadExtentActionId"),
    ...
    @JoinTable(name = "ReadExtentAction_outgoing",
        joinColumns = @JoinColumn(name = "ReadExtentActionId"),
    ...
    @JoinTable(name = "ReadExtentAction_inPartition",
        joinColumns = @JoinColumn(name = "ReadExtentActionId"),
    ...
    @JoinTable(name = "ReadExtentAction_incoming",
        joinColumns = @JoinColumn(name = "ReadExtentActionId"),
    ...
    @JoinColumn(name = "classifierId", table = "ReadExtentAction")
    ...
    @JoinTable(name = "ReadExtentAction_ownedComment",
        joinColumns = @JoinColumn(name = "ReadExtentActionId"),
