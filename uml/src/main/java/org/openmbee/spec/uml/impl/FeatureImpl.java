...
public abstract class FeatureImpl extends MofObjectImpl implements Feature {
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "Feature")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isStatic", table = "Feature")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "Feature")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Feature")
    ...
    @JoinTable(name = "Feature_ownedComment",
