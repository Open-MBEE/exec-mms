...
import org.openmbee.spec.uml.ControlNode;
...
public abstract class ControlNodeImpl extends MofObjectImpl implements ControlNode {
    ...
    @JoinTable(name = "ControlNode_redefinedNode",
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ControlNode")
    ...
    @JoinTable(name = "ControlNode_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ControlNodeId"),
    ...
    @JoinTable(name = "ControlNode_outgoing",
        joinColumns = @JoinColumn(name = "ControlNodeId"),
    ...
    @JoinTable(name = "ControlNode_inPartition",
        joinColumns = @JoinColumn(name = "ControlNodeId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "ControlNode")
    ...
    @JoinTable(name = "ControlNode_incoming",
        joinColumns = @JoinColumn(name = "ControlNodeId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ControlNode")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ControlNode")
    ...
    @JoinTable(name = "ControlNode_ownedComment",
        joinColumns = @JoinColumn(name = "ControlNodeId"),
    ...
    @JoinColumn(name = "activityId", table = "ControlNode")
