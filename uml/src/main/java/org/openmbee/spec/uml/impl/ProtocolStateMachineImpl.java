...
@Entity
@SecondaryTable(name = "ProtocolStateMachine")
@Table(appliesTo = "ProtocolStateMachine", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ProtocolStateMachine")
@JsonTypeName(value = "ProtocolStateMachine")
public class ProtocolStateMachineImpl extends MofObjectImpl implements ProtocolStateMachine {
    ...
    private Collection<ProtocolConformance> conformance;
    ...
    private Collection<State> submachineState;
    ...
    @JoinTable(name = "ProtocolStateMachine_ownedParameterSet",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinTable(name = "ProtocolStateMachine_elementImport",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @Column(name = "name", table = "ProtocolStateMachine")
    ...
    @JoinColumn(name = "specificationId", table = "ProtocolStateMachine")
    ...
    @JoinColumn(name = "nameExpressionId", table = "ProtocolStateMachine")
    ...
    @JoinTable(name = "ProtocolStateMachine_generalization",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinTable(name = "ProtocolStateMachine_packageImport",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinTable(name = "ProtocolStateMachine_precondition",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinTable(name = "ProtocolStateMachine_ownedOperation",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ProtocolStateMachine")
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "ProtocolConformanceMetaDef", metaColumn = @Column(name = "conformanceType"), fetch = FetchType.LAZY)
    @JoinTable(name = "ProtocolStateMachine_conformance",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
        inverseJoinColumns = @JoinColumn(name = "conformanceId"))
    public Collection<ProtocolConformance> getConformance() {
        if (conformance == null) {
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(contentUsing = MofObjectDeserializer.class, contentAs = ProtocolConformanceImpl.class)
    public void setConformance(Collection<ProtocolConformance> conformance) {
    ...
    @JoinTable(name = "ProtocolStateMachine_ownedAttribute",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinTable(name = "ProtocolStateMachine_templateBinding",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinColumn(name = "representationId", table = "ProtocolStateMachine")
    ...
    @JoinTable(name = "ProtocolStateMachine_ownedReception",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "ProtocolStateMachine")
    ...
    @JoinTable(name = "ProtocolStateMachine_useCase",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinTable(name = "ProtocolStateMachine_ownedBehavior",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinColumn(name = "classifierBehaviorId", table = "ProtocolStateMachine")
    ...
    @JoinTable(name = "ProtocolStateMachine_substitution",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinTable(name = "ProtocolStateMachine_ownedConnector",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "ProtocolStateMachine")
    ...
    @JoinTable(name = "ProtocolStateMachine_interfaceRealization",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinTable(name = "ProtocolStateMachine_redefinedClassifier",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinTable(name = "ProtocolStateMachine_ownedRule",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "ProtocolStateMachine")
    ...
    @JoinTable(name = "ProtocolStateMachine_collaborationUse",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinTable(name = "ProtocolStateMachine_connectionPoint",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "ProtocolStateMachine")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isReentrant", table = "ProtocolStateMachine")
    ...
    @JoinTable(name = "ProtocolStateMachine_ownedParameter",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "ProtocolStateMachine")
    ...
    @JoinTable(name = "ProtocolStateMachine_nestedClassifier",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinTable(name = "ProtocolStateMachine_ownedUseCase",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isActive", table = "ProtocolStateMachine")
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "StateMetaDef", metaColumn = @Column(name = "submachineStateType"), fetch = FetchType.LAZY)
    @JoinTable(name = "ProtocolStateMachine_submachineState",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
        inverseJoinColumns = @JoinColumn(name = "submachineStateId"))
    public Collection<State> getSubmachineState() {
        if (submachineState == null) {
            submachineState = new ArrayList<>();
        }
    ...
    public void setSubmachineState(Collection<State> submachineState) {
    ...
    @JoinColumn(name = "package_Id", table = "ProtocolStateMachine")
    ...
    @JoinTable(name = "ProtocolStateMachine_postcondition",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinTable(name = "ProtocolStateMachine_redefinedBehavior",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinTable(name = "ProtocolStateMachine_region",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinTable(name = "ProtocolStateMachine_ownedComment",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
    ...
    @JoinTable(name = "ProtocolStateMachine_powertypeExtent",
        joinColumns = @JoinColumn(name = "ProtocolStateMachineId"),
