...
@Table(appliesTo = "Activity", fetch = FetchMode.SELECT, optional = false)
...
public class ActivityImpl extends MofObjectImpl implements Activity {
    ...
    private Collection<ActivityPartition> partition;
    private Collection<ElementImport> elementImport;
    private String name;
    private Collection<ActivityGroup> group;
    ...
    private Collection<StructuredActivityNode> structuredNode;
    ...
    @JoinTable(name = "Activity_ownedParameterSet",
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "ActivityPartitionMetaDef", metaColumn = @Column(name = "partitionType"), fetch = FetchType.LAZY)
    @JoinTable(name = "Activity_partition",
        joinColumns = @JoinColumn(name = "ActivityId"),
        inverseJoinColumns = @JoinColumn(name = "partitionId"))
    public Collection<ActivityPartition> getPartition() {
        if (partition == null) {
    ...
    public void setPartition(Collection<ActivityPartition> partition) {
    ...
    @JoinTable(name = "Activity_elementImport",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @Column(name = "name", table = "Activity")
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "ActivityGroupMetaDef", metaColumn = @Column(name = "groupType"), fetch = FetchType.LAZY)
    @JoinTable(name = "Activity_group",
        joinColumns = @JoinColumn(name = "ActivityId"),
        inverseJoinColumns = @JoinColumn(name = "groupId"))
    public Collection<ActivityGroup> getGroup() {
        if (group == null) {
            group = new ArrayList<>();
        }
        return group;
    ...
    public void setGroup(Collection<ActivityGroup> group) {
        this.group = group;
    }
    ...
    @JoinColumn(name = "specificationId", table = "Activity")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Activity")
    ...
    @JoinTable(name = "Activity_generalization",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JoinTable(name = "Activity_packageImport",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JoinTable(name = "Activity_precondition",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JoinTable(name = "Activity_ownedOperation",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "Activity")
    ...
    @JoinTable(name = "Activity_ownedAttribute",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JoinTable(name = "Activity_templateBinding",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JoinColumn(name = "representationId", table = "Activity")
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "StructuredActivityNodeMetaDef", metaColumn = @Column(name = "structuredNodeType"), fetch = FetchType.LAZY)
    @JoinTable(name = "Activity_structuredNode",
        joinColumns = @JoinColumn(name = "ActivityId"),
        inverseJoinColumns = @JoinColumn(name = "structuredNodeId"))
    public Collection<StructuredActivityNode> getStructuredNode() {
        if (structuredNode == null) {
            structuredNode = new ArrayList<>();
        }
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(contentUsing = MofObjectDeserializer.class, contentAs = StructuredActivityNodeImpl.class)
    public void setStructuredNode(Collection<StructuredActivityNode> structuredNode) {
    ...
    @JoinTable(name = "Activity_ownedReception",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "Activity")
    ...
    @JoinTable(name = "Activity_useCase",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JoinTable(name = "Activity_ownedBehavior",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JoinColumn(name = "classifierBehaviorId", table = "Activity")
    ...
    @JoinTable(name = "Activity_substitution",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JoinTable(name = "Activity_ownedConnector",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isSingleExecution", table = "Activity")
    ...
    @JsonProperty(required = true)
    @JsonSetter
    public void setSingleExecution(Boolean isSingleExecution) {
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "Activity")
    ...
    @JoinTable(name = "Activity_interfaceRealization",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JoinTable(name = "Activity_redefinedClassifier",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JoinTable(name = "Activity_ownedRule",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Activity")
    ...
    @JoinTable(name = "Activity_collaborationUse",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isReadOnly", table = "Activity")
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Activity")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isReentrant", table = "Activity")
    ...
    @JoinTable(name = "Activity_ownedParameter",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "Activity")
    ...
    @JoinTable(name = "Activity_nestedClassifier",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JoinTable(name = "Activity_ownedUseCase",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isActive", table = "Activity")
    ...
    @JoinColumn(name = "package_Id", table = "Activity")
    ...
    @JoinTable(name = "Activity_postcondition",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JoinTable(name = "Activity_redefinedBehavior",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JoinTable(name = "Activity_ownedComment",
        joinColumns = @JoinColumn(name = "ActivityId"),
    ...
    @JoinTable(name = "Activity_powertypeExtent",
        joinColumns = @JoinColumn(name = "ActivityId"),
