...
import org.openmbee.spec.uml.IntervalConstraint;
...
@Entity
@SecondaryTable(name = "IntervalConstraint")
@Table(appliesTo = "IntervalConstraint", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "IntervalConstraint")
@JsonTypeName(value = "IntervalConstraint")
public class IntervalConstraintImpl extends MofObjectImpl implements IntervalConstraint {
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "IntervalConstraint")
    ...
    @JoinColumn(name = "contextId", table = "IntervalConstraint")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "IntervalMetaDef", metaColumn = @Column(name = "specificationType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "specificationId", table = "IntervalConstraint")
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(using = MofObjectDeserializer.class, as = IntervalImpl.class)
    public void setSpecification(Interval specification) {
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "IntervalConstraint")
    ...
    @JoinColumn(name = "templateParameterId", table = "IntervalConstraint")
    ...
    @JoinColumn(name = "nameExpressionId", table = "IntervalConstraint")
    ...
    @JoinTable(name = "IntervalConstraint_constrainedElement",
        joinColumns = @JoinColumn(name = "IntervalConstraintId"),
    ...
    @JoinTable(name = "IntervalConstraint_ownedComment",
        joinColumns = @JoinColumn(name = "IntervalConstraintId"),
