...
import org.openmbee.spec.uml.CreateObjectAction;
...
@Entity
@SecondaryTable(name = "CreateObjectAction")
@Table(appliesTo = "CreateObjectAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "CreateObjectAction")
@JsonTypeName(value = "CreateObjectAction")
public class CreateObjectActionImpl extends MofObjectImpl implements CreateObjectAction {
    ...
    @JoinTable(name = "CreateObjectAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "CreateObjectActionId"),
    ...
    @JoinColumn(name = "resultId", table = "CreateObjectAction")
    ...
    @Column(name = "name", table = "CreateObjectAction")
    ...
    @JoinTable(name = "CreateObjectAction_localPrecondition",
        joinColumns = @JoinColumn(name = "CreateObjectActionId"),
    ...
    @JoinColumn(name = "classifierId", table = "CreateObjectAction")
    ...
    @JoinColumn(name = "nameExpressionId", table = "CreateObjectAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "CreateObjectAction")
    ...
    @JoinColumn(name = "activityId", table = "CreateObjectAction")
    ...
    @JoinTable(name = "CreateObjectAction_localPostcondition",
        joinColumns = @JoinColumn(name = "CreateObjectActionId"),
    ...
    @JoinTable(name = "CreateObjectAction_redefinedNode",
        joinColumns = @JoinColumn(name = "CreateObjectActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "CreateObjectAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "CreateObjectAction")
    ...
    @JoinTable(name = "CreateObjectAction_handler",
        joinColumns = @JoinColumn(name = "CreateObjectActionId"),
    ...
    @JoinTable(name = "CreateObjectAction_outgoing",
        joinColumns = @JoinColumn(name = "CreateObjectActionId"),
    ...
    @JoinTable(name = "CreateObjectAction_inPartition",
        joinColumns = @JoinColumn(name = "CreateObjectActionId"),
    ...
    @JoinTable(name = "CreateObjectAction_incoming",
        joinColumns = @JoinColumn(name = "CreateObjectActionId"),
    ...
    @JoinTable(name = "CreateObjectAction_ownedComment",
        joinColumns = @JoinColumn(name = "CreateObjectActionId"),
