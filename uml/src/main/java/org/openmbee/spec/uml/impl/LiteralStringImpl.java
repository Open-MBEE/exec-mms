...
import org.openmbee.spec.uml.LiteralString;
...
@Table(appliesTo = "LiteralString", fetch = FetchMode.SELECT, optional = false)
...
public class LiteralStringImpl extends MofObjectImpl implements LiteralString {
    ...
    @JoinColumn(name = "typeId", table = "LiteralString")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "LiteralString")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "value", table = "LiteralString")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "LiteralString")
    ...
    @JoinColumn(name = "templateParameterId", table = "LiteralString")
    ...
    @JoinColumn(name = "nameExpressionId", table = "LiteralString")
    ...
    @JoinTable(name = "LiteralString_ownedComment",
