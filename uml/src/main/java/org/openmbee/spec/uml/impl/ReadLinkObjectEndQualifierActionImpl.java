...
import org.openmbee.spec.uml.ReadLinkObjectEndQualifierAction;
...
@Entity
@SecondaryTable(name = "ReadLinkObjectEndQualifierAction")
@Table(appliesTo = "ReadLinkObjectEndQualifierAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ReadLinkObjectEndQualifierAction")
@JsonTypeName(value = "ReadLinkObjectEndQualifierAction")
public class ReadLinkObjectEndQualifierActionImpl extends MofObjectImpl implements
    ...
    @JoinTable(name = "ReadLinkObjectEndQualifierAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ReadLinkObjectEndQualifierActionId"),
    ...
    @Column(name = "name", table = "ReadLinkObjectEndQualifierAction")
    ...
    @JoinTable(name = "ReadLinkObjectEndQualifierAction_localPrecondition",
        joinColumns = @JoinColumn(name = "ReadLinkObjectEndQualifierActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ReadLinkObjectEndQualifierAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ReadLinkObjectEndQualifierAction")
    ...
    @JoinColumn(name = "activityId", table = "ReadLinkObjectEndQualifierAction")
    ...
    @JoinTable(name = "ReadLinkObjectEndQualifierAction_localPostcondition",
        joinColumns = @JoinColumn(name = "ReadLinkObjectEndQualifierActionId"),
    ...
    @JoinTable(name = "ReadLinkObjectEndQualifierAction_redefinedNode",
        joinColumns = @JoinColumn(name = "ReadLinkObjectEndQualifierActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ReadLinkObjectEndQualifierAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "ReadLinkObjectEndQualifierAction")
    ...
    @JoinTable(name = "ReadLinkObjectEndQualifierAction_handler",
        joinColumns = @JoinColumn(name = "ReadLinkObjectEndQualifierActionId"),
    ...
    @JoinTable(name = "ReadLinkObjectEndQualifierAction_outgoing",
        joinColumns = @JoinColumn(name = "ReadLinkObjectEndQualifierActionId"),
    ...
    @JoinColumn(name = "objectId", table = "ReadLinkObjectEndQualifierAction")
    ...
    @JoinColumn(name = "resultId", table = "ReadLinkObjectEndQualifierAction")
    ...
    @JoinTable(name = "ReadLinkObjectEndQualifierAction_inPartition",
        joinColumns = @JoinColumn(name = "ReadLinkObjectEndQualifierActionId"),
    ...
    @JoinColumn(name = "qualifierId", table = "ReadLinkObjectEndQualifierAction")
    ...
    @JoinTable(name = "ReadLinkObjectEndQualifierAction_incoming",
        joinColumns = @JoinColumn(name = "ReadLinkObjectEndQualifierActionId"),
    ...
    @JoinTable(name = "ReadLinkObjectEndQualifierAction_ownedComment",
        joinColumns = @JoinColumn(name = "ReadLinkObjectEndQualifierActionId"),
