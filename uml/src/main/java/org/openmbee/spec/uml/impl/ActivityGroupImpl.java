...
public abstract class ActivityGroupImpl extends MofObjectImpl implements ActivityGroup {
    ...
    @JoinColumn(name = "inActivityId", table = "ActivityGroup")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "ActivityGroup")
    ...
    @JoinColumn(name = "nameExpressionId", table = "ActivityGroup")
    ...
    @JoinTable(name = "ActivityGroup_ownedComment",
        joinColumns = @JoinColumn(name = "ActivityGroupId"),
