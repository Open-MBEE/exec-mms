...
import org.openmbee.spec.uml.ValueSpecificationAction;
import org.openmbee.spec.uml.VisibilityKind;
import org.openmbee.spec.uml.jackson.MofObjectDeserializer;
import org.openmbee.spec.uml.jackson.MofObjectSerializer;

@Entity
@SecondaryTable(name = "ValueSpecificationAction")
@Table(appliesTo = "ValueSpecificationAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ValueSpecificationAction")
@JsonTypeName(value = "ValueSpecificationAction")
public class ValueSpecificationActionImpl extends MofObjectImpl implements
    ...
    @JoinTable(name = "ValueSpecificationAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ValueSpecificationActionId"),
    ...
    @Column(name = "name", table = "ValueSpecificationAction")
    ...
    @JoinTable(name = "ValueSpecificationAction_localPrecondition",
        joinColumns = @JoinColumn(name = "ValueSpecificationActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ValueSpecificationAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ValueSpecificationAction")
    ...
    @JoinColumn(name = "activityId", table = "ValueSpecificationAction")
    ...
    @JoinTable(name = "ValueSpecificationAction_localPostcondition",
        joinColumns = @JoinColumn(name = "ValueSpecificationActionId"),
    ...
    @JoinTable(name = "ValueSpecificationAction_redefinedNode",
        joinColumns = @JoinColumn(name = "ValueSpecificationActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ValueSpecificationAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "ValueSpecificationAction")
    ...
    @JoinTable(name = "ValueSpecificationAction_handler",
        joinColumns = @JoinColumn(name = "ValueSpecificationActionId"),
    ...
    @JoinTable(name = "ValueSpecificationAction_outgoing",
        joinColumns = @JoinColumn(name = "ValueSpecificationActionId"),
    ...
    @JoinTable(name = "ValueSpecificationAction_inPartition",
        joinColumns = @JoinColumn(name = "ValueSpecificationActionId"),
    ...
    @JoinTable(name = "ValueSpecificationAction_incoming",
        joinColumns = @JoinColumn(name = "ValueSpecificationActionId"),
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "ValueSpecificationMetaDef", metaColumn = @Column(name = "valueType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "valueId", table = "ValueSpecificationAction")
    ...
    @JoinColumn(name = "resultId", table = "ValueSpecificationAction")
    ...
    @JoinTable(name = "ValueSpecificationAction_ownedComment",
        joinColumns = @JoinColumn(name = "ValueSpecificationActionId"),
