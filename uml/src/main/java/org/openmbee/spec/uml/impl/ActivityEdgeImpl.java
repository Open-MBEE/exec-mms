...
public abstract class ActivityEdgeImpl extends MofObjectImpl implements ActivityEdge {
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ActivityEdge")
    ...
    @JoinColumn(name = "sourceId", table = "ActivityEdge")
    ...
    @JoinColumn(name = "guardId", table = "ActivityEdge")
    ...
    @JoinColumn(name = "targetId", table = "ActivityEdge")
    ...
    @JoinTable(name = "ActivityEdge_redefinedEdge",
        joinColumns = @JoinColumn(name = "ActivityEdgeId"),
    ...
    @JoinColumn(name = "interruptsId", table = "ActivityEdge")
    ...
    @JoinTable(name = "ActivityEdge_inPartition",
        joinColumns = @JoinColumn(name = "ActivityEdgeId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "ActivityEdge")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ActivityEdge")
    ...
    @JoinColumn(name = "nameExpressionId", table = "ActivityEdge")
    ...
    @JoinColumn(name = "weightId", table = "ActivityEdge")
    ...
    @JoinColumn(name = "activityId", table = "ActivityEdge")
    ...
    @JoinTable(name = "ActivityEdge_ownedComment",
        joinColumns = @JoinColumn(name = "ActivityEdgeId"),
