...
import org.openmbee.spec.uml.CallOperationAction;
...
@Entity
@SecondaryTable(name = "CallOperationAction")
@Table(appliesTo = "CallOperationAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "CallOperationAction")
@JsonTypeName(value = "CallOperationAction")
public class CallOperationActionImpl extends MofObjectImpl implements CallOperationAction {
    ...
    @JoinColumn(name = "onPortId", table = "CallOperationAction")
    ...
    @JoinTable(name = "CallOperationAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "CallOperationActionId"),
    ...
    @JoinTable(name = "CallOperationAction_argument",
        joinColumns = @JoinColumn(name = "CallOperationActionId"),
    ...
    @Column(name = "name", table = "CallOperationAction")
    ...
    @JoinTable(name = "CallOperationAction_localPrecondition",
        joinColumns = @JoinColumn(name = "CallOperationActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "CallOperationAction")
    ...
    @JoinTable(name = "CallOperationAction_result",
        joinColumns = @JoinColumn(name = "CallOperationActionId"),
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "CallOperationAction")
    ...
    @JoinColumn(name = "activityId", table = "CallOperationAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isSynchronous", table = "CallOperationAction")
    ...
    @JoinTable(name = "CallOperationAction_localPostcondition",
        joinColumns = @JoinColumn(name = "CallOperationActionId"),
    ...
    @JoinTable(name = "CallOperationAction_redefinedNode",
        joinColumns = @JoinColumn(name = "CallOperationActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "CallOperationAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "CallOperationAction")
    ...
    @JoinTable(name = "CallOperationAction_handler",
        joinColumns = @JoinColumn(name = "CallOperationActionId"),
    ...
    @JoinColumn(name = "targetId", table = "CallOperationAction")
    ...
    @JoinTable(name = "CallOperationAction_outgoing",
        joinColumns = @JoinColumn(name = "CallOperationActionId"),
    ...
    @JoinTable(name = "CallOperationAction_inPartition",
        joinColumns = @JoinColumn(name = "CallOperationActionId"),
    ...
    @JoinTable(name = "CallOperationAction_incoming",
        joinColumns = @JoinColumn(name = "CallOperationActionId"),
    ...
    @JoinColumn(name = "operationId", table = "CallOperationAction")
    ...
    @JoinTable(name = "CallOperationAction_ownedComment",
        joinColumns = @JoinColumn(name = "CallOperationActionId"),
