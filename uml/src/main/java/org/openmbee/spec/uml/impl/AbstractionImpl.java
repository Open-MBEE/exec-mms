...
import org.openmbee.spec.uml.Abstraction;
...
@Entity
@SecondaryTable(name = "Abstraction")
@Table(appliesTo = "Abstraction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Abstraction")
@JsonTypeName(value = "Abstraction")
public class AbstractionImpl extends MofObjectImpl implements Abstraction {
    ...
    @JoinTable(name = "Abstraction_client",
        joinColumns = @JoinColumn(name = "AbstractionId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Abstraction")
    ...
    @JoinColumn(name = "mappingId", table = "Abstraction")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "Abstraction")
    ...
    @JoinTable(name = "Abstraction_supplier",
        joinColumns = @JoinColumn(name = "AbstractionId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Abstraction")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Abstraction")
    ...
    @JoinTable(name = "Abstraction_ownedComment",
        joinColumns = @JoinColumn(name = "AbstractionId"),
