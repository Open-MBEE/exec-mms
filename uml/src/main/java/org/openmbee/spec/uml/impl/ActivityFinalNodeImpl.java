...
import org.openmbee.spec.uml.ActivityFinalNode;
...
@Entity
@SecondaryTable(name = "ActivityFinalNode")
@Table(appliesTo = "ActivityFinalNode", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ActivityFinalNode")
@JsonTypeName(value = "ActivityFinalNode")
public class ActivityFinalNodeImpl extends MofObjectImpl implements ActivityFinalNode {
    ...
    @JoinTable(name = "ActivityFinalNode_redefinedNode",
        joinColumns = @JoinColumn(name = "ActivityFinalNodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ActivityFinalNode")
    ...
    @JoinTable(name = "ActivityFinalNode_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ActivityFinalNodeId"),
    ...
    @JoinTable(name = "ActivityFinalNode_outgoing",
        joinColumns = @JoinColumn(name = "ActivityFinalNodeId"),
    ...
    @JoinTable(name = "ActivityFinalNode_inPartition",
        joinColumns = @JoinColumn(name = "ActivityFinalNodeId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "ActivityFinalNode")
    ...
    @JoinTable(name = "ActivityFinalNode_incoming",
        joinColumns = @JoinColumn(name = "ActivityFinalNodeId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ActivityFinalNode")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ActivityFinalNode")
    ...
    @JoinTable(name = "ActivityFinalNode_ownedComment",
        joinColumns = @JoinColumn(name = "ActivityFinalNodeId"),
    ...
    @JoinColumn(name = "activityId", table = "ActivityFinalNode")
