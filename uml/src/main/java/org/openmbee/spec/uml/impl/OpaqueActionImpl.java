...
import org.openmbee.spec.uml.OpaqueAction;
...
@Entity
@SecondaryTable(name = "OpaqueAction")
@Table(appliesTo = "OpaqueAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "OpaqueAction")
@JsonTypeName(value = "OpaqueAction")
public class OpaqueActionImpl extends MofObjectImpl implements OpaqueAction {
    ...
    private Collection<OutputPin> outputValue;
    ...
    @JoinTable(name = "OpaqueAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "OpaqueActionId"),
    ...
    @CollectionTable(name = "OpaqueAction_language",
        joinColumns = @JoinColumn(name = "OpaqueActionId"))
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "OpaqueAction")
    ...
    @JoinTable(name = "OpaqueAction_localPrecondition",
        joinColumns = @JoinColumn(name = "OpaqueActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "OpaqueAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "OpaqueAction")
    ...
    @JoinColumn(name = "activityId", table = "OpaqueAction")
    ...
    @JoinTable(name = "OpaqueAction_localPostcondition",
        joinColumns = @JoinColumn(name = "OpaqueActionId"),
    ...
    @JoinTable(name = "OpaqueAction_redefinedNode",
        joinColumns = @JoinColumn(name = "OpaqueActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "OpaqueAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "OpaqueAction")
    ...
    @JoinTable(name = "OpaqueAction_handler",
        joinColumns = @JoinColumn(name = "OpaqueActionId"),
    ...
    @JoinTable(name = "OpaqueAction_outgoing",
        joinColumns = @JoinColumn(name = "OpaqueActionId"),
    ...
    @JoinTable(name = "OpaqueAction_inPartition",
        joinColumns = @JoinColumn(name = "OpaqueActionId"),
    ...
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @ElementCollection(targetClass = String.class)
    @CollectionTable(name = "OpaqueAction_body",
        joinColumns = @JoinColumn(name = "OpaqueActionId"))
    ...
    @JoinTable(name = "OpaqueAction_incoming",
        joinColumns = @JoinColumn(name = "OpaqueActionId"),
    ...
    @JoinTable(name = "OpaqueAction_inputValue",
        joinColumns = @JoinColumn(name = "OpaqueActionId"),
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "OutputPinMetaDef", metaColumn = @Column(name = "outputValueType"), fetch = FetchType.LAZY)
    @JoinTable(name = "OpaqueAction_outputValue",
        joinColumns = @JoinColumn(name = "OpaqueActionId"),
        inverseJoinColumns = @JoinColumn(name = "outputValueId"))
    public Collection<OutputPin> getOutputValue() {
        if (outputValue == null) {
    ...
    @JsonSetter
    @JsonDeserialize(contentUsing = MofObjectDeserializer.class, contentAs = OutputPinImpl.class)
    public void setOutputValue(Collection<OutputPin> outputValue) {
    ...
    @JoinTable(name = "OpaqueAction_ownedComment",
        joinColumns = @JoinColumn(name = "OpaqueActionId"),
