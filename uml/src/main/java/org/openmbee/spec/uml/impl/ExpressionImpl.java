...
import org.openmbee.spec.uml.Expression;
...
@Table(appliesTo = "Expression", fetch = FetchMode.SELECT, optional = false)
...
public class ExpressionImpl extends MofObjectImpl implements Expression {
    ...
    @JoinTable(name = "Expression_operand",
    ...
    @Column(name = "symbol", table = "Expression")
    ...
    @JoinColumn(name = "typeId", table = "Expression")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Expression")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "Expression")
    ...
    @JoinColumn(name = "templateParameterId", table = "Expression")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Expression")
    ...
    @JoinTable(name = "Expression_ownedComment",
        joinColumns = @JoinColumn(name = "ExpressionId"),
