...
public abstract class ExecutionSpecificationImpl extends MofObjectImpl implements
    ...
    @JoinColumn(name = "startId", table = "ExecutionSpecification")
    ...
    @JoinTable(name = "ExecutionSpecification_generalOrdering",
        joinColumns = @JoinColumn(name = "ExecutionSpecificationId"),
    ...
    @JoinColumn(name = "finishId", table = "ExecutionSpecification")
    ...
    @JoinColumn(name = "enclosingInteractionId", table = "ExecutionSpecification")
    ...
    @JoinColumn(name = "enclosingOperandId", table = "ExecutionSpecification")
    ...
    @JoinTable(name = "ExecutionSpecification_covered",
        joinColumns = @JoinColumn(name = "ExecutionSpecificationId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "ExecutionSpecification")
    ...
    @JoinColumn(name = "nameExpressionId", table = "ExecutionSpecification")
    ...
    @JoinTable(name = "ExecutionSpecification_ownedComment",
        joinColumns = @JoinColumn(name = "ExecutionSpecificationId"),
