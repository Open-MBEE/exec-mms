...
import org.openmbee.spec.uml.ActionInputPin;
...
@Entity
@SecondaryTable(name = "ActionInputPin")
@Table(appliesTo = "ActionInputPin", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ActionInputPin")
@JsonTypeName(value = "ActionInputPin")
public class ActionInputPinImpl extends MofObjectImpl implements ActionInputPin {
    ...
    @JoinTable(name = "ActionInputPin_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ActionInputPinId"),
    ...
    @JoinColumn(name = "upperBoundId", table = "ActionInputPin")
    ...
    @JoinColumn(name = "typeId", table = "ActionInputPin")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "lowerValueId", table = "ActionInputPin")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isOrdered", table = "ActionInputPin")
    ...
    @JoinTable(name = "ActionInputPin_inState",
        joinColumns = @JoinColumn(name = "ActionInputPinId"),
    ...
    @Column(name = "name", table = "ActionInputPin")
    ...
    @JoinColumn(name = "nameExpressionId", table = "ActionInputPin")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ActionInputPin")
    ...
    @JoinColumn(name = "activityId", table = "ActionInputPin")
    ...
    @JoinTable(name = "ActionInputPin_redefinedNode",
        joinColumns = @JoinColumn(name = "ActionInputPinId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ActionInputPin")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "ActionMetaDef", metaColumn = @Column(name = "fromActionType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "fromActionId", table = "ActionInputPin")
    ...
    @JoinColumn(name = "upperValueId", table = "ActionInputPin")
    ...
    @JoinTable(name = "ActionInputPin_outgoing",
        joinColumns = @JoinColumn(name = "ActionInputPinId"),
    ...
    @JoinColumn(name = "selectionId", table = "ActionInputPin")
    ...
    @JoinTable(name = "ActionInputPin_inPartition",
        joinColumns = @JoinColumn(name = "ActionInputPinId"),
    ...
    @JoinTable(name = "ActionInputPin_incoming",
        joinColumns = @JoinColumn(name = "ActionInputPinId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isUnique", table = "ActionInputPin")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isControlType", table = "ActionInputPin")
    ...
    @JoinTable(name = "ActionInputPin_ownedComment",
        joinColumns = @JoinColumn(name = "ActionInputPinId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isControl", table = "ActionInputPin")
