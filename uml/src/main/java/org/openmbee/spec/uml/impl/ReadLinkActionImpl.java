...
import org.openmbee.spec.uml.ReadLinkAction;
...
@Entity
@SecondaryTable(name = "ReadLinkAction")
@Table(appliesTo = "ReadLinkAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ReadLinkAction")
@JsonTypeName(value = "ReadLinkAction")
public class ReadLinkActionImpl extends MofObjectImpl implements ReadLinkAction {
    ...
    @JoinTable(name = "ReadLinkAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ReadLinkActionId"),
    ...
    @JoinTable(name = "ReadLinkAction_inputValue",
        joinColumns = @JoinColumn(name = "ReadLinkActionId"),
    ...
    @Column(name = "name", table = "ReadLinkAction")
    ...
    @JoinTable(name = "ReadLinkAction_localPrecondition",
        joinColumns = @JoinColumn(name = "ReadLinkActionId"),
    ...
    @JoinTable(name = "ReadLinkAction_endData",
        joinColumns = @JoinColumn(name = "ReadLinkActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ReadLinkAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ReadLinkAction")
    ...
    @JoinColumn(name = "activityId", table = "ReadLinkAction")
    ...
    @JoinTable(name = "ReadLinkAction_localPostcondition",
        joinColumns = @JoinColumn(name = "ReadLinkActionId"),
    ...
    @JoinTable(name = "ReadLinkAction_redefinedNode",
        joinColumns = @JoinColumn(name = "ReadLinkActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ReadLinkAction")
    ...
    @JoinColumn(name = "resultId", table = "ReadLinkAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "ReadLinkAction")
    ...
    @JoinTable(name = "ReadLinkAction_handler",
        joinColumns = @JoinColumn(name = "ReadLinkActionId"),
    ...
    @JoinTable(name = "ReadLinkAction_outgoing",
        joinColumns = @JoinColumn(name = "ReadLinkActionId"),
    ...
    @JoinTable(name = "ReadLinkAction_inPartition",
        joinColumns = @JoinColumn(name = "ReadLinkActionId"),
    ...
    @JoinTable(name = "ReadLinkAction_incoming",
        joinColumns = @JoinColumn(name = "ReadLinkActionId"),
    ...
    @JoinTable(name = "ReadLinkAction_ownedComment",
        joinColumns = @JoinColumn(name = "ReadLinkActionId"),
