...
public abstract class ObjectNodeImpl extends MofObjectImpl implements ObjectNode {
    ...
    @JoinTable(name = "ObjectNode_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ObjectNodeId"),
    ...
    @JoinColumn(name = "upperBoundId", table = "ObjectNode")
    ...
    @JoinColumn(name = "typeId", table = "ObjectNode")
    public Type getType() {
        return type;
    }
    ...
    @JoinTable(name = "ObjectNode_inState",
        joinColumns = @JoinColumn(name = "ObjectNodeId"),
    ...
    @Column(name = "name", table = "ObjectNode")
    ...
    @JoinColumn(name = "nameExpressionId", table = "ObjectNode")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ObjectNode")
    ...
    @JoinColumn(name = "activityId", table = "ObjectNode")
    ...
    @JoinTable(name = "ObjectNode_redefinedNode",
        joinColumns = @JoinColumn(name = "ObjectNodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ObjectNode")
    ...
    @JoinTable(name = "ObjectNode_outgoing",
        joinColumns = @JoinColumn(name = "ObjectNodeId"),
    ...
    @JoinColumn(name = "selectionId", table = "ObjectNode")
    ...
    @JoinTable(name = "ObjectNode_inPartition",
        joinColumns = @JoinColumn(name = "ObjectNodeId"),
    ...
    @JoinTable(name = "ObjectNode_incoming",
        joinColumns = @JoinColumn(name = "ObjectNodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isControlType", table = "ObjectNode")
    ...
    @JoinTable(name = "ObjectNode_ownedComment",
        joinColumns = @JoinColumn(name = "ObjectNodeId"),
