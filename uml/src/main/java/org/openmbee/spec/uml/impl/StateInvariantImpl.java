...
import org.openmbee.spec.uml.StateInvariant;
...
@Entity
@SecondaryTable(name = "StateInvariant")
@Table(appliesTo = "StateInvariant", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "StateInvariant")
@JsonTypeName(value = "StateInvariant")
public class StateInvariantImpl extends MofObjectImpl implements StateInvariant {

    private Element owner;
    private VisibilityKind visibility;
    private Constraint invariant;
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "ConstraintMetaDef", metaColumn = @Column(name = "invariantType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "invariantId", table = "StateInvariant")
    ...
    public void setInvariant(Constraint invariant) {
    ...
    @JoinTable(name = "StateInvariant_generalOrdering",
        joinColumns = @JoinColumn(name = "StateInvariantId"),
    ...
    @JoinColumn(name = "enclosingInteractionId", table = "StateInvariant")
    ...
    @JoinColumn(name = "enclosingOperandId", table = "StateInvariant")
    ...
    @JoinTable(name = "StateInvariant_covered",
        joinColumns = @JoinColumn(name = "StateInvariantId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "StateInvariant")
    ...
    @JoinColumn(name = "nameExpressionId", table = "StateInvariant")
    ...
    @JoinTable(name = "StateInvariant_ownedComment",
        joinColumns = @JoinColumn(name = "StateInvariantId"),
