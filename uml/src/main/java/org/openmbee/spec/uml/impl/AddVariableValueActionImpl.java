...
import org.openmbee.spec.uml.AddVariableValueAction;
...
@Entity
@SecondaryTable(name = "AddVariableValueAction")
@Table(appliesTo = "AddVariableValueAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "AddVariableValueAction")
@JsonTypeName(value = "AddVariableValueAction")
public class AddVariableValueActionImpl extends MofObjectImpl implements AddVariableValueAction {
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isReplaceAll", table = "AddVariableValueAction")
    ...
    @JoinTable(name = "AddVariableValueAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "AddVariableValueActionId"),
    ...
    @Column(name = "name", table = "AddVariableValueAction")
    ...
    @JoinTable(name = "AddVariableValueAction_localPrecondition",
        joinColumns = @JoinColumn(name = "AddVariableValueActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "AddVariableValueAction")
    ...
    @JoinColumn(name = "variableId", table = "AddVariableValueAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "AddVariableValueAction")
    ...
    @JoinColumn(name = "activityId", table = "AddVariableValueAction")
    ...
    @JoinTable(name = "AddVariableValueAction_localPostcondition",
        joinColumns = @JoinColumn(name = "AddVariableValueActionId"),
    ...
    @JoinTable(name = "AddVariableValueAction_redefinedNode",
        joinColumns = @JoinColumn(name = "AddVariableValueActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "AddVariableValueAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "AddVariableValueAction")
    ...
    @JoinColumn(name = "insertAtId", table = "AddVariableValueAction")
    ...
    @JoinTable(name = "AddVariableValueAction_handler",
        joinColumns = @JoinColumn(name = "AddVariableValueActionId"),
    ...
    @JoinTable(name = "AddVariableValueAction_outgoing",
        joinColumns = @JoinColumn(name = "AddVariableValueActionId"),
    ...
    @JoinTable(name = "AddVariableValueAction_inPartition",
        joinColumns = @JoinColumn(name = "AddVariableValueActionId"),
    ...
    @JoinTable(name = "AddVariableValueAction_incoming",
        joinColumns = @JoinColumn(name = "AddVariableValueActionId"),
    ...
    @JoinColumn(name = "valueId", table = "AddVariableValueAction")
    ...
    @JoinTable(name = "AddVariableValueAction_ownedComment",
        joinColumns = @JoinColumn(name = "AddVariableValueActionId"),
