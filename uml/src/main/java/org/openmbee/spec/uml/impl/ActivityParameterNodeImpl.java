...
import org.openmbee.spec.uml.ActivityParameterNode;
...
@Entity
@SecondaryTable(name = "ActivityParameterNode")
@Table(appliesTo = "ActivityParameterNode", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ActivityParameterNode")
@JsonTypeName(value = "ActivityParameterNode")
public class ActivityParameterNodeImpl extends MofObjectImpl implements ActivityParameterNode {
    ...
    @JoinTable(name = "ActivityParameterNode_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ActivityParameterNodeId"),
    ...
    @JoinColumn(name = "upperBoundId", table = "ActivityParameterNode")
    ...
    @JoinColumn(name = "typeId", table = "ActivityParameterNode")
    public Type getType() {
        return type;
    }
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "ParameterMetaDef", metaColumn = @Column(name = "parameterType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "parameterId", table = "ActivityParameterNode")
    ...
    @JoinTable(name = "ActivityParameterNode_inState",
        joinColumns = @JoinColumn(name = "ActivityParameterNodeId"),
    ...
    @Column(name = "name", table = "ActivityParameterNode")
    ...
    @JoinColumn(name = "nameExpressionId", table = "ActivityParameterNode")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ActivityParameterNode")
    ...
    @JoinColumn(name = "activityId", table = "ActivityParameterNode")
    ...
    @JoinTable(name = "ActivityParameterNode_redefinedNode",
        joinColumns = @JoinColumn(name = "ActivityParameterNodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ActivityParameterNode")
    ...
    @JoinTable(name = "ActivityParameterNode_outgoing",
        joinColumns = @JoinColumn(name = "ActivityParameterNodeId"),
    ...
    @JoinColumn(name = "selectionId", table = "ActivityParameterNode")
    ...
    @JoinTable(name = "ActivityParameterNode_inPartition",
        joinColumns = @JoinColumn(name = "ActivityParameterNodeId"),
    ...
    @JoinTable(name = "ActivityParameterNode_incoming",
        joinColumns = @JoinColumn(name = "ActivityParameterNodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isControlType", table = "ActivityParameterNode")
    ...
    @JoinTable(name = "ActivityParameterNode_ownedComment",
        joinColumns = @JoinColumn(name = "ActivityParameterNodeId"),
