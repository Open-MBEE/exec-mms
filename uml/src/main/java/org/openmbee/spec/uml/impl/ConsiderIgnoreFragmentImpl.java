...
import org.openmbee.spec.uml.ConsiderIgnoreFragment;
...
@Entity
@SecondaryTable(name = "ConsiderIgnoreFragment")
@Table(appliesTo = "ConsiderIgnoreFragment", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ConsiderIgnoreFragment")
@JsonTypeName(value = "ConsiderIgnoreFragment")
public class ConsiderIgnoreFragmentImpl extends MofObjectImpl implements ConsiderIgnoreFragment {
    ...
    private Collection<NamedElement> message;
    ...
    @JoinTable(name = "ConsiderIgnoreFragment_generalOrdering",
        joinColumns = @JoinColumn(name = "ConsiderIgnoreFragmentId"),
    ...
    @JoinColumn(name = "enclosingInteractionId", table = "ConsiderIgnoreFragment")
    ...
    @JoinColumn(name = "enclosingOperandId", table = "ConsiderIgnoreFragment")
    ...
    @JoinTable(name = "ConsiderIgnoreFragment_covered",
        joinColumns = @JoinColumn(name = "ConsiderIgnoreFragmentId"),
    ...
    @JoinTable(name = "ConsiderIgnoreFragment_cfragmentGate",
        joinColumns = @JoinColumn(name = "ConsiderIgnoreFragmentId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "ConsiderIgnoreFragment")
    ...
    @JoinColumn(name = "nameExpressionId", table = "ConsiderIgnoreFragment")
    ...
    @JoinTable(name = "ConsiderIgnoreFragment_operand",
        joinColumns = @JoinColumn(name = "ConsiderIgnoreFragmentId"),
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "NamedElementMetaDef", metaColumn = @Column(name = "messageType"), fetch = FetchType.LAZY)
    @JoinTable(name = "ConsiderIgnoreFragment_message",
        joinColumns = @JoinColumn(name = "ConsiderIgnoreFragmentId"),
        inverseJoinColumns = @JoinColumn(name = "messageId"))
    public Collection<NamedElement> getMessage() {
        if (message == null) {
    ...
    public void setMessage(Collection<NamedElement> message) {
    ...
    @JoinTable(name = "ConsiderIgnoreFragment_ownedComment",
        joinColumns = @JoinColumn(name = "ConsiderIgnoreFragmentId"),
