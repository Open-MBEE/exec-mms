...
@Entity
@SecondaryTable(name = "InputPin")
@Table(appliesTo = "InputPin", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "InputPin")
@JsonTypeName(value = "InputPin")
public class InputPinImpl extends MofObjectImpl implements InputPin {
    ...
    @JoinTable(name = "InputPin_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "InputPinId"),
    ...
    @JoinColumn(name = "upperBoundId", table = "InputPin")
    ...
    @JoinColumn(name = "typeId", table = "InputPin")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "lowerValueId", table = "InputPin")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isOrdered", table = "InputPin")
    ...
    @JoinTable(name = "InputPin_inState",
        joinColumns = @JoinColumn(name = "InputPinId"),
    ...
    @Column(name = "name", table = "InputPin")
    ...
    @JoinColumn(name = "nameExpressionId", table = "InputPin")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "InputPin")
    ...
    @JoinColumn(name = "activityId", table = "InputPin")
    ...
    @JoinTable(name = "InputPin_redefinedNode",
        joinColumns = @JoinColumn(name = "InputPinId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "InputPin")
    ...
    @JoinColumn(name = "upperValueId", table = "InputPin")
    ...
    @JoinTable(name = "InputPin_outgoing",
        joinColumns = @JoinColumn(name = "InputPinId"),
    ...
    @JoinColumn(name = "selectionId", table = "InputPin")
    ...
    @JoinTable(name = "InputPin_inPartition",
        joinColumns = @JoinColumn(name = "InputPinId"),
    ...
    @JoinTable(name = "InputPin_incoming",
        joinColumns = @JoinColumn(name = "InputPinId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isUnique", table = "InputPin")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isControlType", table = "InputPin")
    ...
    @JoinTable(name = "InputPin_ownedComment",
        joinColumns = @JoinColumn(name = "InputPinId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isControl", table = "InputPin")
