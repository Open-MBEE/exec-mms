...
import org.openmbee.spec.uml.ClearStructuralFeatureAction;
...
@Entity
@SecondaryTable(name = "ClearStructuralFeatureAction")
@Table(appliesTo = "ClearStructuralFeatureAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ClearStructuralFeatureAction")
@JsonTypeName(value = "ClearStructuralFeatureAction")
public class ClearStructuralFeatureActionImpl extends MofObjectImpl implements
    ...
    @JoinTable(name = "ClearStructuralFeatureAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ClearStructuralFeatureActionId"),
    ...
    @JoinColumn(name = "structuralFeatureId", table = "ClearStructuralFeatureAction")
    ...
    @Column(name = "name", table = "ClearStructuralFeatureAction")
    ...
    @JoinTable(name = "ClearStructuralFeatureAction_localPrecondition",
        joinColumns = @JoinColumn(name = "ClearStructuralFeatureActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ClearStructuralFeatureAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ClearStructuralFeatureAction")
    ...
    @JoinColumn(name = "activityId", table = "ClearStructuralFeatureAction")
    ...
    @JoinTable(name = "ClearStructuralFeatureAction_localPostcondition",
        joinColumns = @JoinColumn(name = "ClearStructuralFeatureActionId"),
    ...
    @JoinTable(name = "ClearStructuralFeatureAction_redefinedNode",
        joinColumns = @JoinColumn(name = "ClearStructuralFeatureActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ClearStructuralFeatureAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "ClearStructuralFeatureAction")
    ...
    @JoinTable(name = "ClearStructuralFeatureAction_handler",
        joinColumns = @JoinColumn(name = "ClearStructuralFeatureActionId"),
    ...
    @JoinTable(name = "ClearStructuralFeatureAction_outgoing",
        joinColumns = @JoinColumn(name = "ClearStructuralFeatureActionId"),
    ...
    @JoinTable(name = "ClearStructuralFeatureAction_inPartition",
        joinColumns = @JoinColumn(name = "ClearStructuralFeatureActionId"),
    ...
    @JoinColumn(name = "objectId", table = "ClearStructuralFeatureAction")
    ...
    @JoinTable(name = "ClearStructuralFeatureAction_incoming",
        joinColumns = @JoinColumn(name = "ClearStructuralFeatureActionId"),
    ...
    @JoinColumn(name = "resultId", table = "ClearStructuralFeatureAction")
    ...
    @JoinTable(name = "ClearStructuralFeatureAction_ownedComment",
        joinColumns = @JoinColumn(name = "ClearStructuralFeatureActionId"),
