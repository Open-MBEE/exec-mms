...
import org.openmbee.spec.uml.FinalNode;
...
public abstract class FinalNodeImpl extends MofObjectImpl implements FinalNode {
    ...
    @JoinTable(name = "FinalNode_redefinedNode",
        joinColumns = @JoinColumn(name = "FinalNodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "FinalNode")
    ...
    @JoinTable(name = "FinalNode_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "FinalNodeId"),
    ...
    @JoinTable(name = "FinalNode_outgoing",
        joinColumns = @JoinColumn(name = "FinalNodeId"),
    ...
    @JoinTable(name = "FinalNode_inPartition",
        joinColumns = @JoinColumn(name = "FinalNodeId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "FinalNode")
    ...
    @JoinTable(name = "FinalNode_incoming",
        joinColumns = @JoinColumn(name = "FinalNodeId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "FinalNode")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "FinalNode")
    ...
    @JoinTable(name = "FinalNode_ownedComment",
        joinColumns = @JoinColumn(name = "FinalNodeId"),
    ...
    @JoinColumn(name = "activityId", table = "FinalNode")
