...
import org.openmbee.spec.uml.ExtensionEnd;
...
@Entity
@SecondaryTable(name = "ExtensionEnd")
@Table(appliesTo = "ExtensionEnd", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ExtensionEnd")
@JsonTypeName(value = "ExtensionEnd")
public class ExtensionEndImpl extends MofObjectImpl implements ExtensionEnd {
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isReadOnly", table = "ExtensionEnd")
    ...
    @JoinColumn(name = "associationId", table = "ExtensionEnd")
    ...
    @JoinColumn(name = "lowerValueId", table = "ExtensionEnd")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isOrdered", table = "ExtensionEnd")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isStatic", table = "ExtensionEnd")
    ...
    @Column(name = "name", table = "ExtensionEnd")
    ...
    @JoinTable(name = "ExtensionEnd_qualifier",
        joinColumns = @JoinColumn(name = "ExtensionEndId"),
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "StereotypeMetaDef", metaColumn = @Column(name = "typeType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "typeId", table = "ExtensionEnd")
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(using = MofObjectDeserializer.class, as = StereotypeImpl.class)
    ...
    @JoinColumn(name = "class_Id", table = "ExtensionEnd")
    ...
    @JoinColumn(name = "nameExpressionId", table = "ExtensionEnd")
    ...
    @JoinColumn(name = "interface_Id", table = "ExtensionEnd")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isID", table = "ExtensionEnd")
    public Boolean isID() {
        return isID;
    }
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isDerivedUnion", table = "ExtensionEnd")
    ...
    @JoinColumn(name = "templateParameterId", table = "ExtensionEnd")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ExtensionEnd")
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "ExtensionEnd")
    ...
    @JoinTable(name = "ExtensionEnd_subsettedProperty",
        joinColumns = @JoinColumn(name = "ExtensionEndId"),
    ...
    @JoinColumn(name = "datatypeId", table = "ExtensionEnd")
    ...
    @JoinColumn(name = "upperValueId", table = "ExtensionEnd")
    ...
    @JoinColumn(name = "associationEndId", table = "ExtensionEnd")
    ...
    @JoinTable(name = "ExtensionEnd_redefinedProperty",
        joinColumns = @JoinColumn(name = "ExtensionEndId"),
    ...
    @JoinTable(name = "ExtensionEnd_deployment",
        joinColumns = @JoinColumn(name = "ExtensionEndId"),
    ...
    @JoinColumn(name = "defaultValueId", table = "ExtensionEnd")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isUnique", table = "ExtensionEnd")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isDerived", table = "ExtensionEnd")
    ...
    @JoinTable(name = "ExtensionEnd_ownedComment",
        joinColumns = @JoinColumn(name = "ExtensionEndId"),
    ...
    @JoinColumn(name = "owningAssociationId", table = "ExtensionEnd")
