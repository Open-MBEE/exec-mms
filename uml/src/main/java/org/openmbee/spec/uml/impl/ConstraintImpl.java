...
@Entity
@SecondaryTable(name = "Constraint_")
@Table(appliesTo = "Constraint_", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Constraint_")
@JsonTypeName(value = "Constraint_")
public class ConstraintImpl extends MofObjectImpl implements Constraint {
    ...
    @JoinColumn(name = "specificationId", table = "Constraint_")
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Constraint_")
    ...
    @JoinColumn(name = "contextId", table = "Constraint_")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "Constraint_")
    ...
    @JoinColumn(name = "templateParameterId", table = "Constraint_")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Constraint_")
    ...
    @JoinTable(name = "Constraint_constrainedElement",
    ...
    @JoinTable(name = "Constraint_ownedComment",
        joinColumns = @JoinColumn(name = "ConstraintId"),
