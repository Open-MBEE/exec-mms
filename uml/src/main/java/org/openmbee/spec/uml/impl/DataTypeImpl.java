...
@Table(appliesTo = "DataType", fetch = FetchMode.SELECT, optional = false)
...
public class DataTypeImpl extends MofObjectImpl implements DataType {
    ...
    @JoinTable(name = "DataType_ownedAttribute",
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "DataType")
    ...
    @JoinTable(name = "DataType_useCase",
        joinColumns = @JoinColumn(name = "DataTypeId"),
    ...
    @JoinTable(name = "DataType_elementImport",
        joinColumns = @JoinColumn(name = "DataTypeId"),
    ...
    @Column(name = "name", table = "DataType")
    ...
    @JoinTable(name = "DataType_substitution",
        joinColumns = @JoinColumn(name = "DataTypeId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "DataType")
    ...
    @JoinTable(name = "DataType_generalization",
        joinColumns = @JoinColumn(name = "DataTypeId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "DataType")
    ...
    @JoinTable(name = "DataType_packageImport",
        joinColumns = @JoinColumn(name = "DataTypeId"),
    ...
    @JoinTable(name = "DataType_redefinedClassifier",
        joinColumns = @JoinColumn(name = "DataTypeId"),
    ...
    @JoinTable(name = "DataType_ownedRule",
        joinColumns = @JoinColumn(name = "DataTypeId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "DataType")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "DataType")
    ...
    @JoinTable(name = "DataType_collaborationUse",
        joinColumns = @JoinColumn(name = "DataTypeId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "DataType")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "DataType")
    ...
    @JoinTable(name = "DataType_ownedUseCase",
        joinColumns = @JoinColumn(name = "DataTypeId"),
    ...
    @JoinTable(name = "DataType_templateBinding",
        joinColumns = @JoinColumn(name = "DataTypeId"),
    ...
    @JoinColumn(name = "package_Id", table = "DataType")
    ...
    @JoinColumn(name = "representationId", table = "DataType")
    ...
    @JoinTable(name = "DataType_ownedOperation",
        joinColumns = @JoinColumn(name = "DataTypeId"),
    ...
    @JoinTable(name = "DataType_ownedComment",
        joinColumns = @JoinColumn(name = "DataTypeId"),
    ...
    @JoinTable(name = "DataType_powertypeExtent",
        joinColumns = @JoinColumn(name = "DataTypeId"),
