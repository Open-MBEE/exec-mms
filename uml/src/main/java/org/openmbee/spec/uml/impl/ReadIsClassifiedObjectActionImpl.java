...
import org.openmbee.spec.uml.ReadIsClassifiedObjectAction;
...
@Entity
@SecondaryTable(name = "ReadIsClassifiedObjectAction")
@Table(appliesTo = "ReadIsClassifiedObjectAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ReadIsClassifiedObjectAction")
@JsonTypeName(value = "ReadIsClassifiedObjectAction")
public class ReadIsClassifiedObjectActionImpl extends MofObjectImpl implements
    ...
    @JoinTable(name = "ReadIsClassifiedObjectAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ReadIsClassifiedObjectActionId"),
    ...
    @JoinColumn(name = "classifierId", table = "ReadIsClassifiedObjectAction")
    ...
    @JoinColumn(name = "objectId", table = "ReadIsClassifiedObjectAction")
    ...
    @JoinColumn(name = "resultId", table = "ReadIsClassifiedObjectAction")
    ...
    @Column(name = "name", table = "ReadIsClassifiedObjectAction")
    ...
    @JoinTable(name = "ReadIsClassifiedObjectAction_localPrecondition",
        joinColumns = @JoinColumn(name = "ReadIsClassifiedObjectActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ReadIsClassifiedObjectAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ReadIsClassifiedObjectAction")
    ...
    @JoinColumn(name = "activityId", table = "ReadIsClassifiedObjectAction")
    ...
    @JoinTable(name = "ReadIsClassifiedObjectAction_localPostcondition",
        joinColumns = @JoinColumn(name = "ReadIsClassifiedObjectActionId"),
    ...
    @JoinTable(name = "ReadIsClassifiedObjectAction_redefinedNode",
        joinColumns = @JoinColumn(name = "ReadIsClassifiedObjectActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ReadIsClassifiedObjectAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "ReadIsClassifiedObjectAction")
    ...
    @JoinTable(name = "ReadIsClassifiedObjectAction_handler",
        joinColumns = @JoinColumn(name = "ReadIsClassifiedObjectActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isDirect", table = "ReadIsClassifiedObjectAction")
    ...
    @JoinTable(name = "ReadIsClassifiedObjectAction_outgoing",
        joinColumns = @JoinColumn(name = "ReadIsClassifiedObjectActionId"),
    ...
    @JoinTable(name = "ReadIsClassifiedObjectAction_inPartition",
        joinColumns = @JoinColumn(name = "ReadIsClassifiedObjectActionId"),
    ...
    @JoinTable(name = "ReadIsClassifiedObjectAction_incoming",
        joinColumns = @JoinColumn(name = "ReadIsClassifiedObjectActionId"),
    ...
    @JoinTable(name = "ReadIsClassifiedObjectAction_ownedComment",
        joinColumns = @JoinColumn(name = "ReadIsClassifiedObjectActionId"),
