...
@Entity
@SecondaryTable(name = "Stereotype")
@Table(appliesTo = "Stereotype", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Stereotype")
@JsonTypeName(value = "Stereotype")
public class StereotypeImpl extends MofObjectImpl implements Stereotype {

    private Collection<Image> icon;
    ...
    @ManyToAny(metaDef = "ImageMetaDef", metaColumn = @Column(name = "iconType"), fetch = FetchType.LAZY)
    @JoinTable(name = "Stereotype_icon",
        joinColumns = @JoinColumn(name = "StereotypeId"),
        inverseJoinColumns = @JoinColumn(name = "iconId"))
    public Collection<Image> getIcon() {
        if (icon == null) {
            icon = new ArrayList<>();
        }
        return icon;
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(contentUsing = MofObjectDeserializer.class, contentAs = ImageImpl.class)
    public void setIcon(Collection<Image> icon) {
        this.icon = icon;
    }
    ...
    @JoinTable(name = "Stereotype_elementImport",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @Column(name = "name", table = "Stereotype")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Stereotype")
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(using = MofObjectDeserializer.class, as = ProfileImpl.class)
    ...
    @JoinTable(name = "Stereotype_generalization",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JoinTable(name = "Stereotype_packageImport",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JoinTable(name = "Stereotype_ownedOperation",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "Stereotype")
    ...
    @JoinTable(name = "Stereotype_ownedAttribute",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JoinTable(name = "Stereotype_templateBinding",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JoinColumn(name = "representationId", table = "Stereotype")
    ...
    @JoinTable(name = "Stereotype_ownedReception",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "Stereotype")
    ...
    @JoinTable(name = "Stereotype_useCase",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JoinTable(name = "Stereotype_ownedBehavior",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JoinColumn(name = "classifierBehaviorId", table = "Stereotype")
    ...
    @JoinTable(name = "Stereotype_substitution",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JoinTable(name = "Stereotype_ownedConnector",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "Stereotype")
    ...
    @JoinTable(name = "Stereotype_interfaceRealization",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JoinTable(name = "Stereotype_redefinedClassifier",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JoinTable(name = "Stereotype_ownedRule",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Stereotype")
    ...
    @JoinTable(name = "Stereotype_collaborationUse",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Stereotype")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "Stereotype")
    ...
    @JoinTable(name = "Stereotype_nestedClassifier",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JoinTable(name = "Stereotype_ownedUseCase",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isActive", table = "Stereotype")
    ...
    @JoinColumn(name = "package_Id", table = "Stereotype")
    ...
    @JoinTable(name = "Stereotype_ownedComment",
        joinColumns = @JoinColumn(name = "StereotypeId"),
    ...
    @JoinTable(name = "Stereotype_powertypeExtent",
        joinColumns = @JoinColumn(name = "StereotypeId"),
