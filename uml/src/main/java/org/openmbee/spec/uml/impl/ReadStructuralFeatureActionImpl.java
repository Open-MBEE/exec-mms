...
import org.openmbee.spec.uml.ReadStructuralFeatureAction;
...
@Entity
@SecondaryTable(name = "ReadStructuralFeatureAction")
@Table(appliesTo = "ReadStructuralFeatureAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ReadStructuralFeatureAction")
@JsonTypeName(value = "ReadStructuralFeatureAction")
public class ReadStructuralFeatureActionImpl extends MofObjectImpl implements
    ...
    @JoinTable(name = "ReadStructuralFeatureAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ReadStructuralFeatureActionId"),
    ...
    @JoinColumn(name = "structuralFeatureId", table = "ReadStructuralFeatureAction")
    ...
    @Column(name = "name", table = "ReadStructuralFeatureAction")
    ...
    @JoinTable(name = "ReadStructuralFeatureAction_localPrecondition",
        joinColumns = @JoinColumn(name = "ReadStructuralFeatureActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ReadStructuralFeatureAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ReadStructuralFeatureAction")
    ...
    @JoinColumn(name = "activityId", table = "ReadStructuralFeatureAction")
    ...
    @JoinColumn(name = "resultId", table = "ReadStructuralFeatureAction")
    ...
    @JoinTable(name = "ReadStructuralFeatureAction_localPostcondition",
        joinColumns = @JoinColumn(name = "ReadStructuralFeatureActionId"),
    ...
    @JoinTable(name = "ReadStructuralFeatureAction_redefinedNode",
        joinColumns = @JoinColumn(name = "ReadStructuralFeatureActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ReadStructuralFeatureAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "ReadStructuralFeatureAction")
    ...
    @JoinTable(name = "ReadStructuralFeatureAction_handler",
        joinColumns = @JoinColumn(name = "ReadStructuralFeatureActionId"),
    ...
    @JoinTable(name = "ReadStructuralFeatureAction_outgoing",
        joinColumns = @JoinColumn(name = "ReadStructuralFeatureActionId"),
    ...
    @JoinTable(name = "ReadStructuralFeatureAction_inPartition",
        joinColumns = @JoinColumn(name = "ReadStructuralFeatureActionId"),
    ...
    @JoinColumn(name = "objectId", table = "ReadStructuralFeatureAction")
    ...
    @JoinTable(name = "ReadStructuralFeatureAction_incoming",
        joinColumns = @JoinColumn(name = "ReadStructuralFeatureActionId"),
    ...
    @JoinTable(name = "ReadStructuralFeatureAction_ownedComment",
        joinColumns = @JoinColumn(name = "ReadStructuralFeatureActionId"),
