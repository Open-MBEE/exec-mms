...
public abstract class BehaviorImpl extends MofObjectImpl implements Behavior {
    ...
    @JoinTable(name = "Behavior_ownedParameterSet",
    ...
    @JoinTable(name = "Behavior_elementImport",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @Column(name = "name", table = "Behavior")
    ...
    @JoinColumn(name = "specificationId", table = "Behavior")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Behavior")
    ...
    @JoinTable(name = "Behavior_generalization",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinTable(name = "Behavior_packageImport",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinTable(name = "Behavior_precondition",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinTable(name = "Behavior_ownedOperation",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "Behavior")
    ...
    @JoinTable(name = "Behavior_ownedAttribute",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinTable(name = "Behavior_templateBinding",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinColumn(name = "representationId", table = "Behavior")
    ...
    @JoinTable(name = "Behavior_ownedReception",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "Behavior")
    ...
    @JoinTable(name = "Behavior_useCase",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinTable(name = "Behavior_ownedBehavior",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinColumn(name = "classifierBehaviorId", table = "Behavior")
    ...
    @JoinTable(name = "Behavior_substitution",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinTable(name = "Behavior_ownedConnector",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "Behavior")
    ...
    @JoinTable(name = "Behavior_interfaceRealization",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinTable(name = "Behavior_redefinedClassifier",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinTable(name = "Behavior_ownedRule",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Behavior")
    ...
    @JoinTable(name = "Behavior_collaborationUse",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Behavior")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isReentrant", table = "Behavior")
    ...
    @JoinTable(name = "Behavior_ownedParameter",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "Behavior")
    ...
    @JoinTable(name = "Behavior_nestedClassifier",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinTable(name = "Behavior_ownedUseCase",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isActive", table = "Behavior")
    ...
    @JoinColumn(name = "package_Id", table = "Behavior")
    ...
    @JoinTable(name = "Behavior_postcondition",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinTable(name = "Behavior_redefinedBehavior",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinTable(name = "Behavior_ownedComment",
        joinColumns = @JoinColumn(name = "BehaviorId"),
    ...
    @JoinTable(name = "Behavior_powertypeExtent",
        joinColumns = @JoinColumn(name = "BehaviorId"),
