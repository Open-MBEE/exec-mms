...
import org.openmbee.spec.uml.DestructionOccurrenceSpecification;
...
@Entity
@SecondaryTable(name = "DestructionOccurrenceSpecification")
@Table(appliesTo = "DestructionOccurrenceSpecification", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "DestructionOccurrenceSpecification")
@JsonTypeName(value = "DestructionOccurrenceSpecification")
public class DestructionOccurrenceSpecificationImpl extends MofObjectImpl implements
    ...
    @JoinColumn(name = "messageId", table = "DestructionOccurrenceSpecification")
    ...
    @JoinTable(name = "DestructionOccurrenceSpecification_generalOrdering",
        joinColumns = @JoinColumn(name = "DestructionOccurrenceSpecificationId"),
    ...
    @JoinColumn(name = "enclosingInteractionId", table = "DestructionOccurrenceSpecification")
    ...
    @JoinColumn(name = "enclosingOperandId", table = "DestructionOccurrenceSpecification")
    ...
    @JoinTable(name = "DestructionOccurrenceSpecification_covered",
        joinColumns = @JoinColumn(name = "DestructionOccurrenceSpecificationId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "DestructionOccurrenceSpecification")
    ...
    @JoinTable(name = "DestructionOccurrenceSpecification_toAfter",
        joinColumns = @JoinColumn(name = "DestructionOccurrenceSpecificationId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "DestructionOccurrenceSpecification")
    ...
    @JoinTable(name = "DestructionOccurrenceSpecification_toBefore",
        joinColumns = @JoinColumn(name = "DestructionOccurrenceSpecificationId"),
    ...
    @JoinTable(name = "DestructionOccurrenceSpecification_ownedComment",
        joinColumns = @JoinColumn(name = "DestructionOccurrenceSpecificationId"),
