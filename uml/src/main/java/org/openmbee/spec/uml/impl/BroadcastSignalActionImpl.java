...
import org.openmbee.spec.uml.BroadcastSignalAction;
...
@Entity
@SecondaryTable(name = "BroadcastSignalAction")
@Table(appliesTo = "BroadcastSignalAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "BroadcastSignalAction")
@JsonTypeName(value = "BroadcastSignalAction")
public class BroadcastSignalActionImpl extends MofObjectImpl implements BroadcastSignalAction {
    ...
    @JoinColumn(name = "onPortId", table = "BroadcastSignalAction")
    ...
    @JoinTable(name = "BroadcastSignalAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "BroadcastSignalActionId"),
    ...
    @JoinTable(name = "BroadcastSignalAction_argument",
        joinColumns = @JoinColumn(name = "BroadcastSignalActionId"),
    ...
    @Column(name = "name", table = "BroadcastSignalAction")
    ...
    @JoinTable(name = "BroadcastSignalAction_localPrecondition",
        joinColumns = @JoinColumn(name = "BroadcastSignalActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "BroadcastSignalAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "BroadcastSignalAction")
    ...
    @JoinColumn(name = "activityId", table = "BroadcastSignalAction")
    ...
    @JoinTable(name = "BroadcastSignalAction_localPostcondition",
        joinColumns = @JoinColumn(name = "BroadcastSignalActionId"),
    ...
    @JoinTable(name = "BroadcastSignalAction_redefinedNode",
        joinColumns = @JoinColumn(name = "BroadcastSignalActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "BroadcastSignalAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "BroadcastSignalAction")
    ...
    @JoinTable(name = "BroadcastSignalAction_handler",
        joinColumns = @JoinColumn(name = "BroadcastSignalActionId"),
    ...
    @JoinTable(name = "BroadcastSignalAction_outgoing",
        joinColumns = @JoinColumn(name = "BroadcastSignalActionId"),
    ...
    @JoinColumn(name = "signalId", table = "BroadcastSignalAction")
    ...
    @JoinTable(name = "BroadcastSignalAction_inPartition",
        joinColumns = @JoinColumn(name = "BroadcastSignalActionId"),
    ...
    @JoinTable(name = "BroadcastSignalAction_incoming",
        joinColumns = @JoinColumn(name = "BroadcastSignalActionId"),
    ...
    @JoinTable(name = "BroadcastSignalAction_ownedComment",
        joinColumns = @JoinColumn(name = "BroadcastSignalActionId"),
