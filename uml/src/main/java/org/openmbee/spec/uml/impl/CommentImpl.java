...
@Table(appliesTo = "Comment", fetch = FetchMode.SELECT, optional = false)
...
public class CommentImpl extends MofObjectImpl implements Comment {
    ...
    @ManyToAny(metaDef = "ElementMetaDef", metaColumn = @Column(name = "annotatedElementType"), fetch = FetchType.LAZY)
    @JoinTable(name = "Comment_annotatedElement",
        joinColumns = @JoinColumn(name = "CommentId"),
        inverseJoinColumns = @JoinColumn(name = "annotatedElementId"))
    ...
    @Column(name = "body", table = "Comment")
    ...
    @JoinTable(name = "Comment_ownedComment",
        joinColumns = @JoinColumn(name = "CommentId"),
