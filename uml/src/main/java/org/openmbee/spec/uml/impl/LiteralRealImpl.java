...
import org.openmbee.spec.uml.LiteralReal;
...
@Table(appliesTo = "LiteralReal", fetch = FetchMode.SELECT, optional = false)
...
public class LiteralRealImpl extends MofObjectImpl implements LiteralReal {
    ...
    @JoinColumn(name = "typeId", table = "LiteralReal")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "LiteralReal")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "value", table = "LiteralReal")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "LiteralReal")
    ...
    @JoinColumn(name = "templateParameterId", table = "LiteralReal")
    ...
    @JoinColumn(name = "nameExpressionId", table = "LiteralReal")
    ...
    @JoinTable(name = "LiteralReal_ownedComment",
