...
import org.openmbee.spec.uml.SignalEvent;
...
@Entity
@SecondaryTable(name = "SignalEvent")
@Table(appliesTo = "SignalEvent", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "SignalEvent")
@JsonTypeName(value = "SignalEvent")
public class SignalEventImpl extends MofObjectImpl implements SignalEvent {
    ...
    @Column(name = "name", table = "SignalEvent")
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "SignalEvent")
    ...
    @JoinColumn(name = "templateParameterId", table = "SignalEvent")
    ...
    @JoinColumn(name = "nameExpressionId", table = "SignalEvent")
    ...
    @JoinTable(name = "SignalEvent_ownedComment",
        joinColumns = @JoinColumn(name = "SignalEventId"),
    ...
    @JoinColumn(name = "signalId", table = "SignalEvent")
