...
import org.openmbee.spec.uml.LiteralInteger;
...
@Table(appliesTo = "LiteralInteger", fetch = FetchMode.SELECT, optional = false)
...
public class LiteralIntegerImpl extends MofObjectImpl implements LiteralInteger {
    ...
    @JoinColumn(name = "typeId", table = "LiteralInteger")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "LiteralInteger")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "value", table = "LiteralInteger")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "LiteralInteger")
    ...
    @JoinColumn(name = "templateParameterId", table = "LiteralInteger")
    ...
    @JoinColumn(name = "nameExpressionId", table = "LiteralInteger")
    ...
    @JoinTable(name = "LiteralInteger_ownedComment",
