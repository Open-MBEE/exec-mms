...
import org.openmbee.spec.uml.FlowFinalNode;
...
@Entity
@SecondaryTable(name = "FlowFinalNode")
@Table(appliesTo = "FlowFinalNode", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "FlowFinalNode")
@JsonTypeName(value = "FlowFinalNode")
public class FlowFinalNodeImpl extends MofObjectImpl implements FlowFinalNode {
    ...
    @JoinTable(name = "FlowFinalNode_redefinedNode",
        joinColumns = @JoinColumn(name = "FlowFinalNodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "FlowFinalNode")
    ...
    @JoinTable(name = "FlowFinalNode_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "FlowFinalNodeId"),
    ...
    @JoinTable(name = "FlowFinalNode_outgoing",
        joinColumns = @JoinColumn(name = "FlowFinalNodeId"),
    ...
    @JoinTable(name = "FlowFinalNode_inPartition",
        joinColumns = @JoinColumn(name = "FlowFinalNodeId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "FlowFinalNode")
    ...
    @JoinTable(name = "FlowFinalNode_incoming",
        joinColumns = @JoinColumn(name = "FlowFinalNodeId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "FlowFinalNode")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "FlowFinalNode")
    ...
    @JoinTable(name = "FlowFinalNode_ownedComment",
        joinColumns = @JoinColumn(name = "FlowFinalNodeId"),
    ...
    @JoinColumn(name = "activityId", table = "FlowFinalNode")
