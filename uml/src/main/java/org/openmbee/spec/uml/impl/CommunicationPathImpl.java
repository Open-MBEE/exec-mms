...
import org.openmbee.spec.uml.CommunicationPath;
...
@Entity
@SecondaryTable(name = "CommunicationPath")
@Table(appliesTo = "CommunicationPath", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "CommunicationPath")
@JsonTypeName(value = "CommunicationPath")
public class CommunicationPathImpl extends MofObjectImpl implements CommunicationPath {
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isDerived", table = "CommunicationPath")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "CommunicationPath")
    ...
    @JoinTable(name = "CommunicationPath_useCase",
        joinColumns = @JoinColumn(name = "CommunicationPathId"),
    ...
    @JoinTable(name = "CommunicationPath_elementImport",
        joinColumns = @JoinColumn(name = "CommunicationPathId"),
    ...
    @JoinTable(name = "CommunicationPath_memberEnd",
        joinColumns = @JoinColumn(name = "CommunicationPathId"),
    ...
    @Column(name = "name", table = "CommunicationPath")
    ...
    @JoinTable(name = "CommunicationPath_substitution",
        joinColumns = @JoinColumn(name = "CommunicationPathId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "CommunicationPath")
    ...
    @JoinTable(name = "CommunicationPath_generalization",
        joinColumns = @JoinColumn(name = "CommunicationPathId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "CommunicationPath")
    ...
    @JoinTable(name = "CommunicationPath_packageImport",
        joinColumns = @JoinColumn(name = "CommunicationPathId"),
    ...
    @JoinTable(name = "CommunicationPath_ownedEnd",
        joinColumns = @JoinColumn(name = "CommunicationPathId"),
    ...
    @JoinTable(name = "CommunicationPath_redefinedClassifier",
        joinColumns = @JoinColumn(name = "CommunicationPathId"),
    ...
    @JoinTable(name = "CommunicationPath_ownedRule",
        joinColumns = @JoinColumn(name = "CommunicationPathId"),
    ...
    @JoinTable(name = "CommunicationPath_navigableOwnedEnd",
        joinColumns = @JoinColumn(name = "CommunicationPathId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "CommunicationPath")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "CommunicationPath")
    ...
    @JoinTable(name = "CommunicationPath_collaborationUse",
        joinColumns = @JoinColumn(name = "CommunicationPathId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "CommunicationPath")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "CommunicationPath")
    ...
    @JoinTable(name = "CommunicationPath_ownedUseCase",
        joinColumns = @JoinColumn(name = "CommunicationPathId"),
    ...
    @JoinTable(name = "CommunicationPath_templateBinding",
        joinColumns = @JoinColumn(name = "CommunicationPathId"),
    ...
    @JoinColumn(name = "package_Id", table = "CommunicationPath")
    ...
    @JoinColumn(name = "representationId", table = "CommunicationPath")
    ...
    @JoinTable(name = "CommunicationPath_ownedComment",
        joinColumns = @JoinColumn(name = "CommunicationPathId"),
    ...
    @JoinTable(name = "CommunicationPath_powertypeExtent",
        joinColumns = @JoinColumn(name = "CommunicationPathId"),
