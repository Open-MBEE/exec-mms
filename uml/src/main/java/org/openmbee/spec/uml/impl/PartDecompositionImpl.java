...
@Entity
@SecondaryTable(name = "PartDecomposition")
@Table(appliesTo = "PartDecomposition", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "PartDecomposition")
@JsonTypeName(value = "PartDecomposition")
public class PartDecompositionImpl extends MofObjectImpl implements PartDecomposition {
    ...
    @JoinTable(name = "PartDecomposition_generalOrdering",
        joinColumns = @JoinColumn(name = "PartDecompositionId"),
    ...
    @JoinTable(name = "PartDecomposition_argument",
        joinColumns = @JoinColumn(name = "PartDecompositionId"),
    ...
    @JoinColumn(name = "enclosingInteractionId", table = "PartDecomposition")
    ...
    @JoinColumn(name = "enclosingOperandId", table = "PartDecomposition")
    ...
    @JoinTable(name = "PartDecomposition_covered",
        joinColumns = @JoinColumn(name = "PartDecompositionId"),
    ...
    @JoinTable(name = "PartDecomposition_actualGate",
        joinColumns = @JoinColumn(name = "PartDecompositionId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "PartDecomposition")
    ...
    @JoinColumn(name = "returnValueRecipientId", table = "PartDecomposition")
    ...
    @JoinColumn(name = "refersToId", table = "PartDecomposition")
    ...
    @JoinColumn(name = "nameExpressionId", table = "PartDecomposition")
    ...
    @JoinColumn(name = "returnValueId", table = "PartDecomposition")
    ...
    @JoinTable(name = "PartDecomposition_ownedComment",
        joinColumns = @JoinColumn(name = "PartDecompositionId"),
