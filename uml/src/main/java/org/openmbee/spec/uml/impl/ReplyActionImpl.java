...
import org.openmbee.spec.uml.ReplyAction;
...
@Entity
@SecondaryTable(name = "ReplyAction")
@Table(appliesTo = "ReplyAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ReplyAction")
@JsonTypeName(value = "ReplyAction")
public class ReplyActionImpl extends MofObjectImpl implements ReplyAction {
    ...
    private List<InputPin> replyValue;
    ...
    private InputPin returnInformation;
    private Collection<Classifier> redefinitionContext;
    private Trigger replyToCall;
    ...
    @JoinTable(name = "ReplyAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ReplyActionId"),
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "InputPinMetaDef", metaColumn = @Column(name = "replyValueType"), fetch = FetchType.LAZY)
    @JoinTable(name = "ReplyAction_replyValue",
        joinColumns = @JoinColumn(name = "ReplyActionId"),
        inverseJoinColumns = @JoinColumn(name = "replyValueId"))
    public List<InputPin> getReplyValue() {
        if (replyValue == null) {
            replyValue = new ArrayList<>();
        }
        return replyValue;
    }
    ...
    public void setReplyValue(List<InputPin> replyValue) {
    ...
    @Column(name = "name", table = "ReplyAction")
    ...
    @JoinTable(name = "ReplyAction_localPrecondition",
        joinColumns = @JoinColumn(name = "ReplyActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ReplyAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ReplyAction")
    ...
    @JoinColumn(name = "activityId", table = "ReplyAction")
    ...
    @JoinTable(name = "ReplyAction_localPostcondition",
        joinColumns = @JoinColumn(name = "ReplyActionId"),
    ...
    @JoinTable(name = "ReplyAction_redefinedNode",
        joinColumns = @JoinColumn(name = "ReplyActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ReplyAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "ReplyAction")
    ...
    @JoinTable(name = "ReplyAction_handler",
        joinColumns = @JoinColumn(name = "ReplyActionId"),
    ...
    @JoinTable(name = "ReplyAction_outgoing",
        joinColumns = @JoinColumn(name = "ReplyActionId"),
    ...
    @JoinTable(name = "ReplyAction_inPartition",
        joinColumns = @JoinColumn(name = "ReplyActionId"),
    ...
    @JoinTable(name = "ReplyAction_incoming",
        joinColumns = @JoinColumn(name = "ReplyActionId"),
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "InputPinMetaDef", metaColumn = @Column(name = "returnInformationType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "returnInformationId", table = "ReplyAction")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "TriggerMetaDef", metaColumn = @Column(name = "replyToCallType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "replyToCallId", table = "ReplyAction")
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(using = MofObjectDeserializer.class, as = TriggerImpl.class)
    ...
    @JoinTable(name = "ReplyAction_ownedComment",
        joinColumns = @JoinColumn(name = "ReplyActionId"),
