...
import org.openmbee.spec.uml.LiteralBoolean;
...
@Table(appliesTo = "LiteralBoolean", fetch = FetchMode.SELECT, optional = false)
...
public class LiteralBooleanImpl extends MofObjectImpl implements LiteralBoolean {
    ...
    @JoinColumn(name = "typeId", table = "LiteralBoolean")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "LiteralBoolean")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "LiteralBoolean")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "value", table = "LiteralBoolean")
    ...
    @JoinColumn(name = "templateParameterId", table = "LiteralBoolean")
    ...
    @JoinColumn(name = "nameExpressionId", table = "LiteralBoolean")
    ...
    @JoinTable(name = "LiteralBoolean_ownedComment",
