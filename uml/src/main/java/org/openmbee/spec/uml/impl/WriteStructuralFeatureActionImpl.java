...
import org.openmbee.spec.uml.WriteStructuralFeatureAction;
import org.openmbee.spec.uml.jackson.MofObjectDeserializer;
import org.openmbee.spec.uml.jackson.MofObjectSerializer;

@PrimaryKeyJoinColumn
@Inheritance(strategy = InheritanceType.JOINED)
public abstract class WriteStructuralFeatureActionImpl extends MofObjectImpl implements
    ...
    @JoinTable(name = "WriteStructuralFeatureAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "WriteStructuralFeatureActionId"),
    ...
    @JoinColumn(name = "resultId", table = "WriteStructuralFeatureAction")
    ...
    @JoinColumn(name = "structuralFeatureId", table = "WriteStructuralFeatureAction")
    ...
    @Column(name = "name", table = "WriteStructuralFeatureAction")
    ...
    @JoinTable(name = "WriteStructuralFeatureAction_localPrecondition",
        joinColumns = @JoinColumn(name = "WriteStructuralFeatureActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "WriteStructuralFeatureAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "WriteStructuralFeatureAction")
    ...
    @JoinColumn(name = "activityId", table = "WriteStructuralFeatureAction")
    ...
    @JoinTable(name = "WriteStructuralFeatureAction_localPostcondition",
        joinColumns = @JoinColumn(name = "WriteStructuralFeatureActionId"),
    ...
    @JoinTable(name = "WriteStructuralFeatureAction_redefinedNode",
        joinColumns = @JoinColumn(name = "WriteStructuralFeatureActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "WriteStructuralFeatureAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "WriteStructuralFeatureAction")
    ...
    @JoinTable(name = "WriteStructuralFeatureAction_handler",
        joinColumns = @JoinColumn(name = "WriteStructuralFeatureActionId"),
    ...
    @JoinColumn(name = "valueId", table = "WriteStructuralFeatureAction")
    ...
    @JoinTable(name = "WriteStructuralFeatureAction_outgoing",
        joinColumns = @JoinColumn(name = "WriteStructuralFeatureActionId"),
    ...
    @JoinTable(name = "WriteStructuralFeatureAction_inPartition",
        joinColumns = @JoinColumn(name = "WriteStructuralFeatureActionId"),
    ...
    @JoinColumn(name = "objectId", table = "WriteStructuralFeatureAction")
    ...
    @JoinTable(name = "WriteStructuralFeatureAction_incoming",
        joinColumns = @JoinColumn(name = "WriteStructuralFeatureActionId"),
    ...
    @JoinTable(name = "WriteStructuralFeatureAction_ownedComment",
        joinColumns = @JoinColumn(name = "WriteStructuralFeatureActionId"),
