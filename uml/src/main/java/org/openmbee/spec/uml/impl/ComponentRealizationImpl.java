...
@Entity
@SecondaryTable(name = "ComponentRealization")
@Table(appliesTo = "ComponentRealization", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ComponentRealization")
@JsonTypeName(value = "ComponentRealization")
public class ComponentRealizationImpl extends MofObjectImpl implements ComponentRealization {
    ...
    private Collection<Classifier> realizingClassifier;
    ...
    @JoinTable(name = "ComponentRealization_client",
        joinColumns = @JoinColumn(name = "ComponentRealizationId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "ComponentRealization")
    ...
    @JoinColumn(name = "mappingId", table = "ComponentRealization")
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "ClassifierMetaDef", metaColumn = @Column(name = "realizingClassifierType"), fetch = FetchType.LAZY)
    @JoinTable(name = "ComponentRealization_realizingClassifier",
        joinColumns = @JoinColumn(name = "ComponentRealizationId"),
        inverseJoinColumns = @JoinColumn(name = "realizingClassifierId"))
    public Collection<Classifier> getRealizingClassifier() {
        if (realizingClassifier == null) {
            realizingClassifier = new ArrayList<>();
        }
    ...
    public void setRealizingClassifier(Collection<Classifier> realizingClassifier) {
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "ComponentRealization")
    ...
    @JoinTable(name = "ComponentRealization_supplier",
        joinColumns = @JoinColumn(name = "ComponentRealizationId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "ComponentRealization")
    ...
    @JoinColumn(name = "nameExpressionId", table = "ComponentRealization")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "ComponentMetaDef", metaColumn = @Column(name = "abstractionType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "abstractionId", table = "ComponentRealization")
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(using = MofObjectDeserializer.class, as = ComponentImpl.class)
    public void setAbstraction(Component abstraction) {
    ...
    @JoinTable(name = "ComponentRealization_ownedComment",
        joinColumns = @JoinColumn(name = "ComponentRealizationId"),
