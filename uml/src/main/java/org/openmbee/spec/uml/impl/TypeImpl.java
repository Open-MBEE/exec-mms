...
public abstract class TypeImpl extends MofObjectImpl implements Type {
    ...
    @JoinColumn(name = "package_Id", table = "Type")
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Type")
    ...
    @JoinColumn(name = "templateParameterId", table = "Type")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Type")
    ...
    @JoinTable(name = "Type_ownedComment",
