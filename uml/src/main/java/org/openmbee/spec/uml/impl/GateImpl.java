...
@Entity
@SecondaryTable(name = "Gate")
@Table(appliesTo = "Gate", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Gate")
@JsonTypeName(value = "Gate")
public class GateImpl extends MofObjectImpl implements Gate {
    ...
    @JoinColumn(name = "messageId", table = "Gate")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Gate")
    ...
    @JoinTable(name = "Gate_ownedComment",
        joinColumns = @JoinColumn(name = "GateId"),
