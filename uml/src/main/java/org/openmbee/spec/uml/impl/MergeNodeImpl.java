...
import org.openmbee.spec.uml.MergeNode;
...
@Table(appliesTo = "MergeNode", fetch = FetchMode.SELECT, optional = false)
...
public class MergeNodeImpl extends MofObjectImpl implements MergeNode {
    ...
    @JoinTable(name = "MergeNode_redefinedNode",
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "MergeNode")
    ...
    @JoinTable(name = "MergeNode_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "MergeNodeId"),
    ...
    @JoinTable(name = "MergeNode_outgoing",
        joinColumns = @JoinColumn(name = "MergeNodeId"),
    ...
    @JoinTable(name = "MergeNode_inPartition",
        joinColumns = @JoinColumn(name = "MergeNodeId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "MergeNode")
    ...
    @JoinTable(name = "MergeNode_incoming",
        joinColumns = @JoinColumn(name = "MergeNodeId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "MergeNode")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "MergeNode")
    ...
    @JoinTable(name = "MergeNode_ownedComment",
        joinColumns = @JoinColumn(name = "MergeNodeId"),
    ...
    @JoinColumn(name = "activityId", table = "MergeNode")
