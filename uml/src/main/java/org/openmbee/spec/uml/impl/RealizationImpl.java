...
import org.openmbee.spec.uml.Realization;
...
@Entity
@SecondaryTable(name = "Realization")
@Table(appliesTo = "Realization", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Realization")
@JsonTypeName(value = "Realization")
public class RealizationImpl extends MofObjectImpl implements Realization {
    ...
    @JoinTable(name = "Realization_client",
        joinColumns = @JoinColumn(name = "RealizationId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Realization")
    ...
    @JoinColumn(name = "mappingId", table = "Realization")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "Realization")
    ...
    @JoinTable(name = "Realization_supplier",
        joinColumns = @JoinColumn(name = "RealizationId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Realization")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Realization")
    ...
    @JoinTable(name = "Realization_ownedComment",
        joinColumns = @JoinColumn(name = "RealizationId"),
