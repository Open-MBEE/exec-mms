...
import org.openmbee.spec.uml.CreateLinkAction;
...
@Entity
@SecondaryTable(name = "CreateLinkAction")
@Table(appliesTo = "CreateLinkAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "CreateLinkAction")
@JsonTypeName(value = "CreateLinkAction")
public class CreateLinkActionImpl extends MofObjectImpl implements CreateLinkAction {
    ...
    @JoinTable(name = "CreateLinkAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "CreateLinkActionId"),
    ...
    @JoinTable(name = "CreateLinkAction_inputValue",
        joinColumns = @JoinColumn(name = "CreateLinkActionId"),
    ...
    @Column(name = "name", table = "CreateLinkAction")
    ...
    @JoinTable(name = "CreateLinkAction_localPrecondition",
        joinColumns = @JoinColumn(name = "CreateLinkActionId"),
    ...
    @JoinTable(name = "CreateLinkAction_endData",
        joinColumns = @JoinColumn(name = "CreateLinkActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "CreateLinkAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "CreateLinkAction")
    ...
    @JoinColumn(name = "activityId", table = "CreateLinkAction")
    ...
    @JoinTable(name = "CreateLinkAction_localPostcondition",
        joinColumns = @JoinColumn(name = "CreateLinkActionId"),
    ...
    @JoinTable(name = "CreateLinkAction_redefinedNode",
        joinColumns = @JoinColumn(name = "CreateLinkActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "CreateLinkAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "CreateLinkAction")
    ...
    @JoinTable(name = "CreateLinkAction_handler",
        joinColumns = @JoinColumn(name = "CreateLinkActionId"),
    ...
    @JoinTable(name = "CreateLinkAction_outgoing",
        joinColumns = @JoinColumn(name = "CreateLinkActionId"),
    ...
    @JoinTable(name = "CreateLinkAction_inPartition",
        joinColumns = @JoinColumn(name = "CreateLinkActionId"),
    ...
    @JoinTable(name = "CreateLinkAction_incoming",
        joinColumns = @JoinColumn(name = "CreateLinkActionId"),
    ...
    @JoinTable(name = "CreateLinkAction_ownedComment",
        joinColumns = @JoinColumn(name = "CreateLinkActionId"),
