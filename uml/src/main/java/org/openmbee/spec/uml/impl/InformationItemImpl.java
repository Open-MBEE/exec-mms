...
import org.openmbee.spec.uml.InformationItem;
...
@Entity
@SecondaryTable(name = "InformationItem")
@Table(appliesTo = "InformationItem", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "InformationItem")
@JsonTypeName(value = "InformationItem")
public class InformationItemImpl extends MofObjectImpl implements InformationItem {
    ...
    private Collection<Classifier> represented;
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "InformationItem")
    ...
    @JoinTable(name = "InformationItem_useCase",
        joinColumns = @JoinColumn(name = "InformationItemId"),
    ...
    @JoinTable(name = "InformationItem_elementImport",
        joinColumns = @JoinColumn(name = "InformationItemId"),
    ...
    @Column(name = "name", table = "InformationItem")
    ...
    @JoinTable(name = "InformationItem_substitution",
        joinColumns = @JoinColumn(name = "InformationItemId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "InformationItem")
    ...
    @JoinTable(name = "InformationItem_generalization",
        joinColumns = @JoinColumn(name = "InformationItemId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "InformationItem")
    ...
    @JoinTable(name = "InformationItem_packageImport",
        joinColumns = @JoinColumn(name = "InformationItemId"),
    ...
    @JoinTable(name = "InformationItem_redefinedClassifier",
        joinColumns = @JoinColumn(name = "InformationItemId"),
    ...
    @JoinTable(name = "InformationItem_ownedRule",
        joinColumns = @JoinColumn(name = "InformationItemId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "InformationItem")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "InformationItem")
    ...
    @JoinTable(name = "InformationItem_collaborationUse",
        joinColumns = @JoinColumn(name = "InformationItemId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "InformationItem")
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "ClassifierMetaDef", metaColumn = @Column(name = "representedType"), fetch = FetchType.LAZY)
    @JoinTable(name = "InformationItem_represented",
        joinColumns = @JoinColumn(name = "InformationItemId"),
        inverseJoinColumns = @JoinColumn(name = "representedId"))
    public Collection<Classifier> getRepresented() {
        if (represented == null) {
    ...
    @JsonSetter
    @JsonDeserialize(contentUsing = MofObjectDeserializer.class, contentAs = ClassifierImpl.class)
    public void setRepresented(Collection<Classifier> represented) {
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "InformationItem")
    ...
    @JoinTable(name = "InformationItem_ownedUseCase",
        joinColumns = @JoinColumn(name = "InformationItemId"),
    ...
    @JoinTable(name = "InformationItem_templateBinding",
        joinColumns = @JoinColumn(name = "InformationItemId"),
    ...
    @JoinColumn(name = "package_Id", table = "InformationItem")
    ...
    @JoinColumn(name = "representationId", table = "InformationItem")
    ...
    @JoinTable(name = "InformationItem_ownedComment",
        joinColumns = @JoinColumn(name = "InformationItemId"),
    ...
    @JoinTable(name = "InformationItem_powertypeExtent",
        joinColumns = @JoinColumn(name = "InformationItemId"),
