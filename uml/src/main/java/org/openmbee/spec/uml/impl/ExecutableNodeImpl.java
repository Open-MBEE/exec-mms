...
public abstract class ExecutableNodeImpl extends MofObjectImpl implements ExecutableNode {
    ...
    @JoinTable(name = "ExecutableNode_redefinedNode",
        joinColumns = @JoinColumn(name = "ExecutableNodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ExecutableNode")
    ...
    @JoinTable(name = "ExecutableNode_handler",
        joinColumns = @JoinColumn(name = "ExecutableNodeId"),
    ...
    @JoinTable(name = "ExecutableNode_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ExecutableNodeId"),
    ...
    @JoinTable(name = "ExecutableNode_outgoing",
        joinColumns = @JoinColumn(name = "ExecutableNodeId"),
    ...
    @JoinTable(name = "ExecutableNode_inPartition",
        joinColumns = @JoinColumn(name = "ExecutableNodeId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "ExecutableNode")
    ...
    @JoinTable(name = "ExecutableNode_incoming",
        joinColumns = @JoinColumn(name = "ExecutableNodeId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ExecutableNode")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ExecutableNode")
    ...
    @JoinTable(name = "ExecutableNode_ownedComment",
        joinColumns = @JoinColumn(name = "ExecutableNodeId"),
    ...
    @JoinColumn(name = "activityId", table = "ExecutableNode")
