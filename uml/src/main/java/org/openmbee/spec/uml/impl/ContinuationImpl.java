...
import org.openmbee.spec.uml.Continuation;
...
@Entity
@SecondaryTable(name = "Continuation")
@Table(appliesTo = "Continuation", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Continuation")
@JsonTypeName(value = "Continuation")
public class ContinuationImpl extends MofObjectImpl implements Continuation {
    ...
    @JoinTable(name = "Continuation_generalOrdering",
        joinColumns = @JoinColumn(name = "ContinuationId"),
    ...
    @JoinColumn(name = "enclosingInteractionId", table = "Continuation")
    ...
    @JoinColumn(name = "enclosingOperandId", table = "Continuation")
    ...
    @JoinTable(name = "Continuation_covered",
        joinColumns = @JoinColumn(name = "ContinuationId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "Continuation")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "setting", table = "Continuation")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Continuation")
    ...
    @JoinTable(name = "Continuation_ownedComment",
        joinColumns = @JoinColumn(name = "ContinuationId"),
