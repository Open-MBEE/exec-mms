...
import org.openmbee.spec.uml.Include;
...
@Entity
@SecondaryTable(name = "UseCase")
@Table(appliesTo = "UseCase", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "UseCase")
@JsonTypeName(value = "UseCase")
public class UseCaseImpl extends MofObjectImpl implements UseCase {

    private Element owner;
    private Collection<RedefinableElement> redefinedElement;
    private Collection<Feature> feature;
    private Collection<Extend> extend;
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "ExtendMetaDef", metaColumn = @Column(name = "extendType"), fetch = FetchType.LAZY)
    @JoinTable(name = "UseCase_extend",
        joinColumns = @JoinColumn(name = "UseCaseId"),
        inverseJoinColumns = @JoinColumn(name = "extendId"))
    public Collection<Extend> getExtend() {
        if (extend == null) {
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(contentUsing = MofObjectDeserializer.class, contentAs = ExtendImpl.class)
    public void setExtend(Collection<Extend> extend) {
        this.extend = extend;
    }

    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "UseCase")
    ...
    @JoinTable(name = "UseCase_useCase",
        joinColumns = @JoinColumn(name = "UseCaseId"),
    ...
    @JoinTable(name = "UseCase_elementImport",
        joinColumns = @JoinColumn(name = "UseCaseId"),
    ...
    @Column(name = "name", table = "UseCase")
    ...
    @JoinTable(name = "UseCase_ownedBehavior",
        joinColumns = @JoinColumn(name = "UseCaseId"),
    ...
    @JoinColumn(name = "classifierBehaviorId", table = "UseCase")
    ...
    @JoinTable(name = "UseCase_substitution",
        joinColumns = @JoinColumn(name = "UseCaseId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "UseCase")
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "IncludeMetaDef", metaColumn = @Column(name = "includeType"), fetch = FetchType.LAZY)
    @JoinTable(name = "UseCase_include",
        joinColumns = @JoinColumn(name = "UseCaseId"),
        inverseJoinColumns = @JoinColumn(name = "includeId"))
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(contentUsing = MofObjectDeserializer.class, contentAs = IncludeImpl.class)
    ...
    @JoinTable(name = "UseCase_generalization",
        joinColumns = @JoinColumn(name = "UseCaseId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "UseCase")
    ...
    @JoinTable(name = "UseCase_interfaceRealization",
        joinColumns = @JoinColumn(name = "UseCaseId"),
    ...
    @JoinTable(name = "UseCase_packageImport",
        joinColumns = @JoinColumn(name = "UseCaseId"),
    ...
    @JoinTable(name = "UseCase_redefinedClassifier",
        joinColumns = @JoinColumn(name = "UseCaseId"),
    ...
    @JoinTable(name = "UseCase_ownedRule",
        joinColumns = @JoinColumn(name = "UseCaseId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "UseCase")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "UseCase")
    ...
    @JoinTable(name = "UseCase_collaborationUse",
        joinColumns = @JoinColumn(name = "UseCaseId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "UseCase")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "UseCase")
    ...
    @JoinTable(name = "UseCase_ownedUseCase",
        joinColumns = @JoinColumn(name = "UseCaseId"),
    ...
    @JoinTable(name = "UseCase_templateBinding",
        joinColumns = @JoinColumn(name = "UseCaseId"),
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "ClassifierMetaDef", metaColumn = @Column(name = "subjectType"), fetch = FetchType.LAZY)
    @JoinTable(name = "UseCase_subject",
        joinColumns = @JoinColumn(name = "UseCaseId"),
        inverseJoinColumns = @JoinColumn(name = "subjectId"))
    public Collection<Classifier> getSubject() {
        if (subject == null) {
    ...
    @JsonSetter
    @JsonDeserialize(contentUsing = MofObjectDeserializer.class, contentAs = ClassifierImpl.class)
    public void setSubject(Collection<Classifier> subject) {
    ...
    @JoinColumn(name = "package_Id", table = "UseCase")
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "ExtensionPointMetaDef", metaColumn = @Column(name = "extensionPointType"), fetch = FetchType.LAZY)
    @JoinTable(name = "UseCase_extensionPoint",
        joinColumns = @JoinColumn(name = "UseCaseId"),
        inverseJoinColumns = @JoinColumn(name = "extensionPointId"))
    public Collection<ExtensionPoint> getExtensionPoint() {
    ...
    public void setExtensionPoint(Collection<ExtensionPoint> extensionPoint) {
    ...
    @JoinColumn(name = "representationId", table = "UseCase")
    ...
    @JoinTable(name = "UseCase_ownedComment",
        joinColumns = @JoinColumn(name = "UseCaseId"),
    ...
    @JoinTable(name = "UseCase_powertypeExtent",
        joinColumns = @JoinColumn(name = "UseCaseId"),
