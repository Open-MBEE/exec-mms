...
import org.openmbee.spec.uml.AddStructuralFeatureValueAction;
...
@Entity
@SecondaryTable(name = "AddStructuralFeatureValueAction")
@Table(appliesTo = "AddStructuralFeatureValueAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "AddStructuralFeatureValueAction")
@JsonTypeName(value = "AddStructuralFeatureValueAction")
public class AddStructuralFeatureValueActionImpl extends MofObjectImpl implements
    ...
    @JoinColumn(name = "insertAtId", table = "AddStructuralFeatureValueAction")
    ...
    @JoinTable(name = "AddStructuralFeatureValueAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "AddStructuralFeatureValueActionId"),
    ...
    @JoinColumn(name = "resultId", table = "AddStructuralFeatureValueAction")
    ...
    @JoinColumn(name = "structuralFeatureId", table = "AddStructuralFeatureValueAction")
    ...
    @Column(name = "name", table = "AddStructuralFeatureValueAction")
    ...
    @JoinTable(name = "AddStructuralFeatureValueAction_localPrecondition",
        joinColumns = @JoinColumn(name = "AddStructuralFeatureValueActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "AddStructuralFeatureValueAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "AddStructuralFeatureValueAction")
    ...
    @JoinColumn(name = "activityId", table = "AddStructuralFeatureValueAction")
    ...
    @JoinTable(name = "AddStructuralFeatureValueAction_localPostcondition",
        joinColumns = @JoinColumn(name = "AddStructuralFeatureValueActionId"),
    ...
    @JoinTable(name = "AddStructuralFeatureValueAction_redefinedNode",
        joinColumns = @JoinColumn(name = "AddStructuralFeatureValueActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "AddStructuralFeatureValueAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "AddStructuralFeatureValueAction")
    ...
    @JoinTable(name = "AddStructuralFeatureValueAction_handler",
        joinColumns = @JoinColumn(name = "AddStructuralFeatureValueActionId"),
    ...
    @JoinColumn(name = "valueId", table = "AddStructuralFeatureValueAction")
    ...
    @JoinTable(name = "AddStructuralFeatureValueAction_outgoing",
        joinColumns = @JoinColumn(name = "AddStructuralFeatureValueActionId"),
    ...
    @JoinTable(name = "AddStructuralFeatureValueAction_inPartition",
        joinColumns = @JoinColumn(name = "AddStructuralFeatureValueActionId"),
    ...
    @JoinColumn(name = "objectId", table = "AddStructuralFeatureValueAction")
    ...
    @JoinTable(name = "AddStructuralFeatureValueAction_incoming",
        joinColumns = @JoinColumn(name = "AddStructuralFeatureValueActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isReplaceAll", table = "AddStructuralFeatureValueAction")
    ...
    @JoinTable(name = "AddStructuralFeatureValueAction_ownedComment",
        joinColumns = @JoinColumn(name = "AddStructuralFeatureValueActionId"),
