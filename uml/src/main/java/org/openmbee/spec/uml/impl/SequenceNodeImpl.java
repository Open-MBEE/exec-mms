...
import org.openmbee.spec.uml.SequenceNode;
...
@Entity
@SecondaryTable(name = "SequenceNode")
@Table(appliesTo = "SequenceNode", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "SequenceNode")
@JsonTypeName(value = "SequenceNode")
public class SequenceNodeImpl extends MofObjectImpl implements SequenceNode {
    ...
    @JoinTable(name = "SequenceNode_structuredNodeOutput",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
    ...
    @JoinTable(name = "SequenceNode_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
    ...
    @JoinColumn(name = "inActivityId", table = "SequenceNode")
    ...
    @JoinTable(name = "SequenceNode_elementImport",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
    ...
    @JoinTable(name = "SequenceNode_variable",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
    ...
    @Column(name = "name", table = "SequenceNode")
    ...
    @JoinTable(name = "SequenceNode_localPrecondition",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "SequenceNode")
    ...
    @JoinColumn(name = "activityId", table = "SequenceNode")
    ...
    @JoinTable(name = "SequenceNode_packageImport",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
    ...
    @JoinTable(name = "SequenceNode_ownedRule",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "SequenceNode")
    ...
    @JoinTable(name = "SequenceNode_structuredNodeInput",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
    ...
    @JoinTable(name = "SequenceNode_localPostcondition",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
    ...
    @JoinTable(name = "SequenceNode_redefinedNode",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "SequenceNode")
    ...
    @JoinTable(name = "SequenceNode_node",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "SequenceNode")
    ...
    @JoinTable(name = "SequenceNode_handler",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
    ...
    @JoinTable(name = "SequenceNode_edge",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
    ...
    @JoinTable(name = "SequenceNode_outgoing",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
    ...
    @JoinTable(name = "SequenceNode_inPartition",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
    ...
    @JoinTable(name = "SequenceNode_incoming",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "mustIsolate", table = "SequenceNode")
    ...
    @JoinTable(name = "SequenceNode_ownedComment",
        joinColumns = @JoinColumn(name = "SequenceNodeId"),
