...
import org.openmbee.spec.uml.Observation;
...
@Entity
@SecondaryTable(name = "TimeExpression")
@Table(appliesTo = "TimeExpression", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "TimeExpression")
@JsonTypeName(value = "TimeExpression")
public class TimeExpressionImpl extends MofObjectImpl implements TimeExpression {

    private Element owner;
    private ValueSpecification expr;
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "ValueSpecificationMetaDef", metaColumn = @Column(name = "exprType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "exprId", table = "TimeExpression")
    ...
    public void setExpr(ValueSpecification expr) {
        this.expr = expr;
    }
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "ObservationMetaDef", metaColumn = @Column(name = "observationType"), fetch = FetchType.LAZY)
    @JoinTable(name = "TimeExpression_observation",
        joinColumns = @JoinColumn(name = "TimeExpressionId"),
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(contentUsing = MofObjectDeserializer.class, contentAs = ObservationImpl.class)
    ...
    @JoinColumn(name = "typeId", table = "TimeExpression")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "TimeExpression")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "TimeExpression")
    ...
    @JoinColumn(name = "templateParameterId", table = "TimeExpression")
    ...
    @JoinColumn(name = "nameExpressionId", table = "TimeExpression")
    ...
    @JoinTable(name = "TimeExpression_ownedComment",
        joinColumns = @JoinColumn(name = "TimeExpressionId"),
