...
public abstract class ClassifierImpl extends MofObjectImpl implements Classifier {
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "Classifier")
    ...
    @JoinTable(name = "Classifier_useCase",
    ...
    @JoinTable(name = "Classifier_elementImport",
        joinColumns = @JoinColumn(name = "ClassifierId"),
    ...
    @Column(name = "name", table = "Classifier")
    ...
    @JoinTable(name = "Classifier_substitution",
        joinColumns = @JoinColumn(name = "ClassifierId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "Classifier")
    ...
    @JoinTable(name = "Classifier_generalization",
        joinColumns = @JoinColumn(name = "ClassifierId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "Classifier")
    ...
    @JoinTable(name = "Classifier_packageImport",
        joinColumns = @JoinColumn(name = "ClassifierId"),
    ...
    @JoinTable(name = "Classifier_redefinedClassifier",
        joinColumns = @JoinColumn(name = "ClassifierId"),
    ...
    @JoinTable(name = "Classifier_ownedRule",
        joinColumns = @JoinColumn(name = "ClassifierId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Classifier")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "Classifier")
    ...
    @JoinTable(name = "Classifier_collaborationUse",
        joinColumns = @JoinColumn(name = "ClassifierId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Classifier")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "Classifier")
    ...
    @JoinTable(name = "Classifier_ownedUseCase",
        joinColumns = @JoinColumn(name = "ClassifierId"),
    ...
    @JoinTable(name = "Classifier_templateBinding",
        joinColumns = @JoinColumn(name = "ClassifierId"),
    ...
    @JoinColumn(name = "package_Id", table = "Classifier")
    ...
    @JoinColumn(name = "representationId", table = "Classifier")
    ...
    @JoinTable(name = "Classifier_ownedComment",
        joinColumns = @JoinColumn(name = "ClassifierId"),
    ...
    @JoinTable(name = "Classifier_powertypeExtent",
        joinColumns = @JoinColumn(name = "ClassifierId"),
