...
import org.openmbee.spec.uml.StartClassifierBehaviorAction;
...
@Entity
@SecondaryTable(name = "StartClassifierBehaviorAction")
@Table(appliesTo = "StartClassifierBehaviorAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "StartClassifierBehaviorAction")
@JsonTypeName(value = "StartClassifierBehaviorAction")
public class StartClassifierBehaviorActionImpl extends MofObjectImpl implements
    ...
    @JoinTable(name = "StartClassifierBehaviorAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "StartClassifierBehaviorActionId"),
    ...
    @JoinColumn(name = "objectId", table = "StartClassifierBehaviorAction")
    ...
    @Column(name = "name", table = "StartClassifierBehaviorAction")
    ...
    @JoinTable(name = "StartClassifierBehaviorAction_localPrecondition",
        joinColumns = @JoinColumn(name = "StartClassifierBehaviorActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "StartClassifierBehaviorAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "StartClassifierBehaviorAction")
    ...
    @JoinColumn(name = "activityId", table = "StartClassifierBehaviorAction")
    ...
    @JoinTable(name = "StartClassifierBehaviorAction_localPostcondition",
        joinColumns = @JoinColumn(name = "StartClassifierBehaviorActionId"),
    ...
    @JoinTable(name = "StartClassifierBehaviorAction_redefinedNode",
        joinColumns = @JoinColumn(name = "StartClassifierBehaviorActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "StartClassifierBehaviorAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "StartClassifierBehaviorAction")
    ...
    @JoinTable(name = "StartClassifierBehaviorAction_handler",
        joinColumns = @JoinColumn(name = "StartClassifierBehaviorActionId"),
    ...
    @JoinTable(name = "StartClassifierBehaviorAction_outgoing",
        joinColumns = @JoinColumn(name = "StartClassifierBehaviorActionId"),
    ...
    @JoinTable(name = "StartClassifierBehaviorAction_inPartition",
        joinColumns = @JoinColumn(name = "StartClassifierBehaviorActionId"),
    ...
    @JoinTable(name = "StartClassifierBehaviorAction_incoming",
        joinColumns = @JoinColumn(name = "StartClassifierBehaviorActionId"),
    ...
    @JoinTable(name = "StartClassifierBehaviorAction_ownedComment",
        joinColumns = @JoinColumn(name = "StartClassifierBehaviorActionId"),
