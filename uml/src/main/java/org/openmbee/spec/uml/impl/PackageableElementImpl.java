...
public abstract class PackageableElementImpl extends MofObjectImpl implements PackageableElement {
    ...
    @Column(name = "name", table = "PackageableElement")
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "PackageableElement")
    ...
    @JoinColumn(name = "templateParameterId", table = "PackageableElement")
    ...
    @JoinColumn(name = "nameExpressionId", table = "PackageableElement")
    ...
    @JoinTable(name = "PackageableElement_ownedComment",
        joinColumns = @JoinColumn(name = "PackageableElementId"),
