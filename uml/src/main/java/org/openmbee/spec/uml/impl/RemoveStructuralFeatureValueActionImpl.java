...
import org.openmbee.spec.uml.RemoveStructuralFeatureValueAction;
...
@Entity
@SecondaryTable(name = "RemoveStructuralFeatureValueAction")
@Table(appliesTo = "RemoveStructuralFeatureValueAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "RemoveStructuralFeatureValueAction")
@JsonTypeName(value = "RemoveStructuralFeatureValueAction")
public class RemoveStructuralFeatureValueActionImpl extends MofObjectImpl implements
    ...
    @JoinTable(name = "RemoveStructuralFeatureValueAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "RemoveStructuralFeatureValueActionId"),
    ...
    @JoinColumn(name = "resultId", table = "RemoveStructuralFeatureValueAction")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "StructuralFeatureMetaDef", metaColumn = @Column(name = "structuralFeatureType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "structuralFeatureId", table = "RemoveStructuralFeatureValueAction")
    ...
    @Column(name = "name", table = "RemoveStructuralFeatureValueAction")
    ...
    @JoinTable(name = "RemoveStructuralFeatureValueAction_localPrecondition",
        joinColumns = @JoinColumn(name = "RemoveStructuralFeatureValueActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isRemoveDuplicates", table = "RemoveStructuralFeatureValueAction")
    ...
    @JsonProperty(required = true)
    @JsonSetter
    public void setRemoveDuplicates(Boolean isRemoveDuplicates) {
    ...
    @JoinColumn(name = "nameExpressionId", table = "RemoveStructuralFeatureValueAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "RemoveStructuralFeatureValueAction")
    ...
    @JoinColumn(name = "activityId", table = "RemoveStructuralFeatureValueAction")
    ...
    @JoinTable(name = "RemoveStructuralFeatureValueAction_localPostcondition",
        joinColumns = @JoinColumn(name = "RemoveStructuralFeatureValueActionId"),
    ...
    @JoinTable(name = "RemoveStructuralFeatureValueAction_redefinedNode",
        joinColumns = @JoinColumn(name = "RemoveStructuralFeatureValueActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "RemoveStructuralFeatureValueAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "RemoveStructuralFeatureValueAction")
    ...
    @JoinTable(name = "RemoveStructuralFeatureValueAction_handler",
        joinColumns = @JoinColumn(name = "RemoveStructuralFeatureValueActionId"),
    ...
    @JoinColumn(name = "valueId", table = "RemoveStructuralFeatureValueAction")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "InputPinMetaDef", metaColumn = @Column(name = "removeAtType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "removeAtId", table = "RemoveStructuralFeatureValueAction")
    ...
    @JoinTable(name = "RemoveStructuralFeatureValueAction_outgoing",
        joinColumns = @JoinColumn(name = "RemoveStructuralFeatureValueActionId"),
    ...
    @JoinTable(name = "RemoveStructuralFeatureValueAction_inPartition",
        joinColumns = @JoinColumn(name = "RemoveStructuralFeatureValueActionId"),
    ...
    @JoinColumn(name = "objectId", table = "RemoveStructuralFeatureValueAction")
    ...
    @JoinTable(name = "RemoveStructuralFeatureValueAction_incoming",
        joinColumns = @JoinColumn(name = "RemoveStructuralFeatureValueActionId"),
    ...
    @JoinTable(name = "RemoveStructuralFeatureValueAction_ownedComment",
        joinColumns = @JoinColumn(name = "RemoveStructuralFeatureValueActionId"),
