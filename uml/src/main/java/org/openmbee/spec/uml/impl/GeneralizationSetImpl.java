...
@Entity
@SecondaryTable(name = "GeneralizationSet")
@Table(appliesTo = "GeneralizationSet", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "GeneralizationSet")
@JsonTypeName(value = "GeneralizationSet")
public class GeneralizationSetImpl extends MofObjectImpl implements GeneralizationSet {
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "GeneralizationSet")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isDisjoint", table = "GeneralizationSet")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "GeneralizationSet")
    ...
    @JoinColumn(name = "templateParameterId", table = "GeneralizationSet")
    ...
    @JoinColumn(name = "nameExpressionId", table = "GeneralizationSet")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isCovering", table = "GeneralizationSet")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "ClassifierMetaDef", metaColumn = @Column(name = "powertypeType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "powertypeId", table = "GeneralizationSet")
    ...
    @JoinTable(name = "GeneralizationSet_ownedComment",
        joinColumns = @JoinColumn(name = "GeneralizationSetId"),
    ...
    @JoinTable(name = "GeneralizationSet_generalization",
        joinColumns = @JoinColumn(name = "GeneralizationSetId"),
