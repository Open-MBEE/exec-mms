...
import org.openmbee.spec.uml.InvocationAction;
...
public abstract class InvocationActionImpl extends MofObjectImpl implements InvocationAction {
    ...
    @JoinColumn(name = "onPortId", table = "InvocationAction")
    ...
    @JoinTable(name = "InvocationAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "InvocationActionId"),
    ...
    @JoinTable(name = "InvocationAction_argument",
        joinColumns = @JoinColumn(name = "InvocationActionId"),
    ...
    @Column(name = "name", table = "InvocationAction")
    ...
    @JoinTable(name = "InvocationAction_localPrecondition",
        joinColumns = @JoinColumn(name = "InvocationActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "InvocationAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "InvocationAction")
    ...
    @JoinColumn(name = "activityId", table = "InvocationAction")
    ...
    @JoinTable(name = "InvocationAction_localPostcondition",
        joinColumns = @JoinColumn(name = "InvocationActionId"),
    ...
    @JoinTable(name = "InvocationAction_redefinedNode",
        joinColumns = @JoinColumn(name = "InvocationActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "InvocationAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "InvocationAction")
    ...
    @JoinTable(name = "InvocationAction_handler",
        joinColumns = @JoinColumn(name = "InvocationActionId"),
    ...
    @JoinTable(name = "InvocationAction_outgoing",
        joinColumns = @JoinColumn(name = "InvocationActionId"),
    ...
    @JoinTable(name = "InvocationAction_inPartition",
        joinColumns = @JoinColumn(name = "InvocationActionId"),
    ...
    @JoinTable(name = "InvocationAction_incoming",
        joinColumns = @JoinColumn(name = "InvocationActionId"),
    ...
    @JoinTable(name = "InvocationAction_ownedComment",
        joinColumns = @JoinColumn(name = "InvocationActionId"),
