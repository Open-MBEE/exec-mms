...
import org.openmbee.spec.uml.DeploymentTarget;
...
public abstract class DeploymentTargetImpl extends MofObjectImpl implements DeploymentTarget {
    ...
    @Column(name = "name", table = "DeploymentTarget")
    ...
    @JoinTable(name = "DeploymentTarget_deployment",
        joinColumns = @JoinColumn(name = "DeploymentTargetId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "DeploymentTarget")
    ...
    @JoinTable(name = "DeploymentTarget_ownedComment",
        joinColumns = @JoinColumn(name = "DeploymentTargetId"),
