...
import org.openmbee.spec.uml.AcceptEventAction;
...
@Entity
@SecondaryTable(name = "AcceptEventAction")
@Table(appliesTo = "AcceptEventAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "AcceptEventAction")
@JsonTypeName(value = "AcceptEventAction")
public class AcceptEventActionImpl extends MofObjectImpl implements AcceptEventAction {
    ...
    @JoinTable(name = "AcceptEventAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "AcceptEventActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isUnmarshall", table = "AcceptEventAction")
    ...
    @Column(name = "name", table = "AcceptEventAction")
    ...
    @JoinTable(name = "AcceptEventAction_localPrecondition",
        joinColumns = @JoinColumn(name = "AcceptEventActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "AcceptEventAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "AcceptEventAction")
    ...
    @JoinColumn(name = "activityId", table = "AcceptEventAction")
    ...
    @JoinTable(name = "AcceptEventAction_localPostcondition",
        joinColumns = @JoinColumn(name = "AcceptEventActionId"),
    ...
    @JoinTable(name = "AcceptEventAction_redefinedNode",
        joinColumns = @JoinColumn(name = "AcceptEventActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "AcceptEventAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "AcceptEventAction")
    ...
    @JoinTable(name = "AcceptEventAction_handler",
        joinColumns = @JoinColumn(name = "AcceptEventActionId"),
    ...
    @JoinTable(name = "AcceptEventAction_result",
        joinColumns = @JoinColumn(name = "AcceptEventActionId"),
    ...
    @JoinTable(name = "AcceptEventAction_outgoing",
        joinColumns = @JoinColumn(name = "AcceptEventActionId"),
    ...
    @JoinTable(name = "AcceptEventAction_inPartition",
        joinColumns = @JoinColumn(name = "AcceptEventActionId"),
    ...
    @JoinTable(name = "AcceptEventAction_trigger",
        joinColumns = @JoinColumn(name = "AcceptEventActionId"),
    ...
    @JoinTable(name = "AcceptEventAction_incoming",
        joinColumns = @JoinColumn(name = "AcceptEventActionId"),
    ...
    @JoinTable(name = "AcceptEventAction_ownedComment",
        joinColumns = @JoinColumn(name = "AcceptEventActionId"),
