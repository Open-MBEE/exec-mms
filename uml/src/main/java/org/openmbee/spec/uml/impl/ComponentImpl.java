...
import org.openmbee.spec.uml.Component;
import org.openmbee.spec.uml.ComponentRealization;
...
@Entity
@SecondaryTable(name = "Component")
@Table(appliesTo = "Component", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Component")
@JsonTypeName(value = "Component")
public class ComponentImpl extends MofObjectImpl implements Component {

    private Collection<ComponentRealization> realization;
    ...
    @ManyToAny(metaDef = "ComponentRealizationMetaDef", metaColumn = @Column(name = "realizationType"), fetch = FetchType.LAZY)
    @JoinTable(name = "Component_realization",
        joinColumns = @JoinColumn(name = "ComponentId"),
        inverseJoinColumns = @JoinColumn(name = "realizationId"))
    public Collection<ComponentRealization> getRealization() {
        if (realization == null) {
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(contentUsing = MofObjectDeserializer.class, contentAs = ComponentRealizationImpl.class)
    public void setRealization(Collection<ComponentRealization> realization) {
    ...
    @JoinTable(name = "Component_elementImport",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @Column(name = "name", table = "Component")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Component")
    ...
    @JoinTable(name = "Component_generalization",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JoinTable(name = "Component_packageImport",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JoinTable(name = "Component_ownedOperation",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "Component")
    ...
    @JoinTable(name = "Component_ownedAttribute",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JoinTable(name = "Component_templateBinding",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JoinTable(name = "Component_packagedElement",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JoinColumn(name = "representationId", table = "Component")
    ...
    @JoinTable(name = "Component_ownedReception",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "Component")
    ...
    @JoinTable(name = "Component_useCase",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JoinTable(name = "Component_ownedBehavior",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JoinColumn(name = "classifierBehaviorId", table = "Component")
    ...
    @JoinTable(name = "Component_substitution",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JoinTable(name = "Component_ownedConnector",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "Component")
    ...
    @JoinTable(name = "Component_interfaceRealization",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JoinTable(name = "Component_redefinedClassifier",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JoinTable(name = "Component_ownedRule",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Component")
    ...
    @JoinTable(name = "Component_collaborationUse",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Component")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "Component")
    ...
    @JoinTable(name = "Component_nestedClassifier",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JoinTable(name = "Component_ownedUseCase",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isActive", table = "Component")
    ...
    @JoinColumn(name = "package_Id", table = "Component")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isIndirectlyInstantiated", table = "Component")
    ...
    @JsonProperty(required = true)
    @JsonSetter
    public void setIndirectlyInstantiated(Boolean isIndirectlyInstantiated) {
    ...
    @JoinTable(name = "Component_ownedComment",
        joinColumns = @JoinColumn(name = "ComponentId"),
    ...
    @JoinTable(name = "Component_powertypeExtent",
        joinColumns = @JoinColumn(name = "ComponentId"),
