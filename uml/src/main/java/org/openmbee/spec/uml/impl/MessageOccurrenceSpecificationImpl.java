...
import org.openmbee.spec.uml.MessageOccurrenceSpecification;
...
@Entity
@SecondaryTable(name = "MessageOccurrenceSpecification")
@Table(appliesTo = "MessageOccurrenceSpecification", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "MessageOccurrenceSpecification")
@JsonTypeName(value = "MessageOccurrenceSpecification")
public class MessageOccurrenceSpecificationImpl extends MofObjectImpl implements
    ...
    @JoinColumn(name = "messageId", table = "MessageOccurrenceSpecification")
    ...
    @JoinTable(name = "MessageOccurrenceSpecification_generalOrdering",
        joinColumns = @JoinColumn(name = "MessageOccurrenceSpecificationId"),
    ...
    @JoinColumn(name = "enclosingInteractionId", table = "MessageOccurrenceSpecification")
    ...
    @JoinColumn(name = "enclosingOperandId", table = "MessageOccurrenceSpecification")
    ...
    @JoinTable(name = "MessageOccurrenceSpecification_covered",
        joinColumns = @JoinColumn(name = "MessageOccurrenceSpecificationId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "MessageOccurrenceSpecification")
    ...
    @JoinTable(name = "MessageOccurrenceSpecification_toAfter",
        joinColumns = @JoinColumn(name = "MessageOccurrenceSpecificationId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "MessageOccurrenceSpecification")
    ...
    @JoinTable(name = "MessageOccurrenceSpecification_toBefore",
        joinColumns = @JoinColumn(name = "MessageOccurrenceSpecificationId"),
    ...
    @JoinTable(name = "MessageOccurrenceSpecification_ownedComment",
        joinColumns = @JoinColumn(name = "MessageOccurrenceSpecificationId"),
