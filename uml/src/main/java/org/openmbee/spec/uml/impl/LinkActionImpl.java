...
import org.openmbee.spec.uml.LinkAction;
...
public abstract class LinkActionImpl extends MofObjectImpl implements LinkAction {
    ...
    @JoinTable(name = "LinkAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "LinkActionId"),
    ...
    @JoinTable(name = "LinkAction_inputValue",
        joinColumns = @JoinColumn(name = "LinkActionId"),
    ...
    @Column(name = "name", table = "LinkAction")
    ...
    @JoinTable(name = "LinkAction_localPrecondition",
        joinColumns = @JoinColumn(name = "LinkActionId"),
    ...
    @JoinTable(name = "LinkAction_endData",
        joinColumns = @JoinColumn(name = "LinkActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "LinkAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "LinkAction")
    ...
    @JoinColumn(name = "activityId", table = "LinkAction")
    ...
    @JoinTable(name = "LinkAction_localPostcondition",
        joinColumns = @JoinColumn(name = "LinkActionId"),
    ...
    @JoinTable(name = "LinkAction_redefinedNode",
        joinColumns = @JoinColumn(name = "LinkActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "LinkAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "LinkAction")
    ...
    @JoinTable(name = "LinkAction_handler",
        joinColumns = @JoinColumn(name = "LinkActionId"),
    ...
    @JoinTable(name = "LinkAction_outgoing",
        joinColumns = @JoinColumn(name = "LinkActionId"),
    ...
    @JoinTable(name = "LinkAction_inPartition",
        joinColumns = @JoinColumn(name = "LinkActionId"),
    ...
    @JoinTable(name = "LinkAction_incoming",
        joinColumns = @JoinColumn(name = "LinkActionId"),
    ...
    @JoinTable(name = "LinkAction_ownedComment",
        joinColumns = @JoinColumn(name = "LinkActionId"),
