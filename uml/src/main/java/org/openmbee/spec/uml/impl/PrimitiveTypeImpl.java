...
import org.openmbee.spec.uml.PrimitiveType;
...
@Entity
@SecondaryTable(name = "PrimitiveType")
@Table(appliesTo = "PrimitiveType", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "PrimitiveType")
@JsonTypeName(value = "PrimitiveType")
public class PrimitiveTypeImpl extends MofObjectImpl implements PrimitiveType {
    ...
    @JoinTable(name = "PrimitiveType_ownedAttribute",
        joinColumns = @JoinColumn(name = "PrimitiveTypeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "PrimitiveType")
    ...
    @JoinTable(name = "PrimitiveType_useCase",
        joinColumns = @JoinColumn(name = "PrimitiveTypeId"),
    ...
    @JoinTable(name = "PrimitiveType_elementImport",
        joinColumns = @JoinColumn(name = "PrimitiveTypeId"),
    ...
    @Column(name = "name", table = "PrimitiveType")
    ...
    @JoinTable(name = "PrimitiveType_substitution",
        joinColumns = @JoinColumn(name = "PrimitiveTypeId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "PrimitiveType")
    ...
    @JoinTable(name = "PrimitiveType_generalization",
        joinColumns = @JoinColumn(name = "PrimitiveTypeId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "PrimitiveType")
    ...
    @JoinTable(name = "PrimitiveType_packageImport",
        joinColumns = @JoinColumn(name = "PrimitiveTypeId"),
    ...
    @JoinTable(name = "PrimitiveType_redefinedClassifier",
        joinColumns = @JoinColumn(name = "PrimitiveTypeId"),
    ...
    @JoinTable(name = "PrimitiveType_ownedRule",
        joinColumns = @JoinColumn(name = "PrimitiveTypeId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "PrimitiveType")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "PrimitiveType")
    ...
    @JoinTable(name = "PrimitiveType_collaborationUse",
        joinColumns = @JoinColumn(name = "PrimitiveTypeId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "PrimitiveType")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "PrimitiveType")
    ...
    @JoinTable(name = "PrimitiveType_ownedUseCase",
        joinColumns = @JoinColumn(name = "PrimitiveTypeId"),
    ...
    @JoinTable(name = "PrimitiveType_templateBinding",
        joinColumns = @JoinColumn(name = "PrimitiveTypeId"),
    ...
    @JoinColumn(name = "package_Id", table = "PrimitiveType")
    ...
    @JoinColumn(name = "representationId", table = "PrimitiveType")
    ...
    @JoinTable(name = "PrimitiveType_ownedOperation",
        joinColumns = @JoinColumn(name = "PrimitiveTypeId"),
    ...
    @JoinTable(name = "PrimitiveType_ownedComment",
        joinColumns = @JoinColumn(name = "PrimitiveTypeId"),
    ...
    @JoinTable(name = "PrimitiveType_powertypeExtent",
        joinColumns = @JoinColumn(name = "PrimitiveTypeId"),
