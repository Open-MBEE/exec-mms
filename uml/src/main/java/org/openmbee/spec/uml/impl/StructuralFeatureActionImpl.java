...
import org.openmbee.spec.uml.StructuralFeatureAction;
...
public abstract class StructuralFeatureActionImpl extends MofObjectImpl implements
    ...
    @JoinTable(name = "StructuralFeatureAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "StructuralFeatureActionId"),
    ...
    @JoinColumn(name = "structuralFeatureId", table = "StructuralFeatureAction")
    ...
    @Column(name = "name", table = "StructuralFeatureAction")
    ...
    @JoinTable(name = "StructuralFeatureAction_localPrecondition",
        joinColumns = @JoinColumn(name = "StructuralFeatureActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "StructuralFeatureAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "StructuralFeatureAction")
    ...
    @JoinColumn(name = "activityId", table = "StructuralFeatureAction")
    ...
    @JoinTable(name = "StructuralFeatureAction_localPostcondition",
        joinColumns = @JoinColumn(name = "StructuralFeatureActionId"),
    ...
    @JoinTable(name = "StructuralFeatureAction_redefinedNode",
        joinColumns = @JoinColumn(name = "StructuralFeatureActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "StructuralFeatureAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "StructuralFeatureAction")
    ...
    @JoinTable(name = "StructuralFeatureAction_handler",
        joinColumns = @JoinColumn(name = "StructuralFeatureActionId"),
    ...
    @JoinTable(name = "StructuralFeatureAction_outgoing",
        joinColumns = @JoinColumn(name = "StructuralFeatureActionId"),
    ...
    @JoinTable(name = "StructuralFeatureAction_inPartition",
        joinColumns = @JoinColumn(name = "StructuralFeatureActionId"),
    ...
    @JoinColumn(name = "objectId", table = "StructuralFeatureAction")
    ...
    @JoinTable(name = "StructuralFeatureAction_incoming",
        joinColumns = @JoinColumn(name = "StructuralFeatureActionId"),
    ...
    @JoinTable(name = "StructuralFeatureAction_ownedComment",
        joinColumns = @JoinColumn(name = "StructuralFeatureActionId"),
