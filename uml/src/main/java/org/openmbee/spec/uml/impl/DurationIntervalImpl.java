...
import org.openmbee.spec.uml.Duration;
...
@Entity
@SecondaryTable(name = "DurationInterval")
@Table(appliesTo = "DurationInterval", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "DurationInterval")
@JsonTypeName(value = "DurationInterval")
public class DurationIntervalImpl extends MofObjectImpl implements DurationInterval {
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "DurationMetaDef", metaColumn = @Column(name = "minType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "minId", table = "DurationInterval")
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(using = MofObjectDeserializer.class, as = DurationImpl.class)
    ...
    @JoinColumn(name = "typeId", table = "DurationInterval")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "DurationInterval")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "DurationInterval")
    ...
    @JoinColumn(name = "templateParameterId", table = "DurationInterval")
    ...
    @JoinColumn(name = "nameExpressionId", table = "DurationInterval")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "DurationMetaDef", metaColumn = @Column(name = "maxType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "maxId", table = "DurationInterval")
    ...
    @JoinTable(name = "DurationInterval_ownedComment",
        joinColumns = @JoinColumn(name = "DurationIntervalId"),
