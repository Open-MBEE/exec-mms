...
import org.openmbee.spec.uml.FinalState;
...
@Entity
@SecondaryTable(name = "FinalState")
@Table(appliesTo = "FinalState", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "FinalState")
@JsonTypeName(value = "FinalState")
public class FinalStateImpl extends MofObjectImpl implements FinalState {
    ...
    @JoinColumn(name = "entryId", table = "FinalState")
    ...
    @JoinColumn(name = "stateInvariantId", table = "FinalState")
    ...
    @JoinTable(name = "FinalState_elementImport",
        joinColumns = @JoinColumn(name = "FinalStateId"),
    ...
    @Column(name = "name", table = "FinalState")
    ...
    @JoinColumn(name = "nameExpressionId", table = "FinalState")
    ...
    @JoinTable(name = "FinalState_packageImport",
        joinColumns = @JoinColumn(name = "FinalStateId"),
    ...
    @JoinTable(name = "FinalState_ownedRule",
        joinColumns = @JoinColumn(name = "FinalStateId"),
    ...
    @JoinTable(name = "FinalState_connection",
        joinColumns = @JoinColumn(name = "FinalStateId"),
    ...
    @JoinColumn(name = "containerId", table = "FinalState")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "FinalState")
    ...
    @JoinTable(name = "FinalState_connectionPoint",
        joinColumns = @JoinColumn(name = "FinalStateId"),
    ...
    @JoinTable(name = "FinalState_region",
        joinColumns = @JoinColumn(name = "FinalStateId"),
    ...
    @JoinColumn(name = "exitId", table = "FinalState")
    ...
    @JoinColumn(name = "redefinedVertexId", table = "FinalState")
    ...
    @JoinTable(name = "FinalState_deferrableTrigger",
        joinColumns = @JoinColumn(name = "FinalStateId"),
    ...
    @JoinTable(name = "FinalState_ownedComment",
        joinColumns = @JoinColumn(name = "FinalStateId"),
    ...
    @JoinColumn(name = "submachineId", table = "FinalState")
    ...
    @JoinColumn(name = "doActivityId", table = "FinalState")
