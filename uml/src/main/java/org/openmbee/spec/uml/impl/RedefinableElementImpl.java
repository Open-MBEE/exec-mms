...
public abstract class RedefinableElementImpl extends MofObjectImpl implements RedefinableElement {
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "RedefinableElement")
    ...
    @Column(name = "name", table = "RedefinableElement")
    ...
    @JoinColumn(name = "nameExpressionId", table = "RedefinableElement")
    ...
    @JoinTable(name = "RedefinableElement_ownedComment",
        joinColumns = @JoinColumn(name = "RedefinableElementId"),
