...
import org.openmbee.spec.uml.RaiseExceptionAction;
...
@Entity
@SecondaryTable(name = "RaiseExceptionAction")
@Table(appliesTo = "RaiseExceptionAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "RaiseExceptionAction")
@JsonTypeName(value = "RaiseExceptionAction")
public class RaiseExceptionActionImpl extends MofObjectImpl implements RaiseExceptionAction {
    ...
    @JoinTable(name = "RaiseExceptionAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "RaiseExceptionActionId"),
    ...
    @Column(name = "name", table = "RaiseExceptionAction")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "InputPinMetaDef", metaColumn = @Column(name = "exceptionType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "exceptionId", table = "RaiseExceptionAction")
    ...
    @JoinTable(name = "RaiseExceptionAction_localPrecondition",
        joinColumns = @JoinColumn(name = "RaiseExceptionActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "RaiseExceptionAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "RaiseExceptionAction")
    ...
    @JoinColumn(name = "activityId", table = "RaiseExceptionAction")
    ...
    @JoinTable(name = "RaiseExceptionAction_localPostcondition",
        joinColumns = @JoinColumn(name = "RaiseExceptionActionId"),
    ...
    @JoinTable(name = "RaiseExceptionAction_redefinedNode",
        joinColumns = @JoinColumn(name = "RaiseExceptionActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "RaiseExceptionAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "RaiseExceptionAction")
    ...
    @JoinTable(name = "RaiseExceptionAction_handler",
        joinColumns = @JoinColumn(name = "RaiseExceptionActionId"),
    ...
    @JoinTable(name = "RaiseExceptionAction_outgoing",
        joinColumns = @JoinColumn(name = "RaiseExceptionActionId"),
    ...
    @JoinTable(name = "RaiseExceptionAction_inPartition",
        joinColumns = @JoinColumn(name = "RaiseExceptionActionId"),
    ...
    @JoinTable(name = "RaiseExceptionAction_incoming",
        joinColumns = @JoinColumn(name = "RaiseExceptionActionId"),
    ...
    @JoinTable(name = "RaiseExceptionAction_ownedComment",
        joinColumns = @JoinColumn(name = "RaiseExceptionActionId"),
