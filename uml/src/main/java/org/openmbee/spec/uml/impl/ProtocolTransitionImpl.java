...
import org.openmbee.spec.uml.ProtocolTransition;
...
@Entity
@SecondaryTable(name = "ProtocolTransition")
@Table(appliesTo = "ProtocolTransition", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ProtocolTransition")
@JsonTypeName(value = "ProtocolTransition")
public class ProtocolTransitionImpl extends MofObjectImpl implements ProtocolTransition {
    ...
    private Constraint preCondition;
    ...
    private Constraint postCondition;
    private Collection<Operation> referred;
    ...
    @JoinColumn(name = "sourceId", table = "ProtocolTransition")
    ...
    @JoinColumn(name = "targetId", table = "ProtocolTransition")
    ...
    @JoinTable(name = "ProtocolTransition_elementImport",
        joinColumns = @JoinColumn(name = "ProtocolTransitionId"),
    ...
    @Column(name = "name", table = "ProtocolTransition")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "ConstraintMetaDef", metaColumn = @Column(name = "preConditionType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "preConditionId", table = "ProtocolTransition")
    ...
    public void setPreCondition(Constraint preCondition) {
    ...
    @JoinColumn(name = "nameExpressionId", table = "ProtocolTransition")
    ...
    @JoinTable(name = "ProtocolTransition_packageImport",
        joinColumns = @JoinColumn(name = "ProtocolTransitionId"),
    ...
    @JoinTable(name = "ProtocolTransition_ownedRule",
        joinColumns = @JoinColumn(name = "ProtocolTransitionId"),
    ...
    @JoinColumn(name = "redefinedTransitionId", table = "ProtocolTransition")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ProtocolTransition")
    ...
    @JoinColumn(name = "guardId", table = "ProtocolTransition")
    ...
    @JoinColumn(name = "effectId", table = "ProtocolTransition")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "ConstraintMetaDef", metaColumn = @Column(name = "postConditionType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "postConditionId", table = "ProtocolTransition")
    ...
    @JsonSetter
    @JsonDeserialize(using = MofObjectDeserializer.class, as = ConstraintImpl.class)
    public void setPostCondition(Constraint postCondition) {
    ...
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @Transient
    public Collection<Operation> getReferred() {
        if (referred == null) {
            referred = new ArrayList<>();
        }
        return referred;
    }
    ...
    public void setReferred(Collection<Operation> referred) {
    ...
    @JoinTable(name = "ProtocolTransition_trigger",
        joinColumns = @JoinColumn(name = "ProtocolTransitionId"),
    ...
    @JoinColumn(name = "containerId", table = "ProtocolTransition")
    ...
    @JoinTable(name = "ProtocolTransition_ownedComment",
        joinColumns = @JoinColumn(name = "ProtocolTransitionId"),
