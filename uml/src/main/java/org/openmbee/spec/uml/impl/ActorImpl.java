...
import org.openmbee.spec.uml.Actor;
...
@Entity
@SecondaryTable(name = "Actor")
@Table(appliesTo = "Actor", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Actor")
@JsonTypeName(value = "Actor")
public class ActorImpl extends MofObjectImpl implements Actor {
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "Actor")
    ...
    @JoinTable(name = "Actor_elementImport",
        joinColumns = @JoinColumn(name = "ActorId"),
    ...
    @JoinTable(name = "Actor_ownedBehavior",
        joinColumns = @JoinColumn(name = "ActorId"),
    ...
    @JoinColumn(name = "classifierBehaviorId", table = "Actor")
    ...
    @JoinTable(name = "Actor_substitution",
        joinColumns = @JoinColumn(name = "ActorId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "Actor")
    ...
    @JoinTable(name = "Actor_generalization",
        joinColumns = @JoinColumn(name = "ActorId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "Actor")
    ...
    @JoinTable(name = "Actor_interfaceRealization",
        joinColumns = @JoinColumn(name = "ActorId"),
    ...
    @JoinTable(name = "Actor_packageImport",
        joinColumns = @JoinColumn(name = "ActorId"),
    ...
    @JoinTable(name = "Actor_redefinedClassifier",
        joinColumns = @JoinColumn(name = "ActorId"),
    ...
    @JoinTable(name = "Actor_ownedRule",
        joinColumns = @JoinColumn(name = "ActorId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Actor")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "Actor")
    ...
    @JoinTable(name = "Actor_collaborationUse",
        joinColumns = @JoinColumn(name = "ActorId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Actor")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "Actor")
    ...
    @JoinTable(name = "Actor_ownedUseCase",
        joinColumns = @JoinColumn(name = "ActorId"),
    ...
    @JoinTable(name = "Actor_templateBinding",
        joinColumns = @JoinColumn(name = "ActorId"),
    ...
    @JoinColumn(name = "package_Id", table = "Actor")
    ...
    @JoinColumn(name = "representationId", table = "Actor")
    ...
    @JoinTable(name = "Actor_ownedComment",
        joinColumns = @JoinColumn(name = "ActorId"),
    ...
    @JoinTable(name = "Actor_powertypeExtent",
        joinColumns = @JoinColumn(name = "ActorId"),
