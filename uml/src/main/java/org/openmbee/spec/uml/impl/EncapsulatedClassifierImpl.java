...
import org.openmbee.spec.uml.EncapsulatedClassifier;
...
public abstract class EncapsulatedClassifierImpl extends MofObjectImpl implements
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "EncapsulatedClassifier")
    ...
    @JoinTable(name = "EncapsulatedClassifier_useCase",
        joinColumns = @JoinColumn(name = "EncapsulatedClassifierId"),
    ...
    @JoinTable(name = "EncapsulatedClassifier_elementImport",
        joinColumns = @JoinColumn(name = "EncapsulatedClassifierId"),
    ...
    @Column(name = "name", table = "EncapsulatedClassifier")
    ...
    @JoinTable(name = "EncapsulatedClassifier_substitution",
        joinColumns = @JoinColumn(name = "EncapsulatedClassifierId"),
    ...
    @JoinTable(name = "EncapsulatedClassifier_ownedConnector",
        joinColumns = @JoinColumn(name = "EncapsulatedClassifierId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "EncapsulatedClassifier")
    ...
    @JoinTable(name = "EncapsulatedClassifier_generalization",
        joinColumns = @JoinColumn(name = "EncapsulatedClassifierId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "EncapsulatedClassifier")
    ...
    @JoinTable(name = "EncapsulatedClassifier_packageImport",
        joinColumns = @JoinColumn(name = "EncapsulatedClassifierId"),
    ...
    @JoinTable(name = "EncapsulatedClassifier_redefinedClassifier",
        joinColumns = @JoinColumn(name = "EncapsulatedClassifierId"),
    ...
    @JoinTable(name = "EncapsulatedClassifier_ownedRule",
        joinColumns = @JoinColumn(name = "EncapsulatedClassifierId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "EncapsulatedClassifier")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "EncapsulatedClassifier")
    ...
    @JoinTable(name = "EncapsulatedClassifier_collaborationUse",
        joinColumns = @JoinColumn(name = "EncapsulatedClassifierId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "EncapsulatedClassifier")
    ...
    @JoinTable(name = "EncapsulatedClassifier_ownedAttribute",
        joinColumns = @JoinColumn(name = "EncapsulatedClassifierId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "EncapsulatedClassifier")
    ...
    @JoinTable(name = "EncapsulatedClassifier_ownedUseCase",
        joinColumns = @JoinColumn(name = "EncapsulatedClassifierId"),
    ...
    @JoinTable(name = "EncapsulatedClassifier_templateBinding",
        joinColumns = @JoinColumn(name = "EncapsulatedClassifierId"),
    ...
    @JoinColumn(name = "package_Id", table = "EncapsulatedClassifier")
    ...
    @JoinColumn(name = "representationId", table = "EncapsulatedClassifier")
    ...
    @JoinTable(name = "EncapsulatedClassifier_ownedComment",
        joinColumns = @JoinColumn(name = "EncapsulatedClassifierId"),
    ...
    @JoinTable(name = "EncapsulatedClassifier_powertypeExtent",
        joinColumns = @JoinColumn(name = "EncapsulatedClassifierId"),
