...
import org.openmbee.spec.uml.BehaviorExecutionSpecification;
...
@Entity
@SecondaryTable(name = "BehaviorExecutionSpecification")
@Table(appliesTo = "BehaviorExecutionSpecification", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "BehaviorExecutionSpecification")
@JsonTypeName(value = "BehaviorExecutionSpecification")
public class BehaviorExecutionSpecificationImpl extends MofObjectImpl implements
    ...
    @JoinColumn(name = "startId", table = "BehaviorExecutionSpecification")
    ...
    @JoinColumn(name = "behaviorId", table = "BehaviorExecutionSpecification")
    ...
    @JoinTable(name = "BehaviorExecutionSpecification_generalOrdering",
        joinColumns = @JoinColumn(name = "BehaviorExecutionSpecificationId"),
    ...
    @JoinColumn(name = "finishId", table = "BehaviorExecutionSpecification")
    ...
    @JoinColumn(name = "enclosingInteractionId", table = "BehaviorExecutionSpecification")
    ...
    @JoinColumn(name = "enclosingOperandId", table = "BehaviorExecutionSpecification")
    ...
    @JoinTable(name = "BehaviorExecutionSpecification_covered",
        joinColumns = @JoinColumn(name = "BehaviorExecutionSpecificationId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "BehaviorExecutionSpecification")
    ...
    @JoinColumn(name = "nameExpressionId", table = "BehaviorExecutionSpecification")
    ...
    @JoinTable(name = "BehaviorExecutionSpecification_ownedComment",
        joinColumns = @JoinColumn(name = "BehaviorExecutionSpecificationId"),
