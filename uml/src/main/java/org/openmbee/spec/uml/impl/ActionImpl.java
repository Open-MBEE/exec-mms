...
public abstract class ActionImpl extends MofObjectImpl implements Action {
    ...
    @JoinTable(name = "Action_inInterruptibleRegion",
    ...
    @JoinTable(name = "Action_localPrecondition",
        joinColumns = @JoinColumn(name = "ActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "Action")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "Action")
    ...
    @JoinColumn(name = "activityId", table = "Action")
    ...
    @JoinTable(name = "Action_localPostcondition",
        joinColumns = @JoinColumn(name = "ActionId"),
    ...
    @JoinTable(name = "Action_redefinedNode",
        joinColumns = @JoinColumn(name = "ActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "Action")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "Action")
    ...
    @JoinTable(name = "Action_outgoing",
        joinColumns = @JoinColumn(name = "ActionId"),
    ...
    @JoinTable(name = "Action_inPartition",
        joinColumns = @JoinColumn(name = "ActionId"),
    ...
    @JoinTable(name = "Action_incoming",
        joinColumns = @JoinColumn(name = "ActionId"),
    ...
    @JoinTable(name = "Action_ownedComment",
        joinColumns = @JoinColumn(name = "ActionId"),
