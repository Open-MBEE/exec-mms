...
import org.openmbee.spec.uml.RemoveVariableValueAction;
...
@Entity
@SecondaryTable(name = "RemoveVariableValueAction")
@Table(appliesTo = "RemoveVariableValueAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "RemoveVariableValueAction")
@JsonTypeName(value = "RemoveVariableValueAction")
public class RemoveVariableValueActionImpl extends MofObjectImpl implements
    ...
    @JoinTable(name = "RemoveVariableValueAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "RemoveVariableValueActionId"),
    ...
    @Column(name = "name", table = "RemoveVariableValueAction")
    ...
    @JoinTable(name = "RemoveVariableValueAction_localPrecondition",
        joinColumns = @JoinColumn(name = "RemoveVariableValueActionId"),
    ...
    @JoinColumn(name = "removeAtId", table = "RemoveVariableValueAction")
    ...
    @JoinColumn(name = "nameExpressionId", table = "RemoveVariableValueAction")
    ...
    @JoinColumn(name = "variableId", table = "RemoveVariableValueAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "RemoveVariableValueAction")
    ...
    @JoinColumn(name = "activityId", table = "RemoveVariableValueAction")
    ...
    @JoinTable(name = "RemoveVariableValueAction_localPostcondition",
        joinColumns = @JoinColumn(name = "RemoveVariableValueActionId"),
    ...
    @JoinTable(name = "RemoveVariableValueAction_redefinedNode",
        joinColumns = @JoinColumn(name = "RemoveVariableValueActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "RemoveVariableValueAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "RemoveVariableValueAction")
    ...
    @JoinTable(name = "RemoveVariableValueAction_handler",
        joinColumns = @JoinColumn(name = "RemoveVariableValueActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isRemoveDuplicates", table = "RemoveVariableValueAction")
    ...
    @JoinTable(name = "RemoveVariableValueAction_outgoing",
        joinColumns = @JoinColumn(name = "RemoveVariableValueActionId"),
    ...
    @JoinTable(name = "RemoveVariableValueAction_inPartition",
        joinColumns = @JoinColumn(name = "RemoveVariableValueActionId"),
    ...
    @JoinTable(name = "RemoveVariableValueAction_incoming",
        joinColumns = @JoinColumn(name = "RemoveVariableValueActionId"),
    ...
    @JoinColumn(name = "valueId", table = "RemoveVariableValueAction")
    ...
    @JoinTable(name = "RemoveVariableValueAction_ownedComment",
        joinColumns = @JoinColumn(name = "RemoveVariableValueActionId"),
