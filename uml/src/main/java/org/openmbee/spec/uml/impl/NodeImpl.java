...
@Entity
@SecondaryTable(name = "Node")
@Table(appliesTo = "Node", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Node")
@JsonTypeName(value = "Node")
public class NodeImpl extends MofObjectImpl implements Node {
    ...
    @JoinTable(name = "Node_elementImport",
    ...
    @JoinColumn(name = "nameExpressionId", table = "Node")
    ...
    @JoinTable(name = "Node_generalization",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JoinTable(name = "Node_packageImport",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JoinTable(name = "Node_ownedOperation",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JoinTable(name = "Node_nestedNode",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JoinTable(name = "Node_ownedAttribute",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JoinTable(name = "Node_templateBinding",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JoinTable(name = "Node_deployment",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JoinColumn(name = "representationId", table = "Node")
    ...
    @JoinTable(name = "Node_ownedReception",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "Node")
    ...
    @JoinTable(name = "Node_ownedBehavior",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JoinColumn(name = "classifierBehaviorId", table = "Node")
    ...
    @JoinTable(name = "Node_substitution",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JoinTable(name = "Node_ownedConnector",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "Node")
    ...
    @JoinTable(name = "Node_interfaceRealization",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JoinTable(name = "Node_redefinedClassifier",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Node")
    ...
    @JoinTable(name = "Node_collaborationUse",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Node")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "Node")
    ...
    @JoinTable(name = "Node_nestedClassifier",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JoinTable(name = "Node_ownedUseCase",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isActive", table = "Node")
    ...
    @JoinColumn(name = "package_Id", table = "Node")
    ...
    @JoinTable(name = "Node_ownedComment",
        joinColumns = @JoinColumn(name = "NodeId"),
    ...
    @JoinTable(name = "Node_powertypeExtent",
        joinColumns = @JoinColumn(name = "NodeId"),
