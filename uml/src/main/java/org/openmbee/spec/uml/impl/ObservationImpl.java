...
public abstract class ObservationImpl extends MofObjectImpl implements Observation {
    ...
    @Column(name = "name", table = "Observation")
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Observation")
    ...
    @JoinColumn(name = "templateParameterId", table = "Observation")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Observation")
    ...
    @JoinTable(name = "Observation_ownedComment",
