...
import org.openmbee.spec.uml.ExecutionOccurrenceSpecification;
import org.openmbee.spec.uml.ExecutionSpecification;
...
@Entity
@SecondaryTable(name = "ExecutionOccurrenceSpecification")
@Table(appliesTo = "ExecutionOccurrenceSpecification", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ExecutionOccurrenceSpecification")
@JsonTypeName(value = "ExecutionOccurrenceSpecification")
public class ExecutionOccurrenceSpecificationImpl extends MofObjectImpl implements
    ...
    @JoinTable(name = "ExecutionOccurrenceSpecification_generalOrdering",
        joinColumns = @JoinColumn(name = "ExecutionOccurrenceSpecificationId"),
    ...
    @JoinColumn(name = "enclosingInteractionId", table = "ExecutionOccurrenceSpecification")
    ...
    @JoinColumn(name = "enclosingOperandId", table = "ExecutionOccurrenceSpecification")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "ExecutionSpecificationMetaDef", metaColumn = @Column(name = "executionType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "executionId", table = "ExecutionOccurrenceSpecification")
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(using = MofObjectDeserializer.class, as = ExecutionSpecificationImpl.class)
    public void setExecution(ExecutionSpecification execution) {
    ...
    @JoinTable(name = "ExecutionOccurrenceSpecification_covered",
        joinColumns = @JoinColumn(name = "ExecutionOccurrenceSpecificationId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "ExecutionOccurrenceSpecification")
    ...
    @JoinTable(name = "ExecutionOccurrenceSpecification_toAfter",
        joinColumns = @JoinColumn(name = "ExecutionOccurrenceSpecificationId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ExecutionOccurrenceSpecification")
    ...
    @JoinTable(name = "ExecutionOccurrenceSpecification_toBefore",
        joinColumns = @JoinColumn(name = "ExecutionOccurrenceSpecificationId"),
    ...
    @JoinTable(name = "ExecutionOccurrenceSpecification_ownedComment",
        joinColumns = @JoinColumn(name = "ExecutionOccurrenceSpecificationId"),
