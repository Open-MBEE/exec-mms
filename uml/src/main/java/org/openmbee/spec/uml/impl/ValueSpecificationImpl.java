...
public abstract class ValueSpecificationImpl extends MofObjectImpl implements ValueSpecification {
    ...
    @Column(name = "name", table = "ValueSpecification")
    ...
    @JoinColumn(name = "typeId", table = "ValueSpecification")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "ValueSpecification")
    ...
    @JoinColumn(name = "templateParameterId", table = "ValueSpecification")
    ...
    @JoinColumn(name = "nameExpressionId", table = "ValueSpecification")
    ...
    @JoinTable(name = "ValueSpecification_ownedComment",
        joinColumns = @JoinColumn(name = "ValueSpecificationId"),
