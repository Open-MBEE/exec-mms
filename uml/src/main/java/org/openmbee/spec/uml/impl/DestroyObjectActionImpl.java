...
import org.openmbee.spec.uml.DestroyObjectAction;
...
@Entity
@SecondaryTable(name = "DestroyObjectAction")
@Table(appliesTo = "DestroyObjectAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "DestroyObjectAction")
@JsonTypeName(value = "DestroyObjectAction")
public class DestroyObjectActionImpl extends MofObjectImpl implements DestroyObjectAction {
    ...
    @JoinTable(name = "DestroyObjectAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "DestroyObjectActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isDestroyOwnedObjects", table = "DestroyObjectAction")
    ...
    @JsonProperty(required = true)
    @JsonSetter
    public void setDestroyOwnedObjects(Boolean isDestroyOwnedObjects) {
    ...
    @Column(name = "name", table = "DestroyObjectAction")
    ...
    @JoinTable(name = "DestroyObjectAction_localPrecondition",
        joinColumns = @JoinColumn(name = "DestroyObjectActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "DestroyObjectAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "DestroyObjectAction")
    ...
    @JoinColumn(name = "activityId", table = "DestroyObjectAction")
    ...
    @JoinTable(name = "DestroyObjectAction_localPostcondition",
        joinColumns = @JoinColumn(name = "DestroyObjectActionId"),
    ...
    @JoinTable(name = "DestroyObjectAction_redefinedNode",
        joinColumns = @JoinColumn(name = "DestroyObjectActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "DestroyObjectAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "DestroyObjectAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isDestroyLinks", table = "DestroyObjectAction")
    ...
    @JsonProperty(required = true)
    @JsonSetter
    public void setDestroyLinks(Boolean isDestroyLinks) {
    ...
    @JoinTable(name = "DestroyObjectAction_handler",
        joinColumns = @JoinColumn(name = "DestroyObjectActionId"),
    ...
    @JoinTable(name = "DestroyObjectAction_outgoing",
        joinColumns = @JoinColumn(name = "DestroyObjectActionId"),
    ...
    @JoinTable(name = "DestroyObjectAction_inPartition",
        joinColumns = @JoinColumn(name = "DestroyObjectActionId"),
    ...
    @JoinTable(name = "DestroyObjectAction_incoming",
        joinColumns = @JoinColumn(name = "DestroyObjectActionId"),
    ...
    @JoinTable(name = "DestroyObjectAction_ownedComment",
        joinColumns = @JoinColumn(name = "DestroyObjectActionId"),
    ...
    @JoinColumn(name = "targetId", table = "DestroyObjectAction")
