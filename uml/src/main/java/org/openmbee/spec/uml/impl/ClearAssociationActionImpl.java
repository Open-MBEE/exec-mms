...
import org.openmbee.spec.uml.ClearAssociationAction;
...
@Entity
@SecondaryTable(name = "ClearAssociationAction")
@Table(appliesTo = "ClearAssociationAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ClearAssociationAction")
@JsonTypeName(value = "ClearAssociationAction")
public class ClearAssociationActionImpl extends MofObjectImpl implements ClearAssociationAction {
    ...
    @JoinTable(name = "ClearAssociationAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ClearAssociationActionId"),
    ...
    @Column(name = "name", table = "ClearAssociationAction")
    ...
    @JoinColumn(name = "associationId", table = "ClearAssociationAction")
    ...
    @JoinTable(name = "ClearAssociationAction_localPrecondition",
        joinColumns = @JoinColumn(name = "ClearAssociationActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ClearAssociationAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ClearAssociationAction")
    ...
    @JoinColumn(name = "activityId", table = "ClearAssociationAction")
    ...
    @JoinTable(name = "ClearAssociationAction_localPostcondition",
        joinColumns = @JoinColumn(name = "ClearAssociationActionId"),
    ...
    @JoinTable(name = "ClearAssociationAction_redefinedNode",
        joinColumns = @JoinColumn(name = "ClearAssociationActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ClearAssociationAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "ClearAssociationAction")
    ...
    @JoinTable(name = "ClearAssociationAction_handler",
        joinColumns = @JoinColumn(name = "ClearAssociationActionId"),
    ...
    @JoinTable(name = "ClearAssociationAction_outgoing",
        joinColumns = @JoinColumn(name = "ClearAssociationActionId"),
    ...
    @JoinTable(name = "ClearAssociationAction_inPartition",
        joinColumns = @JoinColumn(name = "ClearAssociationActionId"),
    ...
    @JoinTable(name = "ClearAssociationAction_incoming",
        joinColumns = @JoinColumn(name = "ClearAssociationActionId"),
    ...
    @JoinColumn(name = "objectId", table = "ClearAssociationAction")
    ...
    @JoinTable(name = "ClearAssociationAction_ownedComment",
        joinColumns = @JoinColumn(name = "ClearAssociationActionId"),
