...
import org.openmbee.spec.uml.TypedElement;
...
public abstract class TypedElementImpl extends MofObjectImpl implements TypedElement {
    ...
    @Column(name = "name", table = "TypedElement")
    ...
    @JoinColumn(name = "typeId", table = "TypedElement")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "nameExpressionId", table = "TypedElement")
    ...
    @JoinTable(name = "TypedElement_ownedComment",
        joinColumns = @JoinColumn(name = "TypedElementId"),
