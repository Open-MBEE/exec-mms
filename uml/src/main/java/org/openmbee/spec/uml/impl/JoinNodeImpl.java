...
import org.openmbee.spec.uml.JoinNode;
...
@Table(appliesTo = "JoinNode", fetch = FetchMode.SELECT, optional = false)
...
public class JoinNodeImpl extends MofObjectImpl implements JoinNode {
    ...
    private ValueSpecification joinSpec;
    ...
    @JoinTable(name = "JoinNode_redefinedNode",
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "JoinNode")
    ...
    @JoinTable(name = "JoinNode_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "JoinNodeId"),
    ...
    @JoinTable(name = "JoinNode_outgoing",
        joinColumns = @JoinColumn(name = "JoinNodeId"),
    ...
    @JoinTable(name = "JoinNode_inPartition",
        joinColumns = @JoinColumn(name = "JoinNodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isCombineDuplicate", table = "JoinNode")
    ...
    @JsonProperty(required = true)
    @JsonSetter
    public void setCombineDuplicate(Boolean isCombineDuplicate) {
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "JoinNode")
    ...
    @JoinTable(name = "JoinNode_incoming",
        joinColumns = @JoinColumn(name = "JoinNodeId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "JoinNode")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "ValueSpecificationMetaDef", metaColumn = @Column(name = "joinSpecType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "joinSpecId", table = "JoinNode")
    ...
    public void setJoinSpec(ValueSpecification joinSpec) {
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "JoinNode")
    ...
    @JoinTable(name = "JoinNode_ownedComment",
        joinColumns = @JoinColumn(name = "JoinNodeId"),
    ...
    @JoinColumn(name = "activityId", table = "JoinNode")
