...
import org.openmbee.spec.uml.Collaboration;
...
@Entity
@SecondaryTable(name = "Collaboration")
@Table(appliesTo = "Collaboration", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Collaboration")
@JsonTypeName(value = "Collaboration")
public class CollaborationImpl extends MofObjectImpl implements Collaboration {
    ...
    private Collection<ConnectableElement> collaborationRole;
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "Collaboration")
    ...
    @JoinTable(name = "Collaboration_useCase",
    ...
    @JoinTable(name = "Collaboration_elementImport",
        joinColumns = @JoinColumn(name = "CollaborationId"),
    ...
    @Column(name = "name", table = "Collaboration")
    ...
    @JoinTable(name = "Collaboration_ownedBehavior",
        joinColumns = @JoinColumn(name = "CollaborationId"),
    ...
    @JoinColumn(name = "classifierBehaviorId", table = "Collaboration")
    ...
    @JoinTable(name = "Collaboration_substitution",
        joinColumns = @JoinColumn(name = "CollaborationId"),
    ...
    @JoinTable(name = "Collaboration_ownedConnector",
        joinColumns = @JoinColumn(name = "CollaborationId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "Collaboration")
    ...
    @JoinTable(name = "Collaboration_generalization",
        joinColumns = @JoinColumn(name = "CollaborationId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "Collaboration")
    ...
    @JoinTable(name = "Collaboration_interfaceRealization",
        joinColumns = @JoinColumn(name = "CollaborationId"),
    ...
    @JoinTable(name = "Collaboration_packageImport",
        joinColumns = @JoinColumn(name = "CollaborationId"),
    ...
    @JoinTable(name = "Collaboration_redefinedClassifier",
        joinColumns = @JoinColumn(name = "CollaborationId"),
    ...
    @JoinTable(name = "Collaboration_ownedRule",
        joinColumns = @JoinColumn(name = "CollaborationId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Collaboration")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "Collaboration")
    ...
    @JoinTable(name = "Collaboration_collaborationUse",
        joinColumns = @JoinColumn(name = "CollaborationId"),
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "ConnectableElementMetaDef", metaColumn = @Column(name = "collaborationRoleType"), fetch = FetchType.LAZY)
    @JoinTable(name = "Collaboration_collaborationRole",
        joinColumns = @JoinColumn(name = "CollaborationId"),
        inverseJoinColumns = @JoinColumn(name = "collaborationRoleId"))
    public Collection<ConnectableElement> getCollaborationRole() {
        if (collaborationRole == null) {
            collaborationRole = new ArrayList<>();
        }
    ...
    public void setCollaborationRole(Collection<ConnectableElement> collaborationRole) {
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Collaboration")
    ...
    @JoinTable(name = "Collaboration_ownedAttribute",
        joinColumns = @JoinColumn(name = "CollaborationId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "Collaboration")
    ...
    @JoinTable(name = "Collaboration_ownedUseCase",
        joinColumns = @JoinColumn(name = "CollaborationId"),
    ...
    @JoinTable(name = "Collaboration_templateBinding",
        joinColumns = @JoinColumn(name = "CollaborationId"),
    ...
    @JoinColumn(name = "package_Id", table = "Collaboration")
    ...
    @JoinColumn(name = "representationId", table = "Collaboration")
    ...
    @JoinTable(name = "Collaboration_ownedComment",
        joinColumns = @JoinColumn(name = "CollaborationId"),
    ...
    @JoinTable(name = "Collaboration_powertypeExtent",
        joinColumns = @JoinColumn(name = "CollaborationId"),
