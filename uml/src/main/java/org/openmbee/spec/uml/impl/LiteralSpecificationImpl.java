...
import org.openmbee.spec.uml.LiteralSpecification;
...
public abstract class LiteralSpecificationImpl extends MofObjectImpl implements
    ...
    @Column(name = "name", table = "LiteralSpecification")
    ...
    @JoinColumn(name = "typeId", table = "LiteralSpecification")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "LiteralSpecification")
    ...
    @JoinColumn(name = "templateParameterId", table = "LiteralSpecification")
    ...
    @JoinColumn(name = "nameExpressionId", table = "LiteralSpecification")
    ...
    @JoinTable(name = "LiteralSpecification_ownedComment",
        joinColumns = @JoinColumn(name = "LiteralSpecificationId"),
