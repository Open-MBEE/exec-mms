...
import org.openmbee.spec.uml.DirectedRelationship;
...
public abstract class DirectedRelationshipImpl extends MofObjectImpl implements
    ...
    @JoinTable(name = "DirectedRelationship_ownedComment",
        joinColumns = @JoinColumn(name = "DirectedRelationshipId"),
