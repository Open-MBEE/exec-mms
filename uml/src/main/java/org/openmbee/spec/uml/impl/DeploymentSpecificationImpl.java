...
import org.openmbee.spec.uml.Artifact;
...
import org.openmbee.spec.uml.DeploymentSpecification;
...
import org.openmbee.spec.uml.Manifestation;
...
@Entity
@SecondaryTable(name = "DeploymentSpecification")
@Table(appliesTo = "DeploymentSpecification", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "DeploymentSpecification")
@JsonTypeName(value = "DeploymentSpecification")
public class DeploymentSpecificationImpl extends MofObjectImpl implements DeploymentSpecification {
    ...
    private Collection<Manifestation> manifestation;
    ...
    private Collection<Artifact> nestedArtifact;
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "DeploymentSpecification")
    ...
    @JoinTable(name = "DeploymentSpecification_useCase",
        joinColumns = @JoinColumn(name = "DeploymentSpecificationId"),
    ...
    @JoinTable(name = "DeploymentSpecification_elementImport",
        joinColumns = @JoinColumn(name = "DeploymentSpecificationId"),
    ...
    @Column(name = "name", table = "DeploymentSpecification")
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "ManifestationMetaDef", metaColumn = @Column(name = "manifestationType"), fetch = FetchType.LAZY)
    @JoinTable(name = "DeploymentSpecification_manifestation",
        joinColumns = @JoinColumn(name = "DeploymentSpecificationId"),
        inverseJoinColumns = @JoinColumn(name = "manifestationId"))
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(contentUsing = MofObjectDeserializer.class, contentAs = ManifestationImpl.class)
    ...
    @JoinTable(name = "DeploymentSpecification_ownedOperation",
        joinColumns = @JoinColumn(name = "DeploymentSpecificationId"),
    ...
    @JoinTable(name = "DeploymentSpecification_substitution",
        joinColumns = @JoinColumn(name = "DeploymentSpecificationId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "DeploymentSpecification")
    ...
    @JoinTable(name = "DeploymentSpecification_generalization",
        joinColumns = @JoinColumn(name = "DeploymentSpecificationId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "DeploymentSpecification")
    ...
    @JoinTable(name = "DeploymentSpecification_packageImport",
        joinColumns = @JoinColumn(name = "DeploymentSpecificationId"),
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "DeploymentMetaDef", metaColumn = @Column(name = "deploymentType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "deploymentId", table = "DeploymentSpecification")
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(using = MofObjectDeserializer.class, as = DeploymentImpl.class)
    ...
    @JoinTable(name = "DeploymentSpecification_redefinedClassifier",
        joinColumns = @JoinColumn(name = "DeploymentSpecificationId"),
    ...
    @JoinTable(name = "DeploymentSpecification_ownedRule",
        joinColumns = @JoinColumn(name = "DeploymentSpecificationId"),
    ...
    @JoinTable(name = "DeploymentSpecification_ownedAttribute",
        joinColumns = @JoinColumn(name = "DeploymentSpecificationId"),
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "ArtifactMetaDef", metaColumn = @Column(name = "nestedArtifactType"), fetch = FetchType.LAZY)
    @JoinTable(name = "DeploymentSpecification_nestedArtifact",
        joinColumns = @JoinColumn(name = "DeploymentSpecificationId"),
        inverseJoinColumns = @JoinColumn(name = "nestedArtifactId"))
    public Collection<Artifact> getNestedArtifact() {
        if (nestedArtifact == null) {
            nestedArtifact = new ArrayList<>();
        }
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(contentUsing = MofObjectDeserializer.class, contentAs = ArtifactImpl.class)
    public void setNestedArtifact(Collection<Artifact> nestedArtifact) {
        this.nestedArtifact = nestedArtifact;
    }
    ...
    @JoinColumn(name = "templateParameterId", table = "DeploymentSpecification")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "DeploymentSpecification")
    ...
    @JoinTable(name = "DeploymentSpecification_collaborationUse",
        joinColumns = @JoinColumn(name = "DeploymentSpecificationId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "DeploymentSpecification")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "fileName", table = "DeploymentSpecification")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "DeploymentSpecification")
    ...
    @JoinTable(name = "DeploymentSpecification_ownedUseCase",
        joinColumns = @JoinColumn(name = "DeploymentSpecificationId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "deploymentLocation", table = "DeploymentSpecification")
    ...
    @JoinTable(name = "DeploymentSpecification_templateBinding",
        joinColumns = @JoinColumn(name = "DeploymentSpecificationId"),
    ...
    @JoinColumn(name = "package_Id", table = "DeploymentSpecification")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "executionLocation", table = "DeploymentSpecification")
    ...
    @JoinColumn(name = "representationId", table = "DeploymentSpecification")
    ...
    @JoinTable(name = "DeploymentSpecification_ownedComment",
        joinColumns = @JoinColumn(name = "DeploymentSpecificationId"),
    ...
    @JoinTable(name = "DeploymentSpecification_powertypeExtent",
        joinColumns = @JoinColumn(name = "DeploymentSpecificationId"),
