...
@Entity
@SecondaryTable(name = "ExtensionPoint")
@Table(appliesTo = "ExtensionPoint", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ExtensionPoint")
@JsonTypeName(value = "ExtensionPoint")
public class ExtensionPointImpl extends MofObjectImpl implements ExtensionPoint {
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ExtensionPoint")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "ExtensionPoint")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "UseCaseMetaDef", metaColumn = @Column(name = "useCaseType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "useCaseId", table = "ExtensionPoint")
    ...
    @JoinColumn(name = "nameExpressionId", table = "ExtensionPoint")
    ...
    @JoinTable(name = "ExtensionPoint_ownedComment",
        joinColumns = @JoinColumn(name = "ExtensionPointId"),
