...
import org.openmbee.spec.uml.AnyReceiveEvent;
...
@Entity
@SecondaryTable(name = "AnyReceiveEvent")
@Table(appliesTo = "AnyReceiveEvent", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "AnyReceiveEvent")
@JsonTypeName(value = "AnyReceiveEvent")
public class AnyReceiveEventImpl extends MofObjectImpl implements AnyReceiveEvent {
    ...
    @Column(name = "name", table = "AnyReceiveEvent")
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "AnyReceiveEvent")
    ...
    @JoinColumn(name = "templateParameterId", table = "AnyReceiveEvent")
    ...
    @JoinColumn(name = "nameExpressionId", table = "AnyReceiveEvent")
    ...
    @JoinTable(name = "AnyReceiveEvent_ownedComment",
        joinColumns = @JoinColumn(name = "AnyReceiveEventId"),
