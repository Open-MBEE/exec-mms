...
import org.openmbee.spec.uml.DurationConstraint;
import org.openmbee.spec.uml.DurationInterval;
...
@Entity
@SecondaryTable(name = "DurationConstraint")
@Table(appliesTo = "DurationConstraint", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "DurationConstraint")
@JsonTypeName(value = "DurationConstraint")
public class DurationConstraintImpl extends MofObjectImpl implements DurationConstraint {
    ...
    private DurationInterval specification;
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "DurationConstraint")
    ...
    @JoinColumn(name = "contextId", table = "DurationConstraint")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "DurationConstraint")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "DurationIntervalMetaDef", metaColumn = @Column(name = "specificationType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "specificationId", table = "DurationConstraint")
    public DurationInterval getSpecification() {
        return specification;
    }

    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(using = MofObjectDeserializer.class, as = DurationIntervalImpl.class)
    public void setSpecification(DurationInterval specification) {
    ...
    @JoinColumn(name = "templateParameterId", table = "DurationConstraint")
    ...
    @JoinColumn(name = "nameExpressionId", table = "DurationConstraint")
    ...
    @JoinTable(name = "DurationConstraint_constrainedElement",
        joinColumns = @JoinColumn(name = "DurationConstraintId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "firstEvent", table = "DurationConstraint")
    ...
    @JoinTable(name = "DurationConstraint_ownedComment",
        joinColumns = @JoinColumn(name = "DurationConstraintId"),
