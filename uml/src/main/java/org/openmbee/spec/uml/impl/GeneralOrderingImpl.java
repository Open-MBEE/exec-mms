...
@Entity
@SecondaryTable(name = "GeneralOrdering")
@Table(appliesTo = "GeneralOrdering", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "GeneralOrdering")
@JsonTypeName(value = "GeneralOrdering")
public class GeneralOrderingImpl extends MofObjectImpl implements GeneralOrdering {

    private Element owner;
    private String name;
    private OccurrenceSpecification before;
    private VisibilityKind visibility;
    private Namespace namespace;
    private Collection<Element> ownedElement;
    private OccurrenceSpecification after;
    ...
    @Column(name = "name", table = "GeneralOrdering")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "OccurrenceSpecificationMetaDef", metaColumn = @Column(name = "beforeType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "beforeId", table = "GeneralOrdering")
    ...
    public void setBefore(OccurrenceSpecification before) {
        this.before = before;
    }
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "OccurrenceSpecificationMetaDef", metaColumn = @Column(name = "afterType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "afterId", table = "GeneralOrdering")
    ...
    @JsonSetter
    @JsonDeserialize(using = MofObjectDeserializer.class, as = OccurrenceSpecificationImpl.class)
    public void setAfter(OccurrenceSpecification after) {
        this.after = after;
    }
    ...
    @JoinColumn(name = "nameExpressionId", table = "GeneralOrdering")
    ...
    @JoinTable(name = "GeneralOrdering_ownedComment",
        joinColumns = @JoinColumn(name = "GeneralOrderingId"),
