...
import org.openmbee.spec.uml.ControlFlow;
...
@Entity
@SecondaryTable(name = "ControlFlow")
@Table(appliesTo = "ControlFlow", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ControlFlow")
@JsonTypeName(value = "ControlFlow")
public class ControlFlowImpl extends MofObjectImpl implements ControlFlow {
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ControlFlow")
    ...
    @JoinColumn(name = "sourceId", table = "ControlFlow")
    ...
    @JoinColumn(name = "guardId", table = "ControlFlow")
    ...
    @JoinColumn(name = "targetId", table = "ControlFlow")
    ...
    @JoinTable(name = "ControlFlow_redefinedEdge",
        joinColumns = @JoinColumn(name = "ControlFlowId"),
    ...
    @JoinColumn(name = "interruptsId", table = "ControlFlow")
    ...
    @JoinTable(name = "ControlFlow_inPartition",
        joinColumns = @JoinColumn(name = "ControlFlowId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "ControlFlow")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ControlFlow")
    ...
    @JoinColumn(name = "nameExpressionId", table = "ControlFlow")
    ...
    @JoinColumn(name = "weightId", table = "ControlFlow")
    ...
    @JoinColumn(name = "activityId", table = "ControlFlow")
    ...
    @JoinTable(name = "ControlFlow_ownedComment",
        joinColumns = @JoinColumn(name = "ControlFlowId"),
