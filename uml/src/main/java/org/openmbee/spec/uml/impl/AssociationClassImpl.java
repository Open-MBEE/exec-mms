...
import org.openmbee.spec.uml.AssociationClass;
...
@Entity
@SecondaryTable(name = "AssociationClass")
@Table(appliesTo = "AssociationClass", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "AssociationClass")
@JsonTypeName(value = "AssociationClass")
public class AssociationClassImpl extends MofObjectImpl implements AssociationClass {
    ...
    @JoinTable(name = "AssociationClass_elementImport",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinTable(name = "AssociationClass_memberEnd",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @Column(name = "name", table = "AssociationClass")
    ...
    @JoinColumn(name = "nameExpressionId", table = "AssociationClass")
    ...
    @JoinTable(name = "AssociationClass_generalization",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinTable(name = "AssociationClass_packageImport",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinTable(name = "AssociationClass_ownedEnd",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinTable(name = "AssociationClass_ownedOperation",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "AssociationClass")
    ...
    @JoinTable(name = "AssociationClass_ownedAttribute",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinTable(name = "AssociationClass_templateBinding",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinColumn(name = "representationId", table = "AssociationClass")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isDerived", table = "AssociationClass")
    ...
    @JoinTable(name = "AssociationClass_ownedReception",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "AssociationClass")
    ...
    @JoinTable(name = "AssociationClass_useCase",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinTable(name = "AssociationClass_ownedBehavior",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinColumn(name = "classifierBehaviorId", table = "AssociationClass")
    ...
    @JoinTable(name = "AssociationClass_substitution",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinTable(name = "AssociationClass_ownedConnector",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "AssociationClass")
    ...
    @JoinTable(name = "AssociationClass_interfaceRealization",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinTable(name = "AssociationClass_redefinedClassifier",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinTable(name = "AssociationClass_ownedRule",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinTable(name = "AssociationClass_navigableOwnedEnd",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "AssociationClass")
    ...
    @JoinTable(name = "AssociationClass_collaborationUse",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "AssociationClass")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "AssociationClass")
    ...
    @JoinTable(name = "AssociationClass_nestedClassifier",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinTable(name = "AssociationClass_ownedUseCase",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isActive", table = "AssociationClass")
    ...
    @JoinColumn(name = "package_Id", table = "AssociationClass")
    ...
    @JoinTable(name = "AssociationClass_ownedComment",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
    ...
    @JoinTable(name = "AssociationClass_powertypeExtent",
        joinColumns = @JoinColumn(name = "AssociationClassId"),
