...
import org.openmbee.spec.uml.LiteralUnlimitedNatural;
...
@Entity
@SecondaryTable(name = "LiteralUnlimitedNatural")
@Table(appliesTo = "LiteralUnlimitedNatural", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "LiteralUnlimitedNatural")
@JsonTypeName(value = "LiteralUnlimitedNatural")
public class LiteralUnlimitedNaturalImpl extends MofObjectImpl implements LiteralUnlimitedNatural {
    ...
    @JoinColumn(name = "typeId", table = "LiteralUnlimitedNatural")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "LiteralUnlimitedNatural")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "LiteralUnlimitedNatural")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "value", table = "LiteralUnlimitedNatural")
    ...
    @JoinColumn(name = "templateParameterId", table = "LiteralUnlimitedNatural")
    ...
    @JoinColumn(name = "nameExpressionId", table = "LiteralUnlimitedNatural")
    ...
    @JoinTable(name = "LiteralUnlimitedNatural_ownedComment",
        joinColumns = @JoinColumn(name = "LiteralUnlimitedNaturalId"),
