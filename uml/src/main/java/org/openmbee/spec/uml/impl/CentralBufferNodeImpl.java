...
import org.openmbee.spec.uml.CentralBufferNode;
...
@Entity
@SecondaryTable(name = "CentralBufferNode")
@Table(appliesTo = "CentralBufferNode", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "CentralBufferNode")
@JsonTypeName(value = "CentralBufferNode")
public class CentralBufferNodeImpl extends MofObjectImpl implements CentralBufferNode {
    ...
    @JoinTable(name = "CentralBufferNode_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "CentralBufferNodeId"),
    ...
    @JoinColumn(name = "upperBoundId", table = "CentralBufferNode")
    ...
    @JoinColumn(name = "typeId", table = "CentralBufferNode")
    public Type getType() {
        return type;
    }
    ...
    @JoinTable(name = "CentralBufferNode_inState",
        joinColumns = @JoinColumn(name = "CentralBufferNodeId"),
    ...
    @Column(name = "name", table = "CentralBufferNode")
    ...
    @JoinColumn(name = "nameExpressionId", table = "CentralBufferNode")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "CentralBufferNode")
    ...
    @JoinColumn(name = "activityId", table = "CentralBufferNode")
    ...
    @JoinTable(name = "CentralBufferNode_redefinedNode",
        joinColumns = @JoinColumn(name = "CentralBufferNodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "CentralBufferNode")
    ...
    @JoinTable(name = "CentralBufferNode_outgoing",
        joinColumns = @JoinColumn(name = "CentralBufferNodeId"),
    ...
    @JoinColumn(name = "selectionId", table = "CentralBufferNode")
    ...
    @JoinTable(name = "CentralBufferNode_inPartition",
        joinColumns = @JoinColumn(name = "CentralBufferNodeId"),
    ...
    @JoinTable(name = "CentralBufferNode_incoming",
        joinColumns = @JoinColumn(name = "CentralBufferNodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isControlType", table = "CentralBufferNode")
    ...
    @JoinTable(name = "CentralBufferNode_ownedComment",
        joinColumns = @JoinColumn(name = "CentralBufferNodeId"),
