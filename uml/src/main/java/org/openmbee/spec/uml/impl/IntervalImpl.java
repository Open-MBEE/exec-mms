...
import org.openmbee.spec.uml.Interval;
...
@Entity
@SecondaryTable(name = "Interval")
@Table(appliesTo = "Interval", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Interval")
@JsonTypeName(value = "Interval")
public class IntervalImpl extends MofObjectImpl implements Interval {
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "ValueSpecificationMetaDef", metaColumn = @Column(name = "minType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "minId", table = "Interval")
    ...
    public void setMin(ValueSpecification min) {
        this.min = min;
    }
    ...
    @JoinColumn(name = "typeId", table = "Interval")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Interval")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "ValueSpecificationMetaDef", metaColumn = @Column(name = "maxType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "maxId", table = "Interval")
    ...
    @JsonSetter
    @JsonDeserialize(using = MofObjectDeserializer.class, as = ValueSpecificationImpl.class)
    public void setMax(ValueSpecification max) {
        this.max = max;
    }
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "Interval")
    ...
    @JoinColumn(name = "templateParameterId", table = "Interval")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Interval")
    ...
    @JoinTable(name = "Interval_ownedComment",
        joinColumns = @JoinColumn(name = "IntervalId"),
