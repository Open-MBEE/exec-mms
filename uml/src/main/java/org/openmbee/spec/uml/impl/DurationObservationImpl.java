...
import org.openmbee.spec.uml.DurationObservation;
...
@Entity
@SecondaryTable(name = "DurationObservation")
@Table(appliesTo = "DurationObservation", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "DurationObservation")
@JsonTypeName(value = "DurationObservation")
public class DurationObservationImpl extends MofObjectImpl implements DurationObservation {
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "DurationObservation")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "DurationObservation")
    ...
    @JoinColumn(name = "eventId", table = "DurationObservation")
    ...
    @JoinColumn(name = "templateParameterId", table = "DurationObservation")
    ...
    @JoinColumn(name = "nameExpressionId", table = "DurationObservation")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "firstEvent", table = "DurationObservation")
    ...
    @JoinTable(name = "DurationObservation_ownedComment",
        joinColumns = @JoinColumn(name = "DurationObservationId"),
