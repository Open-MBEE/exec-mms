...
@Table(appliesTo = "Package", fetch = FetchMode.SELECT, optional = false)
...
public class PackageImpl extends MofObjectImpl implements Package {
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "Package")
    ...
    @JoinTable(name = "Package_profileApplication",
    ...
    @JoinTable(name = "Package_packageMerge",
        joinColumns = @JoinColumn(name = "PackageId"),
    ...
    @JoinTable(name = "Package_elementImport",
        joinColumns = @JoinColumn(name = "PackageId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "Package")
    ...
    @JoinColumn(name = "templateParameterId", table = "Package")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Package")
    ...
    @JoinTable(name = "Package_packageImport",
        joinColumns = @JoinColumn(name = "PackageId"),
    ...
    @JoinTable(name = "Package_ownedRule",
        joinColumns = @JoinColumn(name = "PackageId"),
    ...
    @JoinColumn(name = "nestingPackageId", table = "Package")
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Package")
    ...
    @JoinTable(name = "Package_packagedElement",
        joinColumns = @JoinColumn(name = "PackageId"),
    ...
    @JoinTable(name = "Package_templateBinding",
        joinColumns = @JoinColumn(name = "PackageId"),
    ...
    @JoinTable(name = "Package_ownedComment",
        joinColumns = @JoinColumn(name = "PackageId"),
