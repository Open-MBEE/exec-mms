...
public abstract class BehavioralFeatureImpl extends MofObjectImpl implements BehavioralFeature {
    ...
    @JoinTable(name = "BehavioralFeature_method",
        joinColumns = @JoinColumn(name = "BehavioralFeatureId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isStatic", table = "BehavioralFeature")
    ...
    @JoinTable(name = "BehavioralFeature_elementImport",
        joinColumns = @JoinColumn(name = "BehavioralFeatureId"),
    ...
    @Column(name = "name", table = "BehavioralFeature")
    ...
    @JoinColumn(name = "nameExpressionId", table = "BehavioralFeature")
    ...
    @JoinTable(name = "BehavioralFeature_packageImport",
        joinColumns = @JoinColumn(name = "BehavioralFeatureId"),
    ...
    @JoinTable(name = "BehavioralFeature_ownedParameterSet",
        joinColumns = @JoinColumn(name = "BehavioralFeatureId"),
    ...
    @JoinTable(name = "BehavioralFeature_raisedException",
        joinColumns = @JoinColumn(name = "BehavioralFeatureId"),
    ...
    @JoinTable(name = "BehavioralFeature_ownedRule",
        joinColumns = @JoinColumn(name = "BehavioralFeatureId"),
    ...
    @JoinTable(name = "BehavioralFeature_ownedParameter",
        joinColumns = @JoinColumn(name = "BehavioralFeatureId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "BehavioralFeature")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "BehavioralFeature")
    ...
    @JoinTable(name = "BehavioralFeature_ownedComment",
        joinColumns = @JoinColumn(name = "BehavioralFeatureId"),
