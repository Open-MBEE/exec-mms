...
import org.openmbee.spec.uml.TimeInterval;
...
@Entity
@SecondaryTable(name = "TimeInterval")
@Table(appliesTo = "TimeInterval", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "TimeInterval")
@JsonTypeName(value = "TimeInterval")
public class TimeIntervalImpl extends MofObjectImpl implements TimeInterval {

    private Element owner;
    private TimeExpression min;
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "TimeExpressionMetaDef", metaColumn = @Column(name = "minType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "minId", table = "TimeInterval")
    ...
    public void setMin(TimeExpression min) {
        this.min = min;
    }
    ...
    @JoinColumn(name = "typeId", table = "TimeInterval")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "TimeInterval")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "TimeInterval")
    ...
    @JoinColumn(name = "templateParameterId", table = "TimeInterval")
    ...
    @JoinColumn(name = "nameExpressionId", table = "TimeInterval")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "TimeExpressionMetaDef", metaColumn = @Column(name = "maxType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "maxId", table = "TimeInterval")
    ...
    @JsonSetter
    @JsonDeserialize(using = MofObjectDeserializer.class, as = TimeExpressionImpl.class)
    public void setMax(TimeExpression max) {
        this.max = max;
    }
    ...
    @JoinTable(name = "TimeInterval_ownedComment",
        joinColumns = @JoinColumn(name = "TimeIntervalId"),
