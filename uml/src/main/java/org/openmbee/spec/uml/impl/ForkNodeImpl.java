...
import org.openmbee.spec.uml.ForkNode;
...
@Table(appliesTo = "ForkNode", fetch = FetchMode.SELECT, optional = false)
...
public class ForkNodeImpl extends MofObjectImpl implements ForkNode {
    ...
    @JoinTable(name = "ForkNode_redefinedNode",
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ForkNode")
    ...
    @JoinTable(name = "ForkNode_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ForkNodeId"),
    ...
    @JoinTable(name = "ForkNode_outgoing",
        joinColumns = @JoinColumn(name = "ForkNodeId"),
    ...
    @JoinTable(name = "ForkNode_inPartition",
        joinColumns = @JoinColumn(name = "ForkNodeId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "ForkNode")
    ...
    @JoinTable(name = "ForkNode_incoming",
        joinColumns = @JoinColumn(name = "ForkNodeId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ForkNode")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ForkNode")
    ...
    @JoinTable(name = "ForkNode_ownedComment",
        joinColumns = @JoinColumn(name = "ForkNodeId"),
    ...
    @JoinColumn(name = "activityId", table = "ForkNode")
