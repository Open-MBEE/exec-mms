...
import org.openmbee.spec.uml.DestroyLinkAction;
...
@Entity
@SecondaryTable(name = "DestroyLinkAction")
@Table(appliesTo = "DestroyLinkAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "DestroyLinkAction")
@JsonTypeName(value = "DestroyLinkAction")
public class DestroyLinkActionImpl extends MofObjectImpl implements DestroyLinkAction {
    ...
    @JoinTable(name = "DestroyLinkAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "DestroyLinkActionId"),
    ...
    @JoinTable(name = "DestroyLinkAction_inputValue",
        joinColumns = @JoinColumn(name = "DestroyLinkActionId"),
    ...
    @Column(name = "name", table = "DestroyLinkAction")
    ...
    @JoinTable(name = "DestroyLinkAction_localPrecondition",
        joinColumns = @JoinColumn(name = "DestroyLinkActionId"),
    ...
    @JoinTable(name = "DestroyLinkAction_endData",
        joinColumns = @JoinColumn(name = "DestroyLinkActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "DestroyLinkAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "DestroyLinkAction")
    ...
    @JoinColumn(name = "activityId", table = "DestroyLinkAction")
    ...
    @JoinTable(name = "DestroyLinkAction_localPostcondition",
        joinColumns = @JoinColumn(name = "DestroyLinkActionId"),
    ...
    @JoinTable(name = "DestroyLinkAction_redefinedNode",
        joinColumns = @JoinColumn(name = "DestroyLinkActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "DestroyLinkAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "DestroyLinkAction")
    ...
    @JoinTable(name = "DestroyLinkAction_handler",
        joinColumns = @JoinColumn(name = "DestroyLinkActionId"),
    ...
    @JoinTable(name = "DestroyLinkAction_outgoing",
        joinColumns = @JoinColumn(name = "DestroyLinkActionId"),
    ...
    @JoinTable(name = "DestroyLinkAction_inPartition",
        joinColumns = @JoinColumn(name = "DestroyLinkActionId"),
    ...
    @JoinTable(name = "DestroyLinkAction_incoming",
        joinColumns = @JoinColumn(name = "DestroyLinkActionId"),
    ...
    @JoinTable(name = "DestroyLinkAction_ownedComment",
        joinColumns = @JoinColumn(name = "DestroyLinkActionId"),
