...
import org.openmbee.spec.uml.DataStoreNode;
...
@Entity
@SecondaryTable(name = "DataStoreNode")
@Table(appliesTo = "DataStoreNode", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "DataStoreNode")
@JsonTypeName(value = "DataStoreNode")
public class DataStoreNodeImpl extends MofObjectImpl implements DataStoreNode {
    ...
    @JoinTable(name = "DataStoreNode_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "DataStoreNodeId"),
    ...
    @JoinColumn(name = "upperBoundId", table = "DataStoreNode")
    ...
    @JoinColumn(name = "typeId", table = "DataStoreNode")
    public Type getType() {
        return type;
    }
    ...
    @JoinTable(name = "DataStoreNode_inState",
        joinColumns = @JoinColumn(name = "DataStoreNodeId"),
    ...
    @Column(name = "name", table = "DataStoreNode")
    ...
    @JoinColumn(name = "nameExpressionId", table = "DataStoreNode")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "DataStoreNode")
    ...
    @JoinColumn(name = "activityId", table = "DataStoreNode")
    ...
    @JoinTable(name = "DataStoreNode_redefinedNode",
        joinColumns = @JoinColumn(name = "DataStoreNodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "DataStoreNode")
    ...
    @JoinTable(name = "DataStoreNode_outgoing",
        joinColumns = @JoinColumn(name = "DataStoreNodeId"),
    ...
    @JoinColumn(name = "selectionId", table = "DataStoreNode")
    ...
    @JoinTable(name = "DataStoreNode_inPartition",
        joinColumns = @JoinColumn(name = "DataStoreNodeId"),
    ...
    @JoinTable(name = "DataStoreNode_incoming",
        joinColumns = @JoinColumn(name = "DataStoreNodeId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isControlType", table = "DataStoreNode")
    ...
    @JoinTable(name = "DataStoreNode_ownedComment",
        joinColumns = @JoinColumn(name = "DataStoreNodeId"),
