...
@Entity
@SecondaryTable(name = "Manifestation")
@Table(appliesTo = "Manifestation", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Manifestation")
@JsonTypeName(value = "Manifestation")
public class ManifestationImpl extends MofObjectImpl implements Manifestation {
    ...
    private PackageableElement utilizedElement;
    ...
    @JoinTable(name = "Manifestation_client",
        joinColumns = @JoinColumn(name = "ManifestationId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Manifestation")
    ...
    @JoinColumn(name = "mappingId", table = "Manifestation")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "Manifestation")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "PackageableElementMetaDef", metaColumn = @Column(name = "utilizedElementType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "utilizedElementId", table = "Manifestation")
    ...
    public void setUtilizedElement(PackageableElement utilizedElement) {
    ...
    @JoinTable(name = "Manifestation_supplier",
        joinColumns = @JoinColumn(name = "ManifestationId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Manifestation")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Manifestation")
    ...
    @JoinTable(name = "Manifestation_ownedComment",
        joinColumns = @JoinColumn(name = "ManifestationId"),
