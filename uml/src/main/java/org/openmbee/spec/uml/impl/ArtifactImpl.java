...
@Entity
@SecondaryTable(name = "Artifact")
@Table(appliesTo = "Artifact", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Artifact")
@JsonTypeName(value = "Artifact")
public class ArtifactImpl extends MofObjectImpl implements Artifact {
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "Artifact")
    ...
    @JoinTable(name = "Artifact_useCase",
        joinColumns = @JoinColumn(name = "ArtifactId"),
    ...
    @JoinTable(name = "Artifact_elementImport",
        joinColumns = @JoinColumn(name = "ArtifactId"),
    ...
    @Column(name = "name", table = "Artifact")
    ...
    @JoinTable(name = "Artifact_manifestation",
        joinColumns = @JoinColumn(name = "ArtifactId"),
    ...
    @JoinTable(name = "Artifact_ownedOperation",
        joinColumns = @JoinColumn(name = "ArtifactId"),
    ...
    @JoinTable(name = "Artifact_substitution",
        joinColumns = @JoinColumn(name = "ArtifactId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "Artifact")
    ...
    @JoinTable(name = "Artifact_generalization",
        joinColumns = @JoinColumn(name = "ArtifactId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "Artifact")
    ...
    @JoinTable(name = "Artifact_packageImport",
        joinColumns = @JoinColumn(name = "ArtifactId"),
    ...
    @JoinTable(name = "Artifact_redefinedClassifier",
        joinColumns = @JoinColumn(name = "ArtifactId"),
    ...
    @JoinTable(name = "Artifact_ownedRule",
        joinColumns = @JoinColumn(name = "ArtifactId"),
    ...
    @JoinTable(name = "Artifact_ownedAttribute",
        joinColumns = @JoinColumn(name = "ArtifactId"),
    ...
    @JoinTable(name = "Artifact_nestedArtifact",
        joinColumns = @JoinColumn(name = "ArtifactId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Artifact")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "Artifact")
    ...
    @JoinTable(name = "Artifact_collaborationUse",
        joinColumns = @JoinColumn(name = "ArtifactId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Artifact")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "fileName", table = "Artifact")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "Artifact")
    ...
    @JoinTable(name = "Artifact_ownedUseCase",
        joinColumns = @JoinColumn(name = "ArtifactId"),
    ...
    @JoinTable(name = "Artifact_templateBinding",
        joinColumns = @JoinColumn(name = "ArtifactId"),
    ...
    @JoinColumn(name = "package_Id", table = "Artifact")
    ...
    @JoinColumn(name = "representationId", table = "Artifact")
    ...
    @JoinTable(name = "Artifact_ownedComment",
        joinColumns = @JoinColumn(name = "ArtifactId"),
    ...
    @JoinTable(name = "Artifact_powertypeExtent",
        joinColumns = @JoinColumn(name = "ArtifactId"),
