...
import org.openmbee.spec.uml.StructuredClassifier;
...
public abstract class StructuredClassifierImpl extends MofObjectImpl implements
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "StructuredClassifier")
    ...
    @JoinTable(name = "StructuredClassifier_useCase",
        joinColumns = @JoinColumn(name = "StructuredClassifierId"),
    ...
    @JoinTable(name = "StructuredClassifier_elementImport",
        joinColumns = @JoinColumn(name = "StructuredClassifierId"),
    ...
    @Column(name = "name", table = "StructuredClassifier")
    ...
    @JoinTable(name = "StructuredClassifier_substitution",
        joinColumns = @JoinColumn(name = "StructuredClassifierId"),
    ...
    @JoinTable(name = "StructuredClassifier_ownedConnector",
        joinColumns = @JoinColumn(name = "StructuredClassifierId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "StructuredClassifier")
    ...
    @JoinTable(name = "StructuredClassifier_generalization",
        joinColumns = @JoinColumn(name = "StructuredClassifierId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "StructuredClassifier")
    ...
    @JoinTable(name = "StructuredClassifier_packageImport",
        joinColumns = @JoinColumn(name = "StructuredClassifierId"),
    ...
    @JoinTable(name = "StructuredClassifier_redefinedClassifier",
        joinColumns = @JoinColumn(name = "StructuredClassifierId"),
    ...
    @JoinTable(name = "StructuredClassifier_ownedRule",
        joinColumns = @JoinColumn(name = "StructuredClassifierId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "StructuredClassifier")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "StructuredClassifier")
    ...
    @JoinTable(name = "StructuredClassifier_collaborationUse",
        joinColumns = @JoinColumn(name = "StructuredClassifierId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "StructuredClassifier")
    ...
    @JoinTable(name = "StructuredClassifier_ownedAttribute",
        joinColumns = @JoinColumn(name = "StructuredClassifierId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "StructuredClassifier")
    ...
    @JoinTable(name = "StructuredClassifier_ownedUseCase",
        joinColumns = @JoinColumn(name = "StructuredClassifierId"),
    ...
    @JoinTable(name = "StructuredClassifier_templateBinding",
        joinColumns = @JoinColumn(name = "StructuredClassifierId"),
    ...
    @JoinColumn(name = "package_Id", table = "StructuredClassifier")
    ...
    @JoinColumn(name = "representationId", table = "StructuredClassifier")
    ...
    @JoinTable(name = "StructuredClassifier_ownedComment",
        joinColumns = @JoinColumn(name = "StructuredClassifierId"),
    ...
    @JoinTable(name = "StructuredClassifier_powertypeExtent",
        joinColumns = @JoinColumn(name = "StructuredClassifierId"),
