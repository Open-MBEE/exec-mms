...
import org.openmbee.spec.uml.WriteLinkAction;
import org.openmbee.spec.uml.jackson.MofObjectDeserializer;
import org.openmbee.spec.uml.jackson.MofObjectSerializer;

@PrimaryKeyJoinColumn
@Inheritance(strategy = InheritanceType.JOINED)
public abstract class WriteLinkActionImpl extends MofObjectImpl implements WriteLinkAction {
    ...
    @JoinTable(name = "WriteLinkAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "WriteLinkActionId"),
    ...
    @JoinTable(name = "WriteLinkAction_inputValue",
        joinColumns = @JoinColumn(name = "WriteLinkActionId"),
    ...
    @Column(name = "name", table = "WriteLinkAction")
    ...
    @JoinTable(name = "WriteLinkAction_localPrecondition",
        joinColumns = @JoinColumn(name = "WriteLinkActionId"),
    ...
    @JoinTable(name = "WriteLinkAction_endData",
        joinColumns = @JoinColumn(name = "WriteLinkActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "WriteLinkAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "WriteLinkAction")
    ...
    @JoinColumn(name = "activityId", table = "WriteLinkAction")
    ...
    @JoinTable(name = "WriteLinkAction_localPostcondition",
        joinColumns = @JoinColumn(name = "WriteLinkActionId"),
    ...
    @JoinTable(name = "WriteLinkAction_redefinedNode",
        joinColumns = @JoinColumn(name = "WriteLinkActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "WriteLinkAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "WriteLinkAction")
    ...
    @JoinTable(name = "WriteLinkAction_handler",
        joinColumns = @JoinColumn(name = "WriteLinkActionId"),
    ...
    @JoinTable(name = "WriteLinkAction_outgoing",
        joinColumns = @JoinColumn(name = "WriteLinkActionId"),
    ...
    @JoinTable(name = "WriteLinkAction_inPartition",
        joinColumns = @JoinColumn(name = "WriteLinkActionId"),
    ...
    @JoinTable(name = "WriteLinkAction_incoming",
        joinColumns = @JoinColumn(name = "WriteLinkActionId"),
    ...
    @JoinTable(name = "WriteLinkAction_ownedComment",
        joinColumns = @JoinColumn(name = "WriteLinkActionId"),
