...
import org.openmbee.spec.uml.StartObjectBehaviorAction;
...
@Entity
@SecondaryTable(name = "StartObjectBehaviorAction")
@Table(appliesTo = "StartObjectBehaviorAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "StartObjectBehaviorAction")
@JsonTypeName(value = "StartObjectBehaviorAction")
public class StartObjectBehaviorActionImpl extends MofObjectImpl implements
    ...
    @JoinColumn(name = "onPortId", table = "StartObjectBehaviorAction")
    ...
    @JoinTable(name = "StartObjectBehaviorAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "StartObjectBehaviorActionId"),
    ...
    @JoinTable(name = "StartObjectBehaviorAction_argument",
        joinColumns = @JoinColumn(name = "StartObjectBehaviorActionId"),
    ...
    @Column(name = "name", table = "StartObjectBehaviorAction")
    ...
    @JoinTable(name = "StartObjectBehaviorAction_localPrecondition",
        joinColumns = @JoinColumn(name = "StartObjectBehaviorActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "StartObjectBehaviorAction")
    ...
    @JoinTable(name = "StartObjectBehaviorAction_result",
        joinColumns = @JoinColumn(name = "StartObjectBehaviorActionId"),
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "StartObjectBehaviorAction")
    ...
    @JoinColumn(name = "activityId", table = "StartObjectBehaviorAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isSynchronous", table = "StartObjectBehaviorAction")
    ...
    @JoinTable(name = "StartObjectBehaviorAction_localPostcondition",
        joinColumns = @JoinColumn(name = "StartObjectBehaviorActionId"),
    ...
    @JoinTable(name = "StartObjectBehaviorAction_redefinedNode",
        joinColumns = @JoinColumn(name = "StartObjectBehaviorActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "StartObjectBehaviorAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "StartObjectBehaviorAction")
    ...
    @JoinTable(name = "StartObjectBehaviorAction_handler",
        joinColumns = @JoinColumn(name = "StartObjectBehaviorActionId"),
    ...
    @JoinTable(name = "StartObjectBehaviorAction_outgoing",
        joinColumns = @JoinColumn(name = "StartObjectBehaviorActionId"),
    ...
    @JoinTable(name = "StartObjectBehaviorAction_inPartition",
        joinColumns = @JoinColumn(name = "StartObjectBehaviorActionId"),
    ...
    @JoinTable(name = "StartObjectBehaviorAction_incoming",
        joinColumns = @JoinColumn(name = "StartObjectBehaviorActionId"),
    ...
    @JoinColumn(name = "objectId", table = "StartObjectBehaviorAction")
    ...
    @JoinTable(name = "StartObjectBehaviorAction_ownedComment",
        joinColumns = @JoinColumn(name = "StartObjectBehaviorActionId"),
