...
import org.openmbee.spec.uml.CallAction;
...
public abstract class CallActionImpl extends MofObjectImpl implements CallAction {
    ...
    @JoinColumn(name = "onPortId", table = "CallAction")
    ...
    @JoinTable(name = "CallAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "CallActionId"),
    ...
    @JoinTable(name = "CallAction_argument",
        joinColumns = @JoinColumn(name = "CallActionId"),
    ...
    @Column(name = "name", table = "CallAction")
    ...
    @JoinTable(name = "CallAction_localPrecondition",
        joinColumns = @JoinColumn(name = "CallActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "CallAction")
    ...
    @JoinTable(name = "CallAction_result",
        joinColumns = @JoinColumn(name = "CallActionId"),
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "CallAction")
    ...
    @JoinColumn(name = "activityId", table = "CallAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isSynchronous", table = "CallAction")
    ...
    @JoinTable(name = "CallAction_localPostcondition",
        joinColumns = @JoinColumn(name = "CallActionId"),
    ...
    @JoinTable(name = "CallAction_redefinedNode",
        joinColumns = @JoinColumn(name = "CallActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "CallAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "CallAction")
    ...
    @JoinTable(name = "CallAction_handler",
        joinColumns = @JoinColumn(name = "CallActionId"),
    ...
    @JoinTable(name = "CallAction_outgoing",
        joinColumns = @JoinColumn(name = "CallActionId"),
    ...
    @JoinTable(name = "CallAction_inPartition",
        joinColumns = @JoinColumn(name = "CallActionId"),
    ...
    @JoinTable(name = "CallAction_incoming",
        joinColumns = @JoinColumn(name = "CallActionId"),
    ...
    @JoinTable(name = "CallAction_ownedComment",
        joinColumns = @JoinColumn(name = "CallActionId"),
