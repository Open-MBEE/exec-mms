...
@Entity
@SecondaryTable(name = "Signal")
@Table(appliesTo = "Signal", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Signal")
@JsonTypeName(value = "Signal")
public class SignalImpl extends MofObjectImpl implements Signal {
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "Signal")
    ...
    @JoinTable(name = "Signal_useCase",
        joinColumns = @JoinColumn(name = "SignalId"),
    ...
    @JoinTable(name = "Signal_elementImport",
        joinColumns = @JoinColumn(name = "SignalId"),
    ...
    @JoinTable(name = "Signal_ownedAttribute",
        joinColumns = @JoinColumn(name = "SignalId"),
    ...
    @JoinTable(name = "Signal_substitution",
        joinColumns = @JoinColumn(name = "SignalId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "Signal")
    ...
    @JoinTable(name = "Signal_generalization",
        joinColumns = @JoinColumn(name = "SignalId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "Signal")
    ...
    @JoinTable(name = "Signal_packageImport",
        joinColumns = @JoinColumn(name = "SignalId"),
    ...
    @JoinTable(name = "Signal_redefinedClassifier",
        joinColumns = @JoinColumn(name = "SignalId"),
    ...
    @JoinTable(name = "Signal_ownedRule",
        joinColumns = @JoinColumn(name = "SignalId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Signal")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "Signal")
    ...
    @JoinTable(name = "Signal_collaborationUse",
        joinColumns = @JoinColumn(name = "SignalId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Signal")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "Signal")
    ...
    @JoinTable(name = "Signal_ownedUseCase",
        joinColumns = @JoinColumn(name = "SignalId"),
    ...
    @JoinTable(name = "Signal_templateBinding",
        joinColumns = @JoinColumn(name = "SignalId"),
    ...
    @JoinColumn(name = "package_Id", table = "Signal")
    ...
    @JoinColumn(name = "representationId", table = "Signal")
    ...
    @JoinTable(name = "Signal_ownedComment",
        joinColumns = @JoinColumn(name = "SignalId"),
    ...
    @JoinTable(name = "Signal_powertypeExtent",
        joinColumns = @JoinColumn(name = "SignalId"),
