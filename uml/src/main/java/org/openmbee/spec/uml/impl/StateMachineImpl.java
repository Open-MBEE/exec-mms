...
@Entity
@SecondaryTable(name = "StateMachine")
@Table(appliesTo = "StateMachine", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "StateMachine")
@JsonTypeName(value = "StateMachine")
public class StateMachineImpl extends MofObjectImpl implements StateMachine {
    ...
    @JoinTable(name = "StateMachine_ownedParameterSet",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinTable(name = "StateMachine_elementImport",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @Column(name = "name", table = "StateMachine")
    ...
    @JoinColumn(name = "specificationId", table = "StateMachine")
    ...
    @JoinColumn(name = "nameExpressionId", table = "StateMachine")
    ...
    @JoinTable(name = "StateMachine_generalization",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinTable(name = "StateMachine_packageImport",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinTable(name = "StateMachine_precondition",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinTable(name = "StateMachine_ownedOperation",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "StateMachine")
    ...
    @JoinTable(name = "StateMachine_ownedAttribute",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinTable(name = "StateMachine_templateBinding",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinColumn(name = "representationId", table = "StateMachine")
    ...
    @JoinTable(name = "StateMachine_ownedReception",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "StateMachine")
    ...
    @JoinTable(name = "StateMachine_useCase",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinTable(name = "StateMachine_ownedBehavior",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinColumn(name = "classifierBehaviorId", table = "StateMachine")
    ...
    @JoinTable(name = "StateMachine_substitution",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinTable(name = "StateMachine_ownedConnector",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "StateMachine")
    ...
    @JoinTable(name = "StateMachine_interfaceRealization",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinTable(name = "StateMachine_redefinedClassifier",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinTable(name = "StateMachine_ownedRule",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "StateMachine")
    ...
    @JoinTable(name = "StateMachine_collaborationUse",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinTable(name = "StateMachine_connectionPoint",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "StateMachine")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isReentrant", table = "StateMachine")
    ...
    @JoinTable(name = "StateMachine_ownedParameter",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "StateMachine")
    ...
    @JoinTable(name = "StateMachine_nestedClassifier",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinTable(name = "StateMachine_ownedUseCase",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isActive", table = "StateMachine")
    ...
    @JoinTable(name = "StateMachine_submachineState",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinColumn(name = "package_Id", table = "StateMachine")
    ...
    @JoinTable(name = "StateMachine_postcondition",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinTable(name = "StateMachine_redefinedBehavior",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinTable(name = "StateMachine_region",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinTable(name = "StateMachine_ownedComment",
        joinColumns = @JoinColumn(name = "StateMachineId"),
    ...
    @JoinTable(name = "StateMachine_powertypeExtent",
        joinColumns = @JoinColumn(name = "StateMachineId"),
