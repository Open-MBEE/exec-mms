...
import org.openmbee.spec.uml.LiteralNull;
...
@Entity
@SecondaryTable(name = "LiteralNull")
@Table(appliesTo = "LiteralNull", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "LiteralNull")
@JsonTypeName(value = "LiteralNull")
public class LiteralNullImpl extends MofObjectImpl implements LiteralNull {
    ...
    @Column(name = "name", table = "LiteralNull")
    ...
    @JoinColumn(name = "typeId", table = "LiteralNull")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "LiteralNull")
    ...
    @JoinColumn(name = "templateParameterId", table = "LiteralNull")
    ...
    @JoinColumn(name = "nameExpressionId", table = "LiteralNull")
    ...
    @JoinTable(name = "LiteralNull_ownedComment",
        joinColumns = @JoinColumn(name = "LiteralNullId"),
