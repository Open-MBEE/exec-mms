...
@Entity
@SecondaryTable(name = "Interface")
@Table(appliesTo = "Interface", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Interface")
@JsonTypeName(value = "Interface")
public class InterfaceImpl extends MofObjectImpl implements Interface {
    ...
    private Collection<Interface> redefinedInterface;
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "Interface")
    ...
    @JoinTable(name = "Interface_useCase",
    ...
    @JoinTable(name = "Interface_elementImport",
        joinColumns = @JoinColumn(name = "InterfaceId"),
    ...
    @Column(name = "name", table = "Interface")
    ...
    @JoinTable(name = "Interface_substitution",
        joinColumns = @JoinColumn(name = "InterfaceId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "Interface")
    ...
    @JoinTable(name = "Interface_generalization",
        joinColumns = @JoinColumn(name = "InterfaceId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "Interface")
    ...
    @JoinTable(name = "Interface_packageImport",
        joinColumns = @JoinColumn(name = "InterfaceId"),
    ...
    @JoinTable(name = "Interface_redefinedClassifier",
        joinColumns = @JoinColumn(name = "InterfaceId"),
    ...
    @JoinTable(name = "Interface_ownedRule",
        joinColumns = @JoinColumn(name = "InterfaceId"),
    ...
    @JoinTable(name = "Interface_ownedReception",
        joinColumns = @JoinColumn(name = "InterfaceId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Interface")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "Interface")
    ...
    @JoinTable(name = "Interface_collaborationUse",
        joinColumns = @JoinColumn(name = "InterfaceId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Interface")
    ...
    @JoinTable(name = "Interface_ownedOperation",
        joinColumns = @JoinColumn(name = "InterfaceId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "Interface")
    ...
    @JoinTable(name = "Interface_ownedUseCase",
        joinColumns = @JoinColumn(name = "InterfaceId"),
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "InterfaceMetaDef", metaColumn = @Column(name = "redefinedInterfaceType"), fetch = FetchType.LAZY)
    @JoinTable(name = "Interface_redefinedInterface",
        joinColumns = @JoinColumn(name = "InterfaceId"),
        inverseJoinColumns = @JoinColumn(name = "redefinedInterfaceId"))
    public Collection<Interface> getRedefinedInterface() {
        if (redefinedInterface == null) {
            redefinedInterface = new ArrayList<>();
        }
    ...
    public void setRedefinedInterface(Collection<Interface> redefinedInterface) {
    ...
    @JoinTable(name = "Interface_templateBinding",
        joinColumns = @JoinColumn(name = "InterfaceId"),
    ...
    @JoinTable(name = "Interface_nestedClassifier",
        joinColumns = @JoinColumn(name = "InterfaceId"),
    ...
    @JoinColumn(name = "package_Id", table = "Interface")
    ...
    @JoinColumn(name = "representationId", table = "Interface")
    ...
    @JoinColumn(name = "protocolId", table = "Interface")
    ...
    @JoinTable(name = "Interface_ownedAttribute",
        joinColumns = @JoinColumn(name = "InterfaceId"),
    ...
    @JoinTable(name = "Interface_ownedComment",
        joinColumns = @JoinColumn(name = "InterfaceId"),
    ...
    @JoinTable(name = "Interface_powertypeExtent",
        joinColumns = @JoinColumn(name = "InterfaceId"),
