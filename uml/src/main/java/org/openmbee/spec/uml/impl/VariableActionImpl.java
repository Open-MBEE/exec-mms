...
import org.openmbee.spec.uml.VariableAction;
...
public abstract class VariableActionImpl extends MofObjectImpl implements VariableAction {
    ...
    @JoinTable(name = "VariableAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "VariableActionId"),
    ...
    @Column(name = "name", table = "VariableAction")
    ...
    @JoinTable(name = "VariableAction_localPrecondition",
        joinColumns = @JoinColumn(name = "VariableActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "VariableAction")
    ...
    @JoinColumn(name = "variableId", table = "VariableAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "VariableAction")
    ...
    @JoinColumn(name = "activityId", table = "VariableAction")
    ...
    @JoinTable(name = "VariableAction_localPostcondition",
        joinColumns = @JoinColumn(name = "VariableActionId"),
    ...
    @JoinTable(name = "VariableAction_redefinedNode",
        joinColumns = @JoinColumn(name = "VariableActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "VariableAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "VariableAction")
    ...
    @JoinTable(name = "VariableAction_handler",
        joinColumns = @JoinColumn(name = "VariableActionId"),
    ...
    @JoinTable(name = "VariableAction_outgoing",
        joinColumns = @JoinColumn(name = "VariableActionId"),
    ...
    @JoinTable(name = "VariableAction_inPartition",
        joinColumns = @JoinColumn(name = "VariableActionId"),
    ...
    @JoinTable(name = "VariableAction_incoming",
        joinColumns = @JoinColumn(name = "VariableActionId"),
    ...
    @JoinTable(name = "VariableAction_ownedComment",
        joinColumns = @JoinColumn(name = "VariableActionId"),
