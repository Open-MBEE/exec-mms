...
import org.openmbee.spec.uml.DeployedArtifact;
...
public abstract class DeployedArtifactImpl extends MofObjectImpl implements DeployedArtifact {
    ...
    @Column(name = "name", table = "DeployedArtifact")
    ...
    @JoinColumn(name = "nameExpressionId", table = "DeployedArtifact")
    ...
    @JoinTable(name = "DeployedArtifact_ownedComment",
        joinColumns = @JoinColumn(name = "DeployedArtifactId"),
