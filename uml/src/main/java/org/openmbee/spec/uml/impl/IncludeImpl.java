...
@Entity
@SecondaryTable(name = "Include")
@Table(appliesTo = "Include", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Include")
@JsonTypeName(value = "Include")
public class IncludeImpl extends MofObjectImpl implements Include {
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "UseCaseMetaDef", metaColumn = @Column(name = "includingCaseType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "includingCaseId", table = "Include")
    ...
    public void setIncludingCase(UseCase includingCase) {
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "Include")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "UseCaseMetaDef", metaColumn = @Column(name = "additionType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "additionId", table = "Include")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Include")
    ...
    @JoinTable(name = "Include_ownedComment",
        joinColumns = @JoinColumn(name = "IncludeId"),
