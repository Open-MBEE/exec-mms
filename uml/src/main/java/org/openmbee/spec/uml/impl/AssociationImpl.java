...
@Table(appliesTo = "Association", fetch = FetchMode.SELECT, optional = false)
...
public class AssociationImpl extends MofObjectImpl implements Association {
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isDerived", table = "Association")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "Association")
    ...
    @JoinTable(name = "Association_useCase",
    ...
    @JoinTable(name = "Association_elementImport",
        joinColumns = @JoinColumn(name = "AssociationId"),
    ...
    @JoinTable(name = "Association_memberEnd",
        joinColumns = @JoinColumn(name = "AssociationId"),
    ...
    @Column(name = "name", table = "Association")
    ...
    @JoinTable(name = "Association_substitution",
        joinColumns = @JoinColumn(name = "AssociationId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "Association")
    ...
    @JoinTable(name = "Association_generalization",
        joinColumns = @JoinColumn(name = "AssociationId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "Association")
    ...
    @JoinTable(name = "Association_packageImport",
        joinColumns = @JoinColumn(name = "AssociationId"),
    ...
    @JoinTable(name = "Association_ownedEnd",
        joinColumns = @JoinColumn(name = "AssociationId"),
    ...
    @JoinTable(name = "Association_redefinedClassifier",
        joinColumns = @JoinColumn(name = "AssociationId"),
    ...
    @JoinTable(name = "Association_ownedRule",
        joinColumns = @JoinColumn(name = "AssociationId"),
    ...
    @JoinTable(name = "Association_navigableOwnedEnd",
        joinColumns = @JoinColumn(name = "AssociationId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Association")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "Association")
    ...
    @JoinTable(name = "Association_collaborationUse",
        joinColumns = @JoinColumn(name = "AssociationId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Association")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "Association")
    ...
    @JoinTable(name = "Association_ownedUseCase",
        joinColumns = @JoinColumn(name = "AssociationId"),
    ...
    @JoinTable(name = "Association_templateBinding",
        joinColumns = @JoinColumn(name = "AssociationId"),
    ...
    @JoinColumn(name = "package_Id", table = "Association")
    ...
    @JoinColumn(name = "representationId", table = "Association")
    ...
    @JoinTable(name = "Association_ownedComment",
        joinColumns = @JoinColumn(name = "AssociationId"),
    ...
    @JoinTable(name = "Association_powertypeExtent",
        joinColumns = @JoinColumn(name = "AssociationId"),
