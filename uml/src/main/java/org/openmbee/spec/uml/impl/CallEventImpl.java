...
import org.openmbee.spec.uml.CallEvent;
...
@Entity
@SecondaryTable(name = "CallEvent")
@Table(appliesTo = "CallEvent", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "CallEvent")
@JsonTypeName(value = "CallEvent")
public class CallEventImpl extends MofObjectImpl implements CallEvent {
    ...
    @Column(name = "name", table = "CallEvent")
    ...
    @JoinColumn(name = "operationId", table = "CallEvent")
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "CallEvent")
    ...
    @JoinColumn(name = "templateParameterId", table = "CallEvent")
    ...
    @JoinColumn(name = "nameExpressionId", table = "CallEvent")
    ...
    @JoinTable(name = "CallEvent_ownedComment",
        joinColumns = @JoinColumn(name = "CallEventId"),
