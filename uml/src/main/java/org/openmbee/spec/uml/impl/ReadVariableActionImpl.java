...
import org.openmbee.spec.uml.ReadVariableAction;
...
@Entity
@SecondaryTable(name = "ReadVariableAction")
@Table(appliesTo = "ReadVariableAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ReadVariableAction")
@JsonTypeName(value = "ReadVariableAction")
public class ReadVariableActionImpl extends MofObjectImpl implements ReadVariableAction {
    ...
    @JoinTable(name = "ReadVariableAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ReadVariableActionId"),
    ...
    @JoinColumn(name = "resultId", table = "ReadVariableAction")
    ...
    @Column(name = "name", table = "ReadVariableAction")
    ...
    @JoinTable(name = "ReadVariableAction_localPrecondition",
        joinColumns = @JoinColumn(name = "ReadVariableActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ReadVariableAction")
    ...
    @JoinColumn(name = "variableId", table = "ReadVariableAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ReadVariableAction")
    ...
    @JoinColumn(name = "activityId", table = "ReadVariableAction")
    ...
    @JoinTable(name = "ReadVariableAction_localPostcondition",
        joinColumns = @JoinColumn(name = "ReadVariableActionId"),
    ...
    @JoinTable(name = "ReadVariableAction_redefinedNode",
        joinColumns = @JoinColumn(name = "ReadVariableActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ReadVariableAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "ReadVariableAction")
    ...
    @JoinTable(name = "ReadVariableAction_handler",
        joinColumns = @JoinColumn(name = "ReadVariableActionId"),
    ...
    @JoinTable(name = "ReadVariableAction_outgoing",
        joinColumns = @JoinColumn(name = "ReadVariableActionId"),
    ...
    @JoinTable(name = "ReadVariableAction_inPartition",
        joinColumns = @JoinColumn(name = "ReadVariableActionId"),
    ...
    @JoinTable(name = "ReadVariableAction_incoming",
        joinColumns = @JoinColumn(name = "ReadVariableActionId"),
    ...
    @JoinTable(name = "ReadVariableAction_ownedComment",
        joinColumns = @JoinColumn(name = "ReadVariableActionId"),
