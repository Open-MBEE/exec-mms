...
@Entity
@SecondaryTable(name = "InstanceSpecification")
@Table(appliesTo = "InstanceSpecification", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "InstanceSpecification")
@JsonTypeName(value = "InstanceSpecification")
public class InstanceSpecificationImpl extends MofObjectImpl implements InstanceSpecification {
    ...
    @JoinTable(name = "InstanceSpecification_slot",
        joinColumns = @JoinColumn(name = "InstanceSpecificationId"),
    ...
    @JoinColumn(name = "specificationId", table = "InstanceSpecification")
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "InstanceSpecification")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "InstanceSpecification")
    ...
    @JoinTable(name = "InstanceSpecification_classifier",
        joinColumns = @JoinColumn(name = "InstanceSpecificationId"),
    ...
    @JoinTable(name = "InstanceSpecification_deployment",
        joinColumns = @JoinColumn(name = "InstanceSpecificationId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "InstanceSpecification")
    ...
    @JoinColumn(name = "nameExpressionId", table = "InstanceSpecification")
    ...
    @JoinTable(name = "InstanceSpecification_ownedComment",
        joinColumns = @JoinColumn(name = "InstanceSpecificationId"),
