...
import org.openmbee.spec.uml.ValuePin;
...
@Entity
@SecondaryTable(name = "ValuePin")
@Table(appliesTo = "ValuePin", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ValuePin")
@JsonTypeName(value = "ValuePin")
public class ValuePinImpl extends MofObjectImpl implements ValuePin {
    ...
    @JoinTable(name = "ValuePin_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ValuePinId"),
    ...
    @JoinColumn(name = "valueId", table = "ValuePin")
    ...
    @JoinColumn(name = "upperBoundId", table = "ValuePin")
    ...
    @JoinColumn(name = "typeId", table = "ValuePin")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "lowerValueId", table = "ValuePin")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isOrdered", table = "ValuePin")
    ...
    @JoinTable(name = "ValuePin_inState",
        joinColumns = @JoinColumn(name = "ValuePinId"),
    ...
    @Column(name = "name", table = "ValuePin")
    ...
    @JoinColumn(name = "nameExpressionId", table = "ValuePin")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ValuePin")
    ...
    @JoinColumn(name = "activityId", table = "ValuePin")
    ...
    @JoinTable(name = "ValuePin_redefinedNode",
        joinColumns = @JoinColumn(name = "ValuePinId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ValuePin")
    ...
    @JoinColumn(name = "upperValueId", table = "ValuePin")
    ...
    @JoinTable(name = "ValuePin_outgoing",
        joinColumns = @JoinColumn(name = "ValuePinId"),
    ...
    @JoinColumn(name = "selectionId", table = "ValuePin")
    ...
    @JoinTable(name = "ValuePin_inPartition",
        joinColumns = @JoinColumn(name = "ValuePinId"),
    ...
    @JoinTable(name = "ValuePin_incoming",
        joinColumns = @JoinColumn(name = "ValuePinId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isUnique", table = "ValuePin")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isControlType", table = "ValuePin")
    ...
    @JoinTable(name = "ValuePin_ownedComment",
        joinColumns = @JoinColumn(name = "ValuePinId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isControl", table = "ValuePin")
