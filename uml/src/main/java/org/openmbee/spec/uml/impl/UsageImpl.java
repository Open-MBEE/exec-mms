...
import org.openmbee.spec.uml.Usage;
...
@Table(appliesTo = "Usage", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Usage")
@JsonTypeName(value = "Usage")
public class UsageImpl extends MofObjectImpl implements Usage {
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Usage")
    ...
    @JoinColumn(name = "templateParameterId", table = "Usage")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Usage")
    ...
    @JoinTable(name = "Usage_ownedComment",
        joinColumns = @JoinColumn(name = "UsageId"),
