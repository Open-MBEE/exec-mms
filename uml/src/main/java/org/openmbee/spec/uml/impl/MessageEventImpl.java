...
import org.openmbee.spec.uml.MessageEvent;
...
public abstract class MessageEventImpl extends MofObjectImpl implements MessageEvent {
    ...
    @Column(name = "name", table = "MessageEvent")
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "MessageEvent")
    ...
    @JoinColumn(name = "templateParameterId", table = "MessageEvent")
    ...
    @JoinColumn(name = "nameExpressionId", table = "MessageEvent")
    ...
    @JoinTable(name = "MessageEvent_ownedComment",
        joinColumns = @JoinColumn(name = "MessageEventId"),
