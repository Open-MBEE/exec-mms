...
@Entity
@SecondaryTable(name = "ParameterSet")
@Table(appliesTo = "ParameterSet", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ParameterSet")
@JsonTypeName(value = "ParameterSet")
public class ParameterSetImpl extends MofObjectImpl implements ParameterSet {
    ...
    private Collection<Constraint> condition;
    ...
    @Column(name = "name", table = "ParameterSet")
    ...
    @ManyToAny(metaDef = "ParameterMetaDef", metaColumn = @Column(name = "parameterType"), fetch = FetchType.LAZY)
    @JoinTable(name = "ParameterSet_parameter",
        joinColumns = @JoinColumn(name = "ParameterSetId"),
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "ConstraintMetaDef", metaColumn = @Column(name = "conditionType"), fetch = FetchType.LAZY)
    @JoinTable(name = "ParameterSet_condition",
        joinColumns = @JoinColumn(name = "ParameterSetId"),
        inverseJoinColumns = @JoinColumn(name = "conditionId"))
    public Collection<Constraint> getCondition() {
        if (condition == null) {
    ...
    public void setCondition(Collection<Constraint> condition) {
    ...
    @JoinColumn(name = "nameExpressionId", table = "ParameterSet")
    ...
    @JoinTable(name = "ParameterSet_ownedComment",
        joinColumns = @JoinColumn(name = "ParameterSetId"),
