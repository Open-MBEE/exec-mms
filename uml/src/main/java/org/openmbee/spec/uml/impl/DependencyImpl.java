...
@Table(appliesTo = "Dependency", fetch = FetchMode.SELECT, optional = false)
...
public class DependencyImpl extends MofObjectImpl implements Dependency {
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Dependency")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "Dependency")
    ...
    @JoinColumn(name = "templateParameterId", table = "Dependency")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Dependency")
    ...
    @JoinTable(name = "Dependency_ownedComment",
        joinColumns = @JoinColumn(name = "DependencyId"),
