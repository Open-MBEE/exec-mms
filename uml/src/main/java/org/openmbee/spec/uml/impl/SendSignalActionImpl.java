...
import org.openmbee.spec.uml.SendSignalAction;
...
@Entity
@SecondaryTable(name = "SendSignalAction")
@Table(appliesTo = "SendSignalAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "SendSignalAction")
@JsonTypeName(value = "SendSignalAction")
public class SendSignalActionImpl extends MofObjectImpl implements SendSignalAction {
    ...
    @JoinColumn(name = "onPortId", table = "SendSignalAction")
    ...
    @JoinTable(name = "SendSignalAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "SendSignalActionId"),
    ...
    @JoinTable(name = "SendSignalAction_argument",
        joinColumns = @JoinColumn(name = "SendSignalActionId"),
    ...
    @Column(name = "name", table = "SendSignalAction")
    ...
    @JoinTable(name = "SendSignalAction_localPrecondition",
        joinColumns = @JoinColumn(name = "SendSignalActionId"),
    ...
    @JoinColumn(name = "targetId", table = "SendSignalAction")
    ...
    @JoinColumn(name = "nameExpressionId", table = "SendSignalAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "SendSignalAction")
    ...
    @JoinColumn(name = "activityId", table = "SendSignalAction")
    ...
    @JoinTable(name = "SendSignalAction_localPostcondition",
        joinColumns = @JoinColumn(name = "SendSignalActionId"),
    ...
    @JoinTable(name = "SendSignalAction_redefinedNode",
        joinColumns = @JoinColumn(name = "SendSignalActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "SendSignalAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "SendSignalAction")
    ...
    @JoinTable(name = "SendSignalAction_handler",
        joinColumns = @JoinColumn(name = "SendSignalActionId"),
    ...
    @JoinColumn(name = "signalId", table = "SendSignalAction")
    ...
    @JoinTable(name = "SendSignalAction_outgoing",
        joinColumns = @JoinColumn(name = "SendSignalActionId"),
    ...
    @JoinTable(name = "SendSignalAction_inPartition",
        joinColumns = @JoinColumn(name = "SendSignalActionId"),
    ...
    @JoinTable(name = "SendSignalAction_incoming",
        joinColumns = @JoinColumn(name = "SendSignalActionId"),
    ...
    @JoinTable(name = "SendSignalAction_ownedComment",
        joinColumns = @JoinColumn(name = "SendSignalActionId"),
