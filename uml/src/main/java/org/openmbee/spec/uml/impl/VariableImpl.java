...
@Entity
@SecondaryTable(name = "Variable")
@Table(appliesTo = "Variable", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Variable")
@JsonTypeName(value = "Variable")
public class VariableImpl extends MofObjectImpl implements Variable {
    ...
    private StructuredActivityNode scope;
    ...
    @Any(metaDef = "ActivityMetaDef", metaColumn = @Column(name = "activityScopeType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "activityScopeId", table = "Variable")
    ...
    public void setActivityScope(Activity activityScope) {
    ...
    @JoinColumn(name = "typeId", table = "Variable")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Variable")
    ...
    @JoinColumn(name = "lowerValueId", table = "Variable")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isOrdered", table = "Variable")
    ...
    @JoinColumn(name = "upperValueId", table = "Variable")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "Variable")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "StructuredActivityNodeMetaDef", metaColumn = @Column(name = "scopeType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "scopeId", table = "Variable")
    ...
    public void setScope(StructuredActivityNode scope) {
        this.scope = scope;
    }

    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isUnique", table = "Variable")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Variable")
    ...
    @JoinColumn(name = "templateParameterId", table = "Variable")
    ...
    @JoinTable(name = "Variable_ownedComment",
        joinColumns = @JoinColumn(name = "VariableId"),
