...
import org.openmbee.spec.uml.Device;
...
@Entity
@SecondaryTable(name = "Device")
@Table(appliesTo = "Device", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Device")
@JsonTypeName(value = "Device")
public class DeviceImpl extends MofObjectImpl implements Device {
    ...
    @JoinTable(name = "Device_elementImport",
    ...
    @JoinColumn(name = "nameExpressionId", table = "Device")
    ...
    @JoinTable(name = "Device_generalization",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JoinTable(name = "Device_packageImport",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JoinTable(name = "Device_ownedOperation",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "Device")
    ...
    @JoinTable(name = "Device_nestedNode",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JoinTable(name = "Device_ownedAttribute",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JoinTable(name = "Device_templateBinding",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JoinTable(name = "Device_deployment",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JoinColumn(name = "representationId", table = "Device")
    ...
    @JoinTable(name = "Device_ownedReception",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "Device")
    ...
    @JoinTable(name = "Device_ownedBehavior",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JoinColumn(name = "classifierBehaviorId", table = "Device")
    ...
    @JoinTable(name = "Device_substitution",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JoinTable(name = "Device_ownedConnector",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "Device")
    ...
    @JoinTable(name = "Device_interfaceRealization",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JoinTable(name = "Device_redefinedClassifier",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JoinTable(name = "Device_ownedRule",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "Device")
    ...
    @JoinTable(name = "Device_collaborationUse",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Device")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "Device")
    ...
    @JoinTable(name = "Device_nestedClassifier",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JoinTable(name = "Device_ownedUseCase",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isActive", table = "Device")
    ...
    @JoinColumn(name = "package_Id", table = "Device")
    ...
    @JoinTable(name = "Device_ownedComment",
        joinColumns = @JoinColumn(name = "DeviceId"),
    ...
    @JoinTable(name = "Device_powertypeExtent",
        joinColumns = @JoinColumn(name = "DeviceId"),
