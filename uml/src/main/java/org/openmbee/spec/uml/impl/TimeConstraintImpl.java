...
import org.openmbee.spec.uml.TimeConstraint;
...
@Entity
@SecondaryTable(name = "TimeConstraint")
@Table(appliesTo = "TimeConstraint", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "TimeConstraint")
@JsonTypeName(value = "TimeConstraint")
public class TimeConstraintImpl extends MofObjectImpl implements TimeConstraint {

    private Element owner;
    private TimeInterval specification;
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "TimeIntervalMetaDef", metaColumn = @Column(name = "specificationType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "specificationId", table = "TimeConstraint")
    public TimeInterval getSpecification() {
        return specification;
    }

    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(using = MofObjectDeserializer.class, as = TimeIntervalImpl.class)
    public void setSpecification(TimeInterval specification) {
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "TimeConstraint")
    ...
    @JoinColumn(name = "contextId", table = "TimeConstraint")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "firstEvent", table = "TimeConstraint")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "TimeConstraint")
    ...
    @JoinColumn(name = "templateParameterId", table = "TimeConstraint")
    ...
    @JoinColumn(name = "nameExpressionId", table = "TimeConstraint")
    ...
    @JoinTable(name = "TimeConstraint_constrainedElement",
        joinColumns = @JoinColumn(name = "TimeConstraintId"),
    ...
    @JoinTable(name = "TimeConstraint_ownedComment",
        joinColumns = @JoinColumn(name = "TimeConstraintId"),
