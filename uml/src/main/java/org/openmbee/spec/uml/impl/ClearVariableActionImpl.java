...
import org.openmbee.spec.uml.ClearVariableAction;
...
@Entity
@SecondaryTable(name = "ClearVariableAction")
@Table(appliesTo = "ClearVariableAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ClearVariableAction")
@JsonTypeName(value = "ClearVariableAction")
public class ClearVariableActionImpl extends MofObjectImpl implements ClearVariableAction {
    ...
    @JoinTable(name = "ClearVariableAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ClearVariableActionId"),
    ...
    @Column(name = "name", table = "ClearVariableAction")
    ...
    @JoinTable(name = "ClearVariableAction_localPrecondition",
        joinColumns = @JoinColumn(name = "ClearVariableActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ClearVariableAction")
    ...
    @JoinColumn(name = "variableId", table = "ClearVariableAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ClearVariableAction")
    ...
    @JoinColumn(name = "activityId", table = "ClearVariableAction")
    ...
    @JoinTable(name = "ClearVariableAction_localPostcondition",
        joinColumns = @JoinColumn(name = "ClearVariableActionId"),
    ...
    @JoinTable(name = "ClearVariableAction_redefinedNode",
        joinColumns = @JoinColumn(name = "ClearVariableActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ClearVariableAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "ClearVariableAction")
    ...
    @JoinTable(name = "ClearVariableAction_handler",
        joinColumns = @JoinColumn(name = "ClearVariableActionId"),
    ...
    @JoinTable(name = "ClearVariableAction_outgoing",
        joinColumns = @JoinColumn(name = "ClearVariableActionId"),
    ...
    @JoinTable(name = "ClearVariableAction_inPartition",
        joinColumns = @JoinColumn(name = "ClearVariableActionId"),
    ...
    @JoinTable(name = "ClearVariableAction_incoming",
        joinColumns = @JoinColumn(name = "ClearVariableActionId"),
    ...
    @JoinTable(name = "ClearVariableAction_ownedComment",
        joinColumns = @JoinColumn(name = "ClearVariableActionId"),
