...
public abstract class BehavioredClassifierImpl extends MofObjectImpl implements
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "BehavioredClassifier")
    ...
    @JoinTable(name = "BehavioredClassifier_useCase",
        joinColumns = @JoinColumn(name = "BehavioredClassifierId"),
    ...
    @JoinTable(name = "BehavioredClassifier_elementImport",
        joinColumns = @JoinColumn(name = "BehavioredClassifierId"),
    ...
    @Column(name = "name", table = "BehavioredClassifier")
    ...
    @JoinTable(name = "BehavioredClassifier_ownedBehavior",
        joinColumns = @JoinColumn(name = "BehavioredClassifierId"),
    ...
    @JoinColumn(name = "classifierBehaviorId", table = "BehavioredClassifier")
    ...
    @JoinTable(name = "BehavioredClassifier_substitution",
        joinColumns = @JoinColumn(name = "BehavioredClassifierId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "BehavioredClassifier")
    ...
    @JoinTable(name = "BehavioredClassifier_generalization",
        joinColumns = @JoinColumn(name = "BehavioredClassifierId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "BehavioredClassifier")
    ...
    @JoinTable(name = "BehavioredClassifier_interfaceRealization",
        joinColumns = @JoinColumn(name = "BehavioredClassifierId"),
    ...
    @JoinTable(name = "BehavioredClassifier_packageImport",
        joinColumns = @JoinColumn(name = "BehavioredClassifierId"),
    ...
    @JoinTable(name = "BehavioredClassifier_redefinedClassifier",
        joinColumns = @JoinColumn(name = "BehavioredClassifierId"),
    ...
    @JoinTable(name = "BehavioredClassifier_ownedRule",
        joinColumns = @JoinColumn(name = "BehavioredClassifierId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "BehavioredClassifier")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "BehavioredClassifier")
    ...
    @JoinTable(name = "BehavioredClassifier_collaborationUse",
        joinColumns = @JoinColumn(name = "BehavioredClassifierId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "BehavioredClassifier")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "BehavioredClassifier")
    ...
    @JoinTable(name = "BehavioredClassifier_ownedUseCase",
        joinColumns = @JoinColumn(name = "BehavioredClassifierId"),
    ...
    @JoinTable(name = "BehavioredClassifier_templateBinding",
        joinColumns = @JoinColumn(name = "BehavioredClassifierId"),
    ...
    @JoinColumn(name = "package_Id", table = "BehavioredClassifier")
    ...
    @JoinColumn(name = "representationId", table = "BehavioredClassifier")
    ...
    @JoinTable(name = "BehavioredClassifier_ownedComment",
        joinColumns = @JoinColumn(name = "BehavioredClassifierId"),
    ...
    @JoinTable(name = "BehavioredClassifier_powertypeExtent",
        joinColumns = @JoinColumn(name = "BehavioredClassifierId"),
