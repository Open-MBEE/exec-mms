...
import org.openmbee.spec.uml.OpaqueBehavior;
...
@Entity
@SecondaryTable(name = "OpaqueBehavior")
@Table(appliesTo = "OpaqueBehavior", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "OpaqueBehavior")
@JsonTypeName(value = "OpaqueBehavior")
public class OpaqueBehaviorImpl extends MofObjectImpl implements OpaqueBehavior {
    ...
    @CollectionTable(name = "OpaqueBehavior_body",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"))
    ...
    @JoinTable(name = "OpaqueBehavior_ownedParameterSet",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinTable(name = "OpaqueBehavior_elementImport",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "OpaqueBehavior")
    ...
    @JoinColumn(name = "specificationId", table = "OpaqueBehavior")
    ...
    @JoinColumn(name = "nameExpressionId", table = "OpaqueBehavior")
    ...
    @JoinTable(name = "OpaqueBehavior_generalization",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinTable(name = "OpaqueBehavior_packageImport",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinTable(name = "OpaqueBehavior_precondition",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinTable(name = "OpaqueBehavior_ownedOperation",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "OpaqueBehavior")
    ...
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @ElementCollection(targetClass = String.class)
    @CollectionTable(name = "OpaqueBehavior_language",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"))
    ...
    @JoinTable(name = "OpaqueBehavior_ownedAttribute",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinTable(name = "OpaqueBehavior_templateBinding",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinColumn(name = "representationId", table = "OpaqueBehavior")
    ...
    @JoinTable(name = "OpaqueBehavior_ownedReception",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isAbstract", table = "OpaqueBehavior")
    ...
    @JoinTable(name = "OpaqueBehavior_useCase",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinTable(name = "OpaqueBehavior_ownedBehavior",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinColumn(name = "classifierBehaviorId", table = "OpaqueBehavior")
    ...
    @JoinTable(name = "OpaqueBehavior_substitution",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinTable(name = "OpaqueBehavior_ownedConnector",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinColumn(name = "ownedTemplateSignatureId", table = "OpaqueBehavior")
    ...
    @JoinTable(name = "OpaqueBehavior_interfaceRealization",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinTable(name = "OpaqueBehavior_redefinedClassifier",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinTable(name = "OpaqueBehavior_ownedRule",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinColumn(name = "templateParameterId", table = "OpaqueBehavior")
    ...
    @JoinTable(name = "OpaqueBehavior_collaborationUse",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "OpaqueBehavior")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isReentrant", table = "OpaqueBehavior")
    ...
    @JoinTable(name = "OpaqueBehavior_ownedParameter",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isFinalSpecialization", table = "OpaqueBehavior")
    ...
    @JoinTable(name = "OpaqueBehavior_nestedClassifier",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinTable(name = "OpaqueBehavior_ownedUseCase",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isActive", table = "OpaqueBehavior")
    ...
    @JoinColumn(name = "package_Id", table = "OpaqueBehavior")
    ...
    @JoinTable(name = "OpaqueBehavior_postcondition",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinTable(name = "OpaqueBehavior_redefinedBehavior",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinTable(name = "OpaqueBehavior_ownedComment",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
    ...
    @JoinTable(name = "OpaqueBehavior_powertypeExtent",
        joinColumns = @JoinColumn(name = "OpaqueBehaviorId"),
