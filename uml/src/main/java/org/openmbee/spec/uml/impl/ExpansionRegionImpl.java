...
import org.openmbee.spec.uml.ExpansionKind;
...
@Entity
@SecondaryTable(name = "ExpansionRegion")
@Table(appliesTo = "ExpansionRegion", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ExpansionRegion")
@JsonTypeName(value = "ExpansionRegion")
public class ExpansionRegionImpl extends MofObjectImpl implements ExpansionRegion {

    private Element owner;
    private Collection<RedefinableElement> redefinedElement;
    private Collection<ExpansionNode> inputElement;
    ...
    private Collection<ExpansionNode> outputElement;
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "ExpansionNodeMetaDef", metaColumn = @Column(name = "inputElementType"), fetch = FetchType.LAZY)
    @JoinTable(name = "ExpansionRegion_inputElement",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
        inverseJoinColumns = @JoinColumn(name = "inputElementId"))
    public Collection<ExpansionNode> getInputElement() {
        if (inputElement == null) {
            inputElement = new ArrayList<>();
        }
        return inputElement;
    }
    ...
    @JsonProperty(required = true)
    @JsonSetter
    @JsonDeserialize(contentUsing = MofObjectDeserializer.class, contentAs = ExpansionNodeImpl.class)
    public void setInputElement(Collection<ExpansionNode> inputElement) {
    ...
    @JoinTable(name = "ExpansionRegion_structuredNodeOutput",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
    ...
    @JoinTable(name = "ExpansionRegion_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
    ...
    @JoinColumn(name = "inActivityId", table = "ExpansionRegion")
    ...
    @JoinTable(name = "ExpansionRegion_elementImport",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
    ...
    @JoinTable(name = "ExpansionRegion_variable",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
    ...
    @Column(name = "name", table = "ExpansionRegion")
    ...
    @JoinTable(name = "ExpansionRegion_localPrecondition",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ExpansionRegion")
    ...
    @JoinColumn(name = "activityId", table = "ExpansionRegion")
    ...
    @JoinTable(name = "ExpansionRegion_packageImport",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
    ...
    @JoinTable(name = "ExpansionRegion_ownedRule",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ExpansionRegion")
    ...
    @JoinTable(name = "ExpansionRegion_structuredNodeInput",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
    ...
    @JoinTable(name = "ExpansionRegion_localPostcondition",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
    ...
    @JoinTable(name = "ExpansionRegion_redefinedNode",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ExpansionRegion")
    ...
    @JoinTable(name = "ExpansionRegion_node",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "ExpansionRegion")
    ...
    @JoinTable(name = "ExpansionRegion_handler",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
    ...
    @JoinTable(name = "ExpansionRegion_edge",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
    ...
    @JoinTable(name = "ExpansionRegion_outgoing",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
    ...
    @JoinTable(name = "ExpansionRegion_inPartition",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
    ...
    @JoinTable(name = "ExpansionRegion_incoming",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "mustIsolate", table = "ExpansionRegion")
    ...
    @JsonGetter
    @JsonSerialize(contentUsing = MofObjectSerializer.class)
    @ManyToAny(metaDef = "ExpansionNodeMetaDef", metaColumn = @Column(name = "outputElementType"), fetch = FetchType.LAZY)
    @JoinTable(name = "ExpansionRegion_outputElement",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
        inverseJoinColumns = @JoinColumn(name = "outputElementId"))
    public Collection<ExpansionNode> getOutputElement() {
    ...
    @JsonSetter
    @JsonDeserialize(contentUsing = MofObjectDeserializer.class, contentAs = ExpansionNodeImpl.class)
    public void setOutputElement(Collection<ExpansionNode> outputElement) {
    ...
    @JoinTable(name = "ExpansionRegion_ownedComment",
        joinColumns = @JoinColumn(name = "ExpansionRegionId"),
