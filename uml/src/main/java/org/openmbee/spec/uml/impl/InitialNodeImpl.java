...
import org.openmbee.spec.uml.InitialNode;
...
@Entity
@SecondaryTable(name = "InitialNode")
@Table(appliesTo = "InitialNode", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "InitialNode")
@JsonTypeName(value = "InitialNode")
public class InitialNodeImpl extends MofObjectImpl implements InitialNode {
    ...
    @JoinTable(name = "InitialNode_redefinedNode",
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "InitialNode")
    ...
    @JoinTable(name = "InitialNode_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "InitialNodeId"),
    ...
    @JoinTable(name = "InitialNode_outgoing",
        joinColumns = @JoinColumn(name = "InitialNodeId"),
    ...
    @JoinTable(name = "InitialNode_inPartition",
        joinColumns = @JoinColumn(name = "InitialNodeId"),
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "InitialNode")
    ...
    @JoinTable(name = "InitialNode_incoming",
        joinColumns = @JoinColumn(name = "InitialNodeId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "InitialNode")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "InitialNode")
    ...
    @JoinTable(name = "InitialNode_ownedComment",
        joinColumns = @JoinColumn(name = "InitialNodeId"),
    ...
    @JoinColumn(name = "activityId", table = "InitialNode")
