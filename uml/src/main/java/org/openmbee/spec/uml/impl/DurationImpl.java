...
@Entity
@SecondaryTable(name = "Duration")
@Table(appliesTo = "Duration", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "Duration")
@JsonTypeName(value = "Duration")
public class DurationImpl extends MofObjectImpl implements Duration {
    ...
    @JoinColumn(name = "exprId", table = "Duration")
    ...
    @JoinColumn(name = "typeId", table = "Duration")
    public Type getType() {
        return type;
    }
    ...
    @JoinColumn(name = "owningTemplateParameterId", table = "Duration")
    ...
    @JoinTable(name = "Duration_observation",
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @Column(name = "name", table = "Duration")
    ...
    @JoinColumn(name = "templateParameterId", table = "Duration")
    ...
    @JoinColumn(name = "nameExpressionId", table = "Duration")
    ...
    @JoinTable(name = "Duration_ownedComment",
        joinColumns = @JoinColumn(name = "DurationId"),
