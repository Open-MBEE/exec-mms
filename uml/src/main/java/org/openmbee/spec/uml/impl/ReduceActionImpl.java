...
import org.openmbee.spec.uml.ReduceAction;
...
@Entity
@SecondaryTable(name = "ReduceAction")
@Table(appliesTo = "ReduceAction", fetch = FetchMode.SELECT, optional = false)
@DiscriminatorValue(value = "ReduceAction")
@JsonTypeName(value = "ReduceAction")
public class ReduceActionImpl extends MofObjectImpl implements ReduceAction {
    ...
    private InputPin collection;
    private OutputPin result;
    private Behavior reducer;
    ...
    @JoinTable(name = "ReduceAction_inInterruptibleRegion",
        joinColumns = @JoinColumn(name = "ReduceActionId"),
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "InputPinMetaDef", metaColumn = @Column(name = "collectionType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "collectionId", table = "ReduceAction")
    ...
    @JoinColumn(name = "resultId", table = "ReduceAction")
    ...
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @Any(metaDef = "BehaviorMetaDef", metaColumn = @Column(name = "reducerType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "reducerId", table = "ReduceAction")
    ...
    @Column(name = "name", table = "ReduceAction")
    ...
    @JoinTable(name = "ReduceAction_localPrecondition",
        joinColumns = @JoinColumn(name = "ReduceActionId"),
    ...
    @JoinColumn(name = "nameExpressionId", table = "ReduceAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isOrdered", table = "ReduceAction")
    ...
    @JoinColumn(name = "inStructuredNodeId", table = "ReduceAction")
    ...
    @JoinColumn(name = "activityId", table = "ReduceAction")
    ...
    @JoinTable(name = "ReduceAction_localPostcondition",
        joinColumns = @JoinColumn(name = "ReduceActionId"),
    ...
    @JoinTable(name = "ReduceAction_redefinedNode",
        joinColumns = @JoinColumn(name = "ReduceActionId"),
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLeaf", table = "ReduceAction")
    ...
    @JsonProperty(required = true)
    @JsonGetter
    @Column(name = "isLocallyReentrant", table = "ReduceAction")
    ...
    @JoinTable(name = "ReduceAction_handler",
        joinColumns = @JoinColumn(name = "ReduceActionId"),
    ...
    @JoinTable(name = "ReduceAction_outgoing",
        joinColumns = @JoinColumn(name = "ReduceActionId"),
    ...
    @JoinTable(name = "ReduceAction_inPartition",
        joinColumns = @JoinColumn(name = "ReduceActionId"),
    ...
    @JoinTable(name = "ReduceAction_incoming",
        joinColumns = @JoinColumn(name = "ReduceActionId"),
    ...
    @JoinTable(name = "ReduceAction_ownedComment",
        joinColumns = @JoinColumn(name = "ReduceActionId"),
