...
public class VeController extends BaseController {
    ...
    public MountsResponse getMounts(
        ...
        MountJson json = serviceFactory.getServiceForSchema( ViewService.class ,getProjectType(projectId)).getProjectUsages(projectId, refId, params.get("commitId"), new ArrayList<>(), true);
    ...
    public DocumentsResponse getDocuments(
        ...
        ElementsResponse docs = serviceFactory.getServiceForSchema( ViewService.class , getProjectType(projectId)).getDocuments(projectId, refId, params);
    ...
    public ElementsResponse getViews(
        ...
        return serviceFactory.getServiceForSchema( ViewService.class , getProjectType(projectId)).getViews(projectId, refId, req, params);
    }
    ...
    public ElementsResponse createOrUpdateViews(
        ...
        ViewService viewService = serviceFactory.getServiceForSchema( ViewService.class , getProjectType(projectId));
    ...
    public GroupsResponse getGroups(
        ...
        ElementsResponse groups = serviceFactory.getServiceForSchema( ViewService.class , getProjectType(projectId)).getGroups(projectId, refId, params);
